...
extern _Bool fetch_struct_quotastat(struct tcb *const tcp, const kernel_ulong_t data, void *p);
...
extern void print_kernel_sigset(struct tcb *tcp, const kernel_ulong_t addr);
...
extern int print_timeval(struct tcb *const tcp, const kernel_ulong_t addr);
extern int print_timeval_utimes(struct tcb *const tcp, const kernel_ulong_t addr);
extern const char * sprint_timeval(struct tcb *const tcp, const kernel_ulong_t addr);
extern int print_itimerval(struct tcb *const tcp, const kernel_ulong_t addr);
