...
static const unsigned int header_size =
 __builtin_offsetof (kernel_dirent_t, d_name);
static void
print_dentry_head(const kernel_dirent_t *const dent)
{
 tprint_struct_begin();
 do { tprints_field_name("d_ino"); tprintf("%llu", (sizeof((*dent).d_ino) == sizeof(char) ? (unsigned long long) (unsigned char) ((*dent).d_ino) : sizeof((*dent).d_ino) == sizeof(short) ? (unsigned long long) (unsigned short) ((*dent).d_ino) : sizeof((*dent).d_ino) == sizeof(int) ? (unsigned long long) (unsigned int) ((*dent).d_ino) : sizeof((*dent).d_ino) == sizeof(long) ? (unsigned long long) (unsigned long) ((*dent).d_ino) : (unsigned long long) ((*dent).d_ino))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("d_off"); tprintf("%llu", (sizeof((*dent).d_off) == sizeof(char) ? (unsigned long long) (unsigned char) ((*dent).d_off) : sizeof((*dent).d_off) == sizeof(short) ? (unsigned long long) (unsigned short) ((*dent).d_off) : sizeof((*dent).d_off) == sizeof(int) ? (unsigned long long) (unsigned int) ((*dent).d_off) : sizeof((*dent).d_off) == sizeof(long) ? (unsigned long long) (unsigned long) ((*dent).d_off) : (unsigned long long) ((*dent).d_off))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("d_reclen"); tprintf("%llu", (sizeof((*dent).d_reclen) == sizeof(char) ? (unsigned long long) (unsigned char) ((*dent).d_reclen) : sizeof((*dent).d_reclen) == sizeof(short) ? (unsigned long long) (unsigned short) ((*dent).d_reclen) : sizeof((*dent).d_reclen) == sizeof(int) ? (unsigned long long) (unsigned int) ((*dent).d_reclen) : sizeof((*dent).d_reclen) == sizeof(long) ? (unsigned long long) (unsigned long) ((*dent).d_reclen) : (unsigned long long) ((*dent).d_reclen))); } while (0);
}
static unsigned int
     ...
     const void *const arg, const unsigned int d_name_type_len)
{
 ...
 if (d_name_type_len) {
  ...
  unsigned char d_type;
  if (umoven_or_printaddr((tcp), (d_type_addr), sizeof(*(&d_type)), (void *) (&d_type)))
   rc = -1;
  else
...
int sys_getdents(struct tcb *tcp)
{
...
print_old_dirent(struct tcb *const tcp, const kernel_ulong_t addr)
{
 ...
 if (umoven_or_printaddr((tcp), (addr), sizeof(*(&dent)), (void *) (&dent)))
  return;
 print_dentry_head(&dent);
 tprint_struct_next();
 tprints_field_name("d_name");
 printpathn(tcp, addr + header_size,
     (((dent.d_reclen) < (256)) ? (dent.d_reclen) : (256)));
 tprint_struct_end();
}
int sys_readdir(struct tcb *tcp)
{
 if ((!((tcp)->flags & 0x04))) {
  ...
  if (count != 1) {
   tprint_arg_next();
   tprintf("%llu", (sizeof(count) == sizeof(char) ? (unsigned long long) (unsigned char) (count) : sizeof(count) == sizeof(short) ? (unsigned long long) (unsigned short) (count) : sizeof(count) == sizeof(int) ? (unsigned long long) (unsigned int) (count) : sizeof(count) == sizeof(long) ? (unsigned long long) (unsigned long) (count) : (unsigned long long) (count)));
  }
 }
 return 0;
}
