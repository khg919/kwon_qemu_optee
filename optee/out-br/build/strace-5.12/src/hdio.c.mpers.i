...
static const struct xlat_data hdio_drive_cmds_xdata[] = {
 { (unsigned)(0x00), "ATA_CMD_NOP" },
 { (unsigned)(0x03), "ATA_CMD_CFA_REQ_EXT_ERR" },
 { (unsigned)(0x06), "ATA_CMD_DSM" },
 { (unsigned)(0x08), "ATA_CMD_DEV_RESET" },
 { (unsigned)(0x0B), "ATA_CMD_REQ_SENSE_DATA" },
 { (unsigned)(0x10), "ATA_CMD_RESTORE" },
 { (unsigned)(0x20), "ATA_CMD_PIO_READ" },
 { (unsigned)(0x22), "ATA_CMD_READ_LONG" },
 { (unsigned)(0x23), "ATA_CMD_READ_LONG_ONCE" },
 { (unsigned)(0x24), "ATA_CMD_PIO_READ_EXT" },
 { (unsigned)(0x25), "ATA_CMD_READ_EXT" },
 { (unsigned)(0x26), "ATA_CMD_READ_QUEUED" },
 { (unsigned)(0x27), "ATA_CMD_READ_NATIVE_MAX_EXT" },
 { (unsigned)(0x29), "ATA_CMD_READ_MULTI_EXT" },
 { (unsigned)(0x2A), "ATA_CMD_READ_STREAM_DMA_EXT" },
 { (unsigned)(0x2B), "ATA_CMD_READ_STREAM_EXT" },
 { (unsigned)(0x2F), "ATA_CMD_READ_LOG_EXT" },
 { (unsigned)(0x30), "ATA_CMD_PIO_WRITE" },
 { (unsigned)(0x32), "ATA_CMD_WRITE_LONG" },
 { (unsigned)(0x33), "ATA_CMD_WRITE_LONG_ONCE" },
 { (unsigned)(0x34), "ATA_CMD_PIO_WRITE_EXT" },
 { (unsigned)(0x35), "ATA_CMD_WRITE_EXT" },
 { (unsigned)(0x36), "ATA_CMD_WRITE_QUEUED" },
 { (unsigned)(0x37), "ATA_CMD_SET_MAX_EXT" },
 { (unsigned)(0x38), "ATA_CMD_CFA_WRITE_NE" },
 { (unsigned)(0x39), "ATA_CMD_WRITE_MULTI_EXT" },
 { (unsigned)(0x3A), "ATA_CMD_WRITE_STREAM_DMA_EXT" },
 { (unsigned)(0x3B), "ATA_CMD_WRITE_STREAM_EXT" },
 { (unsigned)(0x3D), "ATA_CMD_WRITE_FUA_EXT" },
 { (unsigned)(0x3E), "ATA_CMD_WRITE_QUEUED_FUA_EXT" },
 { (unsigned)(0x3F), "ATA_CMD_WRITE_LOG_EXT" },
 { (unsigned)(0x40), "ATA_CMD_VERIFY" },
 { (unsigned)(0x42), "ATA_CMD_VERIFY_EXT" },
 { (unsigned)(0x45), "ATA_CMD_WRITE_UNCORR_EXT" },
 { (unsigned)(0x47), "ATA_CMD_READ_LOG_DMA_EXT" },
 { (unsigned)(0x4A), "ATA_CMD_ZAC_MGMT_IN" },
 { (unsigned)(0x51), "ATA_CMD_CONFIG_STREAM" },
 { (unsigned)(0x57), "ATA_CMD_WRITE_LOG_DMA_EXT" },
 { (unsigned)(0x5B), "ATA_CMD_TRUSTED_NONDATA" },
 { (unsigned)(0x5C), "ATA_CMD_TRUSTED_RCV" },
 { (unsigned)(0x5D), "ATA_CMD_TRUSTED_RCV_DMA" },
 { (unsigned)(0x5E), "ATA_CMD_TRUSTED_SND" },
 { (unsigned)(0x5F), "ATA_CMD_TRUSTED_SND_DMA" },
 { (unsigned)(0x60), "ATA_CMD_FPDMA_READ" },
 { (unsigned)(0x61), "ATA_CMD_FPDMA_WRITE" },
 { (unsigned)(0x63), "ATA_CMD_NCQ_NON_DATA" },
 { (unsigned)(0x64), "ATA_CMD_FPDMA_SEND" },
 { (unsigned)(0x65), "ATA_CMD_FPDMA_RECV" },
 { (unsigned)(0x87), "ATA_CMD_CFA_TRANS_SECT" },
 { (unsigned)(0x90), "ATA_CMD_EDD" },
 { (unsigned)(0x91), "ATA_CMD_INIT_DEV_PARAMS" },
 { (unsigned)(0x92), "ATA_CMD_DOWNLOAD_MICRO" },
 { (unsigned)(0x93), "ATA_CMD_DOWNLOAD_MICRO_DMA" },
 { (unsigned)(0x9F), "ATA_CMD_ZAC_MGMT_OUT" },
 { (unsigned)(0xA0), "ATA_CMD_PACKET" },
 { (unsigned)(0xA1), "ATA_CMD_ID_ATAPI" },
 { (unsigned)(0xA2), "ATA_CMD_SERVICE" },
 { (unsigned)(0xB0), "ATA_CMD_SMART" },
 { (unsigned)(0xB1), "ATA_CMD_CONF_OVERLAY" },
 { (unsigned)(0xB4), "ATA_CMD_SANITIZE_DEVICE" },
 { (unsigned)(0xC0), "ATA_CMD_CFA_ERASE" },
 { (unsigned)(0xC4), "ATA_CMD_READ_MULTI" },
 { (unsigned)(0xC5), "ATA_CMD_WRITE_MULTI" },
 { (unsigned)(0xC6), "ATA_CMD_SET_MULTI" },
 { (unsigned)(0xC8), "ATA_CMD_READ" },
 { (unsigned)(0xCA), "ATA_CMD_WRITE" },
 { (unsigned)(0xCD), "ATA_CMD_CFA_WRITE_MULT_NE" },
 { (unsigned)(0xCE), "ATA_CMD_WRITE_MULTI_FUA_EXT" },
 { (unsigned)(0xD1), "ATA_CMD_CHK_MED_CRD_TYP" },
 { (unsigned)(0xDE), "ATA_CMD_MEDIA_LOCK" },
 { (unsigned)(0xDF), "ATA_CMD_MEDIA_UNLOCK" },
 { (unsigned)(0xE0), "ATA_CMD_STANDBYNOW1" },
 { (unsigned)(0xE1), "ATA_CMD_IDLEIMMEDIATE" },
 { (unsigned)(0xE2), "ATA_CMD_STANDBY" },
 { (unsigned)(0xE3), "ATA_CMD_IDLE" },
 { (unsigned)(0xE4), "ATA_CMD_PMP_READ" },
 { (unsigned)(0xE5), "ATA_CMD_CHK_POWER" },
 { (unsigned)(0xE6), "ATA_CMD_SLEEP" },
 { (unsigned)(0xE7), "ATA_CMD_FLUSH" },
 { (unsigned)(0xE8), "ATA_CMD_PMP_WRITE" },
 { (unsigned)(0xE9), "ATA_CMD_PMP_READ_DMA" },
 { (unsigned)(0xEA), "ATA_CMD_FLUSH_EXT" },
 { (unsigned)(0xEB), "ATA_CMD_PMP_WRITE_DMA" },
 { (unsigned)(0xEC), "ATA_CMD_ID_ATA" },
 { (unsigned)(0xEF), "ATA_CMD_SET_FEATURES" },
 { (unsigned)(0xF1), "ATA_CMD_SEC_SET_PASS" },
 { (unsigned)(0xF2), "ATA_CMD_SEC_UNLOCK" },
 { (unsigned)(0xF3), "ATA_CMD_SEC_ERASE_PREP" },
 { (unsigned)(0xF4), "ATA_CMD_SEC_ERASE_UNIT" },
 { (unsigned)(0xF5), "ATA_CMD_SEC_FREEZE_LOCK" },
 { (unsigned)(0xF6), "ATA_CMD_SEC_DISABLE_PASS" },
 { (unsigned)(0xF8), "ATA_CMD_READ_NATIVE_MAX" },
 { (unsigned)(0xF9), "ATA_CMD_SET_MAX" },
};
static
const struct xlat hdio_drive_cmds[1] = { {
 .data = hdio_drive_cmds_xdata,
 .size = (sizeof(hdio_drive_cmds_xdata) / sizeof((hdio_drive_cmds_xdata)[0]) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(typeof((hdio_drive_cmds_xdata)), typeof(&(hdio_drive_cmds_xdata)[0])))]) * 0)),
 .type = XT_SORTED,
 .flags_mask = 0
  | ((unsigned) (0x00))
  | ((unsigned) (0x03))
 ...
 .flags_strsz = 0
  + sizeof("ATA_CMD_NOP")
  + sizeof("ATA_CMD_CFA_REQ_EXT_ERR")
  + sizeof("ATA_CMD_DSM")
  + sizeof("ATA_CMD_DEV_RESET")
  + sizeof("ATA_CMD_REQ_SENSE_DATA")
  + sizeof("ATA_CMD_RESTORE")
  + sizeof("ATA_CMD_PIO_READ")
  + sizeof("ATA_CMD_READ_LONG")
  + sizeof("ATA_CMD_READ_LONG_ONCE")
  + sizeof("ATA_CMD_PIO_READ_EXT")
  + sizeof("ATA_CMD_READ_EXT")
  + sizeof("ATA_CMD_READ_QUEUED")
  + sizeof("ATA_CMD_READ_NATIVE_MAX_EXT")
  + sizeof("ATA_CMD_READ_MULTI_EXT")
  + sizeof("ATA_CMD_READ_STREAM_DMA_EXT")
  + sizeof("ATA_CMD_READ_STREAM_EXT")
  + sizeof("ATA_CMD_READ_LOG_EXT")
  + sizeof("ATA_CMD_PIO_WRITE")
  + sizeof("ATA_CMD_WRITE_LONG")
  + sizeof("ATA_CMD_WRITE_LONG_ONCE")
  + sizeof("ATA_CMD_PIO_WRITE_EXT")
  + sizeof("ATA_CMD_WRITE_EXT")
  + sizeof("ATA_CMD_WRITE_QUEUED")
  + sizeof("ATA_CMD_SET_MAX_EXT")
  + sizeof("ATA_CMD_CFA_WRITE_NE")
  + sizeof("ATA_CMD_WRITE_MULTI_EXT")
  + sizeof("ATA_CMD_WRITE_STREAM_DMA_EXT")
  + sizeof("ATA_CMD_WRITE_STREAM_EXT")
  + sizeof("ATA_CMD_WRITE_FUA_EXT")
  + sizeof("ATA_CMD_WRITE_QUEUED_FUA_EXT")
  + sizeof("ATA_CMD_WRITE_LOG_EXT")
  + sizeof("ATA_CMD_VERIFY")
  + sizeof("ATA_CMD_VERIFY_EXT")
  + sizeof("ATA_CMD_WRITE_UNCORR_EXT")
  + sizeof("ATA_CMD_READ_LOG_DMA_EXT")
  + sizeof("ATA_CMD_ZAC_MGMT_IN")
  + sizeof("ATA_CMD_CONFIG_STREAM")
  + sizeof("ATA_CMD_WRITE_LOG_DMA_EXT")
  + sizeof("ATA_CMD_TRUSTED_NONDATA")
  + sizeof("ATA_CMD_TRUSTED_RCV")
  + sizeof("ATA_CMD_TRUSTED_RCV_DMA")
  + sizeof("ATA_CMD_TRUSTED_SND")
  + sizeof("ATA_CMD_TRUSTED_SND_DMA")
  + sizeof("ATA_CMD_FPDMA_READ")
  + sizeof("ATA_CMD_FPDMA_WRITE")
  + sizeof("ATA_CMD_NCQ_NON_DATA")
  + sizeof("ATA_CMD_FPDMA_SEND")
  + sizeof("ATA_CMD_FPDMA_RECV")
  + sizeof("ATA_CMD_CFA_TRANS_SECT")
  + sizeof("ATA_CMD_EDD")
  + sizeof("ATA_CMD_INIT_DEV_PARAMS")
  + sizeof("ATA_CMD_DOWNLOAD_MICRO")
  + sizeof("ATA_CMD_DOWNLOAD_MICRO_DMA")
  + sizeof("ATA_CMD_ZAC_MGMT_OUT")
  + sizeof("ATA_CMD_PACKET")
  + sizeof("ATA_CMD_ID_ATAPI")
  + sizeof("ATA_CMD_SERVICE")
  + sizeof("ATA_CMD_SMART")
  + sizeof("ATA_CMD_CONF_OVERLAY")
  + sizeof("ATA_CMD_SANITIZE_DEVICE")
  + sizeof("ATA_CMD_CFA_ERASE")
  + sizeof("ATA_CMD_READ_MULTI")
  + sizeof("ATA_CMD_WRITE_MULTI")
  + sizeof("ATA_CMD_SET_MULTI")
  + sizeof("ATA_CMD_READ")
  + sizeof("ATA_CMD_WRITE")
  + sizeof("ATA_CMD_CFA_WRITE_MULT_NE")
  + sizeof("ATA_CMD_WRITE_MULTI_FUA_EXT")
  + sizeof("ATA_CMD_CHK_MED_CRD_TYP")
  + sizeof("ATA_CMD_MEDIA_LOCK")
  + sizeof("ATA_CMD_MEDIA_UNLOCK")
  + sizeof("ATA_CMD_STANDBYNOW1")
  + sizeof("ATA_CMD_IDLEIMMEDIATE")
  + sizeof("ATA_CMD_STANDBY")
  + sizeof("ATA_CMD_IDLE")
  + sizeof("ATA_CMD_PMP_READ")
  + sizeof("ATA_CMD_CHK_POWER")
  + sizeof("ATA_CMD_SLEEP")
  + sizeof("ATA_CMD_FLUSH")
  + sizeof("ATA_CMD_PMP_WRITE")
  + sizeof("ATA_CMD_PMP_READ_DMA")
  + sizeof("ATA_CMD_FLUSH_EXT")
  + sizeof("ATA_CMD_PMP_WRITE_DMA")
  + sizeof("ATA_CMD_ID_ATA")
  + sizeof("ATA_CMD_SET_FEATURES")
  + sizeof("ATA_CMD_SEC_SET_PASS")
  + sizeof("ATA_CMD_SEC_UNLOCK")
  + sizeof("ATA_CMD_SEC_ERASE_PREP")
  + sizeof("ATA_CMD_SEC_ERASE_UNIT")
  + sizeof("ATA_CMD_SEC_FREEZE_LOCK")
  + sizeof("ATA_CMD_SEC_DISABLE_PASS")
  + sizeof("ATA_CMD_READ_NATIVE_MAX")
  + sizeof("ATA_CMD_SET_MAX")
  ,
} };
static int
print_hdio_getgeo(struct tcb *const tcp, const kernel_ulong_t arg)
{
 ...
 if (umoven_or_printaddr((tcp), (arg), sizeof(*(&geo)), (void *) (&geo)))
  return 0200;
 tprint_struct_begin();
 do { tprints_field_name("heads"); tprintf("%llu", (sizeof((geo).heads) == sizeof(char) ? (unsigned long long) (unsigned char) ((geo).heads) : sizeof((geo).heads) == sizeof(short) ? (unsigned long long) (unsigned short) ((geo).heads) : sizeof((geo).heads) == sizeof(int) ? (unsigned long long) (unsigned int) ((geo).heads) : sizeof((geo).heads) == sizeof(long) ? (unsigned long long) (unsigned long) ((geo).heads) : (unsigned long long) ((geo).heads))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("sectors"); tprintf("%llu", (sizeof((geo).sectors) == sizeof(char) ? (unsigned long long) (unsigned char) ((geo).sectors) : sizeof((geo).sectors) == sizeof(short) ? (unsigned long long) (unsigned short) ((geo).sectors) : sizeof((geo).sectors) == sizeof(int) ? (unsigned long long) (unsigned int) ((geo).sectors) : sizeof((geo).sectors) == sizeof(long) ? (unsigned long long) (unsigned long) ((geo).sectors) : (unsigned long long) ((geo).sectors))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("cylinders"); tprintf("%llu", (sizeof((geo).cylinders) == sizeof(char) ? (unsigned long long) (unsigned char) ((geo).cylinders) : sizeof((geo).cylinders) == sizeof(short) ? (unsigned long long) (unsigned short) ((geo).cylinders) : sizeof((geo).cylinders) == sizeof(int) ? (unsigned long long) (unsigned int) ((geo).cylinders) : sizeof((geo).cylinders) == sizeof(long) ? (unsigned long long) (unsigned long) ((geo).cylinders) : (unsigned long long) ((geo).cylinders))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("start"); tprintf("%llu", (sizeof((geo).start) == sizeof(char) ? (unsigned long long) (unsigned char) ((geo).start) : sizeof((geo).start) == sizeof(short) ? (unsigned long long) (unsigned short) ((geo).start) : sizeof((geo).start) == sizeof(int) ? (unsigned long long) (unsigned int) ((geo).start) : sizeof((geo).start) == sizeof(long) ? (unsigned long long) (unsigned long) ((geo).start) : (unsigned long long) ((geo).start))); } while (0);
 tprint_struct_end();
 return 0200;
}
static int
print_hdio_drive_cmd(struct tcb *const tcp, const kernel_ulong_t arg)
{
 ...
 if ((!((tcp)->flags & 0x04))) {
  ...
  if (umoven_or_printaddr((tcp), (arg), sizeof(*(&c)), (void *) (&c)))
   return 0200;
  tprint_struct_begin();
  do { tprints_field_name("command"); printxval64((hdio_drive_cmds), (sizeof((c).command) == sizeof(char) ? (unsigned long long) (unsigned char) ((c).command) : sizeof((c).command) == sizeof(short) ? (unsigned long long) (unsigned short) ((c).command) : sizeof((c).command) == sizeof(int) ? (unsigned long long) (unsigned int) ((c).command) : sizeof((c).command) == sizeof(long) ? (unsigned long long) (unsigned long) ((c).command) : (unsigned long long) ((c).command)), ("ATA_CMD_???")); } while (0);
  tprint_struct_next();
  do { tprints_field_name("sector_number"); tprintf("%llu", (sizeof((c).sector_number) == sizeof(char) ? (unsigned long long) (unsigned char) ((c).sector_number) : sizeof((c).sector_number) == sizeof(short) ? (unsigned long long) (unsigned short) ((c).sector_number) : sizeof((c).sector_number) == sizeof(int) ? (unsigned long long) (unsigned int) ((c).sector_number) : sizeof((c).sector_number) == sizeof(long) ? (unsigned long long) (unsigned long) ((c).sector_number) : (unsigned long long) ((c).sector_number))); } while (0);
  tprint_struct_next();
  do { tprints_field_name("feature"); tprintf("%llu", (sizeof((c).feature) == sizeof(char) ? (unsigned long long) (unsigned char) ((c).feature) : sizeof((c).feature) == sizeof(short) ? (unsigned long long) (unsigned short) ((c).feature) : sizeof((c).feature) == sizeof(int) ? (unsigned long long) (unsigned int) ((c).feature) : sizeof((c).feature) == sizeof(long) ? (unsigned long long) (unsigned long) ((c).feature) : (unsigned long long) ((c).feature))); } while (0);
  tprint_struct_next();
  do { tprints_field_name("sector_count"); tprintf("%llu", (sizeof((c).sector_count) == sizeof(char) ? (unsigned long long) (unsigned char) ((c).sector_count) : sizeof((c).sector_count) == sizeof(short) ? (unsigned long long) (unsigned short) ((c).sector_count) : sizeof((c).sector_count) == sizeof(int) ? (unsigned long long) (unsigned int) ((c).sector_count) : sizeof((c).sector_count) == sizeof(long) ? (unsigned long long) (unsigned long) ((c).sector_count) : (unsigned long long) ((c).sector_count))); } while (0);
  tprint_struct_end();
  return 0;
 }
 struct {
 ...
 if ((((tcp)->u_error != 0) && tcp->u_error != 5) || umoven((tcp), (arg), sizeof(*(&c)), (void *) (&c)))
  return 0200;
 tprint_value_changed();
 tprint_struct_begin();
 do { tprints_field_name("status"); tprintf("%#llx", (sizeof((c).status) == sizeof(char) ? (unsigned long long) (unsigned char) ((c).status) : sizeof((c).status) == sizeof(short) ? (unsigned long long) (unsigned short) ((c).status) : sizeof((c).status) == sizeof(int) ? (unsigned long long) (unsigned int) ((c).status) : sizeof((c).status) == sizeof(long) ? (unsigned long long) (unsigned long) ((c).status) : (unsigned long long) ((c).status))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("error"); tprintf("%llu", (sizeof((c).error) == sizeof(char) ? (unsigned long long) (unsigned char) ((c).error) : sizeof((c).error) == sizeof(short) ? (unsigned long long) (unsigned short) ((c).error) : sizeof((c).error) == sizeof(int) ? (unsigned long long) (unsigned int) ((c).error) : sizeof((c).error) == sizeof(long) ? (unsigned long long) (unsigned long) ((c).error) : (unsigned long long) ((c).error))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("nsector"); tprintf("%llu", (sizeof((c).nsector) == sizeof(char) ? (unsigned long long) (unsigned char) ((c).nsector) : sizeof((c).nsector) == sizeof(short) ? (unsigned long long) (unsigned short) ((c).nsector) : sizeof((c).nsector) == sizeof(int) ? (unsigned long long) (unsigned int) ((c).nsector) : sizeof((c).nsector) == sizeof(long) ? (unsigned long long) (unsigned long) ((c).nsector) : (unsigned long long) ((c).nsector))); } while (0);
 if (c.sector_count) {
  tprint_struct_next();
...
MPERS_PRINTER_DECL(int, hdio_ioctl, struct tcb *const tcp, const unsigned int code, const kernel_ulong_t arg)
{
 switch (code) {
 case 0x0301:
