...
#pragma GCC diagnostic ignored "-Wtautological-compare"
 ;
_Static_assert((1) == (1), "BLKPG_ADD_PARTITION != 1");
...
#pragma GCC diagnostic ignored "-Wtautological-compare"
 ;
_Static_assert((2) == (2), "BLKPG_DEL_PARTITION != 2");
...
#pragma GCC diagnostic ignored "-Wtautological-compare"
 ;
_Static_assert((3) == (3), "BLKPG_RESIZE_PARTITION != 3");

#pragma GCC diagnostic pop
;
static const struct xlat_data blkpg_ops_xdata[] = {
 [1] = { (unsigned)(1), "BLKPG_ADD_PARTITION" },
 [2] = { (unsigned)(2), "BLKPG_DEL_PARTITION" },
 [3] = { (unsigned)(3), "BLKPG_RESIZE_PARTITION" },
};
static
const struct xlat blkpg_ops[1] = { {
 .data = blkpg_ops_xdata,
 .size = (sizeof(blkpg_ops_xdata) / sizeof((blkpg_ops_xdata)[0]) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(typeof((blkpg_ops_xdata)), typeof(&(blkpg_ops_xdata)[0])))]) * 0)),
 .type = XT_INDEXED,
 .flags_mask = 0
  | ((unsigned) (1))
  | ((unsigned) (2))
  ...
  ,
 .flags_strsz = 0
  + sizeof("BLKPG_ADD_PARTITION")
  + sizeof("BLKPG_DEL_PARTITION")
  + sizeof("BLKPG_RESIZE_PARTITION")
  ,
} };
static void
print_blkpg_req(struct tcb *tcp, const struct_blkpg_ioctl_arg *blkpg)
{
 ...
 tprint_struct_begin();
 do { tprints_field_name("op"); printxval64((blkpg_ops), (sizeof((*blkpg).op) == sizeof(char) ? (unsigned long long) (unsigned char) ((*blkpg).op) : sizeof((*blkpg).op) == sizeof(short) ? (unsigned long long) (unsigned short) ((*blkpg).op) : sizeof((*blkpg).op) == sizeof(int) ? (unsigned long long) (unsigned int) ((*blkpg).op) : sizeof((*blkpg).op) == sizeof(long) ? (unsigned long long) (unsigned long) ((*blkpg).op) : (unsigned long long) ((*blkpg).op)), ("BLKPG_???")); } while (0);
 tprint_struct_next();
 do { tprints_field_name("flags"); tprintf("%lld", (sizeof((*blkpg).flags) == sizeof(char) ? (long long) (char) ((*blkpg).flags) : sizeof((*blkpg).flags) == sizeof(short) ? (long long) (short) ((*blkpg).flags) : sizeof((*blkpg).flags) == sizeof(int) ? (long long) (int) ((*blkpg).flags) : sizeof((*blkpg).flags) == sizeof(long) ? (long long) (long) ((*blkpg).flags) : (long long) ((*blkpg).flags))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("datalen"); tprintf("%lld", (sizeof((*blkpg).datalen) == sizeof(char) ? (long long) (char) ((*blkpg).datalen) : sizeof((*blkpg).datalen) == sizeof(short) ? (long long) (short) ((*blkpg).datalen) : sizeof((*blkpg).datalen) == sizeof(int) ? (long long) (int) ((*blkpg).datalen) : sizeof((*blkpg).datalen) == sizeof(long) ? (long long) (long) ((*blkpg).datalen) : (long long) ((*blkpg).datalen))); } while (0);
 tprint_struct_next();
 tprints_field_name("data");
 if (!umoven_or_printaddr((tcp), (((kernel_ulong_t) (unsigned long) (blkpg->data))), sizeof(*(&p)), (void *) (&p))) {
  tprint_struct_begin();
  do { tprints_field_name("start"); tprintf("%lld", (sizeof((p).start) == sizeof(char) ? (long long) (char) ((p).start) : sizeof((p).start) == sizeof(short) ? (long long) (short) ((p).start) : sizeof((p).start) == sizeof(int) ? (long long) (int) ((p).start) : sizeof((p).start) == sizeof(long) ? (long long) (long) ((p).start) : (long long) ((p).start))); } while (0);
  tprint_struct_next();
  do { tprints_field_name("length"); tprintf("%lld", (sizeof((p).length) == sizeof(char) ? (long long) (char) ((p).length) : sizeof((p).length) == sizeof(short) ? (long long) (short) ((p).length) : sizeof((p).length) == sizeof(int) ? (long long) (int) ((p).length) : sizeof((p).length) == sizeof(long) ? (long long) (long) ((p).length) : (long long) ((p).length))); } while (0);
  tprint_struct_next();
  do { tprints_field_name("pno"); tprintf("%lld", (sizeof((p).pno) == sizeof(char) ? (long long) (char) ((p).pno) : sizeof((p).pno) == sizeof(short) ? (long long) (short) ((p).pno) : sizeof((p).pno) == sizeof(int) ? (long long) (int) ((p).pno) : sizeof((p).pno) == sizeof(long) ? (long long) (long) ((p).pno) : (long long) ((p).pno))); } while (0);
  tprint_struct_next();
  do { tprints_field_name("devname"); print_quoted_cstring((const char *) (p).devname, sizeof((p).devname) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(typeof(((p).devname)), typeof(&((p).devname)[0])))]) * 0)); } while (0);
  tprint_struct_next();
  do { tprints_field_name("volname"); print_quoted_cstring((const char *) (p).volname, sizeof((p).volname) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(typeof(((p).volname)), typeof(&((p).volname)[0])))]) * 0)); } while (0);
  tprint_struct_end();
 }
 tprint_struct_end();
}
MPERS_PRINTER_DECL(int, block_ioctl, struct tcb *const tcp, const unsigned int code, const kernel_ulong_t arg)
{
 switch (code) {
 case (((0U) << (((0 +8)+8)+14)) | (((0x12)) << (0 +8)) | (((98)) << 0) | ((0) << ((0 +8)+8))):
 case (((0U) << (((0 +8)+8)+14)) | (((0x12)) << (0 +8)) | (((100)) << 0) | ((0) << ((0 +8)+8))):
  tprint_arg_next();
  ...
  break;
 case (((0U) << (((0 +8)+8)+14)) | (((0x12)) << (0 +8)) | (((103)) << 0) | ((0) << ((0 +8)+8))):
 case (((0U) << (((0 +8)+8)+14)) | (((0x12)) << (0 +8)) | (((126)) << 0) | ((0) << ((0 +8)+8))):
  if ((!((tcp)->flags & 0x04)))
   return 0;
  tprint_arg_next();
  printnum_short(tcp, arg, "%hu");
  break;
 case (((0U) << (((0 +8)+8)+14)) | (((0x12)) << (0 +8)) | (((94)) << 0) | ((0) << ((0 +8)+8))):
 case (((2U) << (((0 +8)+8)+14)) | (((0x12)) << (0 +8)) | (((112)) << 0) | ((((sizeof(size_t)))) << ((0 +8)+8))):
 case (((0U) << (((0 +8)+8)+14)) | (((0x12)) << (0 +8)) | (((104)) << 0) | ((0) << ((0 +8)+8))):
 case (((0U) << (((0 +8)+8)+14)) | (((0x12)) << (0 +8)) | (((122)) << 0) | ((0) << ((0 +8)+8))):
  if ((!((tcp)->flags & 0x04)))
   return 0;
  __attribute__((__fallthrough__));
 case (((0U) << (((0 +8)+8)+14)) | (((0x12)) << (0 +8)) | (((93)) << 0) | ((0) << ((0 +8)+8))):
 case (((1U) << (((0 +8)+8)+14)) | (((0x12)) << (0 +8)) | (((113)) << 0) | ((((sizeof(size_t)))) << ((0 +8)+8))):
  tprint_arg_next();
  printnum_int(tcp, arg, "%d");
  break;
 case (((0U) << (((0 +8)+8)+14)) | (((0x12)) << (0 +8)) | (((123)) << 0) | ((0) << ((0 +8)+8))):
 case (((0U) << (((0 +8)+8)+14)) | (((0x12)) << (0 +8)) | (((120)) << 0) | ((0) << ((0 +8)+8))):
 case (((0U) << (((0 +8)+8)+14)) | (((0x12)) << (0 +8)) | (((121)) << 0) | ((0) << ((0 +8)+8))):
 case (((0U) << (((0 +8)+8)+14)) | (((0x12)) << (0 +8)) | (((124)) << 0) | ((0) << ((0 +8)+8))):
 case (((2U) << (((0 +8)+8)+14)) | (((0x12)) << (0 +8)) | (((132)) << 0) | ((((sizeof(__u32)))) << ((0 +8)+8))):
 case (((2U) << (((0 +8)+8)+14)) | (((0x12)) << (0 +8)) | (((133)) << 0) | ((((sizeof(__u32)))) << ((0 +8)+8))):
  if ((!((tcp)->flags & 0x04)))
   return 0;
  tprint_arg_next();
  printnum_int(tcp, arg, "%u");
  break;
 case (((0U) << (((0 +8)+8)+14)) | (((0x12)) << (0 +8)) | (((99)) << 0) | ((0) << ((0 +8)+8))):
 case (((0U) << (((0 +8)+8)+14)) | (((0x12)) << (0 +8)) | (((101)) << 0) | ((0) << ((0 +8)+8))):
  if ((!((tcp)->flags & 0x04)))
   return 0;
  tprint_arg_next();
  printnum_slong(tcp, arg);
  break;
 case (((0U) << (((0 +8)+8)+14)) | (((0x12)) << (0 +8)) | (((96)) << 0) | ((0) << ((0 +8)+8))):
  if ((!((tcp)->flags & 0x04)))
   return 0;
  tprint_arg_next();
  printnum_ulong(tcp, arg);
  break;
 case (((2U) << (((0 +8)+8)+14)) | (((0x12)) << (0 +8)) | (((114)) << 0) | ((((sizeof(size_t)))) << ((0 +8)+8))):
  if ((!((tcp)->flags & 0x04)))
   return 0;
  tprint_arg_next();
  printnum_int64(tcp, arg, "%" "ll" "u");
  break;
 case (((0U) << (((0 +8)+8)+14)) | (((0x12)) << (0 +8)) | (((119)) << 0) | ((0) << ((0 +8)+8))):
 case (((0U) << (((0 +8)+8)+14)) | (((0x12)) << (0 +8)) | (((125)) << 0) | ((0) << ((0 +8)+8))):
 case (((0U) << (((0 +8)+8)+14)) | (((0x12)) << (0 +8)) | (((127)) << 0) | ((0) << ((0 +8)+8))):
  tprint_arg_next();
  printpair_int64(tcp, arg, "%" "ll" "u");
  break;
 case (((0U) << (((0 +8)+8)+14)) | (((0x12)) << (0 +8)) | (((105)) << 0) | ((0) << ((0 +8)+8))): {
  struct_blkpg_ioctl_arg blkpg;
  tprint_arg_next();
  if (!umoven_or_printaddr((tcp), (arg), sizeof(*(&blkpg)), (void *) (&blkpg)))
   print_blkpg_req(tcp, &blkpg);
  break;
 }
 case (((2U|1U) << (((0 +8)+8)+14)) | (((0x12)) << (0 +8)) | (((115)) << 0) | ((((sizeof(struct blk_user_trace_setup)))) << ((0 +8)+8))):
  if ((!((tcp)->flags & 0x04))) {
   struct_blk_user_trace_setup buts;
   tprint_arg_next();
   if (umoven_or_printaddr((tcp), (arg), sizeof(*(&buts)), (void *) (&buts)))
    break;
   tprint_struct_begin();
   do { tprints_field_name("act_mask"); tprintf("%llu", (sizeof((buts).act_mask) == sizeof(char) ? (unsigned long long) (unsigned char) ((buts).act_mask) : sizeof((buts).act_mask) == sizeof(short) ? (unsigned long long) (unsigned short) ((buts).act_mask) : sizeof((buts).act_mask) == sizeof(int) ? (unsigned long long) (unsigned int) ((buts).act_mask) : sizeof((buts).act_mask) == sizeof(long) ? (unsigned long long) (unsigned long) ((buts).act_mask) : (unsigned long long) ((buts).act_mask))); } while (0);
   tprint_struct_next();
   do { tprints_field_name("buf_size"); tprintf("%llu", (sizeof((buts).buf_size) == sizeof(char) ? (unsigned long long) (unsigned char) ((buts).buf_size) : sizeof((buts).buf_size) == sizeof(short) ? (unsigned long long) (unsigned short) ((buts).buf_size) : sizeof((buts).buf_size) == sizeof(int) ? (unsigned long long) (unsigned int) ((buts).buf_size) : sizeof((buts).buf_size) == sizeof(long) ? (unsigned long long) (unsigned long) ((buts).buf_size) : (unsigned long long) ((buts).buf_size))); } while (0);
   tprint_struct_next();
   do { tprints_field_name("buf_nr"); tprintf("%llu", (sizeof((buts).buf_nr) == sizeof(char) ? (unsigned long long) (unsigned char) ((buts).buf_nr) : sizeof((buts).buf_nr) == sizeof(short) ? (unsigned long long) (unsigned short) ((buts).buf_nr) : sizeof((buts).buf_nr) == sizeof(int) ? (unsigned long long) (unsigned int) ((buts).buf_nr) : sizeof((buts).buf_nr) == sizeof(long) ? (unsigned long long) (unsigned long) ((buts).buf_nr) : (unsigned long long) ((buts).buf_nr))); } while (0);
   tprint_struct_next();
   do { tprints_field_name("start_lba"); tprintf("%llu", (sizeof((buts).start_lba) == sizeof(char) ? (unsigned long long) (unsigned char) ((buts).start_lba) : sizeof((buts).start_lba) == sizeof(short) ? (unsigned long long) (unsigned short) ((buts).start_lba) : sizeof((buts).start_lba) == sizeof(int) ? (unsigned long long) (unsigned int) ((buts).start_lba) : sizeof((buts).start_lba) == sizeof(long) ? (unsigned long long) (unsigned long) ((buts).start_lba) : (unsigned long long) ((buts).start_lba))); } while (0);
   tprint_struct_next();
   do { tprints_field_name("end_lba"); tprintf("%llu", (sizeof((buts).end_lba) == sizeof(char) ? (unsigned long long) (unsigned char) ((buts).end_lba) : sizeof((buts).end_lba) == sizeof(short) ? (unsigned long long) (unsigned short) ((buts).end_lba) : sizeof((buts).end_lba) == sizeof(int) ? (unsigned long long) (unsigned int) ((buts).end_lba) : sizeof((buts).end_lba) == sizeof(long) ? (unsigned long long) (unsigned long) ((buts).end_lba) : (unsigned long long) ((buts).end_lba))); } while (0);
   tprint_struct_next();
   do { tprints_field_name("pid"); printpid((tcp), (buts).pid, PT_TGID); } while (0);
   return 0;
  } else {
   struct_blk_user_trace_setup buts;
   if (!((tcp)->u_error != 0) && !umoven((tcp), (arg), sizeof(*(&buts)), (void *) (&buts))) {
    tprint_struct_next();
    do { tprints_field_name("name"); print_quoted_cstring((const char *) (buts).name, sizeof((buts).name) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(typeof(((buts).name)), typeof(&((buts).name)[0])))]) * 0)); } while (0);
   }
   tprint_struct_end();
   break;
  }
 case (((0U) << (((0 +8)+8)+14)) | (((0x12)) << (0 +8)) | (((95)) << 0) | ((0) << ((0 +8)+8))):
 case (((0U) << (((0 +8)+8)+14)) | (((0x12)) << (0 +8)) | (((97)) << 0) | ((0) << ((0 +8)+8))):
 case (((0U) << (((0 +8)+8)+14)) | (((0x12)) << (0 +8)) | (((116)) << 0) | ((0) << ((0 +8)+8))):
 case (((0U) << (((0 +8)+8)+14)) | (((0x12)) << (0 +8)) | (((117)) << 0) | ((0) << ((0 +8)+8))):
 case (((0U) << (((0 +8)+8)+14)) | (((0x12)) << (0 +8)) | (((118)) << 0) | ((0) << ((0 +8)+8))):
  break;
 default:
  return 0100;
 }
