...
#pragma GCC diagnostic ignored "-Wtautological-compare"
 ;
_Static_assert((SIGEV_SIGNAL) == (0), "SIGEV_SIGNAL != 0");
...
#pragma GCC diagnostic ignored "-Wtautological-compare"
 ;
_Static_assert((SIGEV_NONE) == (1), "SIGEV_NONE != 1");
...
#pragma GCC diagnostic ignored "-Wtautological-compare"
 ;
_Static_assert((SIGEV_THREAD) == (2), "SIGEV_THREAD != 2");
...
#pragma GCC diagnostic ignored "-Wtautological-compare"
 ;
_Static_assert((SIGEV_THREAD_ID) == (4), "SIGEV_THREAD_ID != 4");

#pragma GCC diagnostic pop
;
static const struct xlat_data sigev_value_xdata[] = {
 [SIGEV_SIGNAL] = { (unsigned)(SIGEV_SIGNAL), "SIGEV_SIGNAL" },
 [SIGEV_NONE] = { (unsigned)(SIGEV_NONE), "SIGEV_NONE" },
 [SIGEV_THREAD] = { (unsigned)(SIGEV_THREAD), "SIGEV_THREAD" },
 [SIGEV_THREAD_ID] = { (unsigned)(SIGEV_THREAD_ID), "SIGEV_THREAD_ID" },
};
static
const struct xlat sigev_value[1] = { {
 .data = sigev_value_xdata,
 .size = (sizeof(sigev_value_xdata) / sizeof((sigev_value_xdata)[0]) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(typeof((sigev_value_xdata)), typeof(&(sigev_value_xdata)[0])))]) * 0)),
 .type = XT_INDEXED,
 .flags_mask = 0
  | ((unsigned) (SIGEV_SIGNAL))
  | ((unsigned) (SIGEV_NONE))
  | ((unsigned) (SIGEV_THREAD))
  | ((unsigned) (SIGEV_THREAD_ID))
  ,
 .flags_strsz = 0
  + sizeof("SIGEV_SIGNAL")
  + sizeof("SIGEV_NONE")
  + sizeof("SIGEV_THREAD")
  + sizeof("SIGEV_THREAD_ID")
  ,
} };
static void
print_sigev_value(const typeof(((struct_sigevent *)0)->sigev_value) v)
{
 tprint_struct_begin();
 do { tprints_field_name("sival_int"); tprintf("%lld", (sizeof((v).sival_int) == sizeof(char) ? (long long) (char) ((v).sival_int) : sizeof((v).sival_int) == sizeof(short) ? (long long) (short) ((v).sival_int) : sizeof((v).sival_int) == sizeof(int) ? (long long) (int) ((v).sival_int) : sizeof((v).sival_int) == sizeof(long) ? (long long) (long) ((v).sival_int) : (long long) ((v).sival_int))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("sival_ptr"); printaddr((mpers_ptr_t) (v).sival_ptr); } while (0);
 tprint_struct_end();
}
MPERS_PRINTER_DECL(void, print_sigevent, struct tcb *const tcp, const kernel_ulong_t addr)
{
 struct_sigevent sev;
 if (umoven_or_printaddr((tcp), (addr), sizeof(*(&sev)), (void *) (&sev)))
  return;
 tprint_struct_begin();
 if (sev.sigev_value.sival_ptr) {
  do { tprints_field_name("sigev_value"); (print_sigev_value)((sev).sigev_value); } while (0);
  tprint_struct_next();
 }
 ...
 case SIGEV_THREAD_ID:
  do { tprints_field_name("sigev_signo"); (printsignal)((sev).sigev_signo); } while (0);
  break;
 default:
  do { tprints_field_name("sigev_signo"); tprintf("%llu", (sizeof((sev).sigev_signo) == sizeof(char) ? (unsigned long long) (unsigned char) ((sev).sigev_signo) : sizeof((sev).sigev_signo) == sizeof(short) ? (unsigned long long) (unsigned short) ((sev).sigev_signo) : sizeof((sev).sigev_signo) == sizeof(int) ? (unsigned long long) (unsigned int) ((sev).sigev_signo) : sizeof((sev).sigev_signo) == sizeof(long) ? (unsigned long long) (unsigned long) ((sev).sigev_signo) : (unsigned long long) ((sev).sigev_signo))); } while (0);
 }
 tprint_struct_next();
 do { tprints_field_name("sigev_notify"); printxval64((sigev_value), (sizeof((sev).sigev_notify) == sizeof(char) ? (unsigned long long) (unsigned char) ((sev).sigev_notify) : sizeof((sev).sigev_notify) == sizeof(short) ? (unsigned long long) (unsigned short) ((sev).sigev_notify) : sizeof((sev).sigev_notify) == sizeof(int) ? (unsigned long long) (unsigned int) ((sev).sigev_notify) : sizeof((sev).sigev_notify) == sizeof(long) ? (unsigned long long) (unsigned long) ((sev).sigev_notify) : (unsigned long long) ((sev).sigev_notify)), ("SIGEV_???")); } while (0);
 switch (sev.sigev_notify) {
 case SIGEV_THREAD_ID:
  tprint_struct_next();
  do { tprints_field_name("sigev_notify_thread_id"); tprintf("%lld", (sizeof((sev).sigev_un.tid) == sizeof(char) ? (long long) (char) ((sev).sigev_un.tid) : sizeof((sev).sigev_un.tid) == sizeof(short) ? (long long) (short) ((sev).sigev_un.tid) : sizeof((sev).sigev_un.tid) == sizeof(int) ? (long long) (int) ((sev).sigev_un.tid) : sizeof((sev).sigev_un.tid) == sizeof(long) ? (long long) (long) ((sev).sigev_un.tid) : (long long) ((sev).sigev_un.tid))); } while (0);
  break;
 case SIGEV_THREAD:
  tprint_struct_next();
  do { tprints_field_name("sigev_notify_function"); printaddr((mpers_ptr_t) (sev).sigev_un.sigev_thread.function); } while (0);
  tprint_struct_next();
  do { tprints_field_name("sigev_notify_attributes"); printaddr((mpers_ptr_t) (sev).sigev_un.sigev_thread.attribute); } while (0);
  break;
 }
 tprint_struct_end();
}
