...
int sys_sysinfo(struct tcb *tcp)
{
 sysinfo_t si;
 if ((!((tcp)->flags & 0x04)))
  return 0;
 if (!umoven_or_printaddr((tcp), (tcp->u_arg[0]), sizeof(*(&si)), (void *) (&si))) {
  tprint_struct_begin();
  do { tprints_field_name("uptime"); tprintf("%llu", (sizeof((si).uptime) == sizeof(char) ? (unsigned long long) (unsigned char) ((si).uptime) : sizeof((si).uptime) == sizeof(short) ? (unsigned long long) (unsigned short) ((si).uptime) : sizeof((si).uptime) == sizeof(int) ? (unsigned long long) (unsigned int) ((si).uptime) : sizeof((si).uptime) == sizeof(long) ? (unsigned long long) (unsigned long) ((si).uptime) : (unsigned long long) ((si).uptime))); } while (0);
  tprint_struct_next();
  do { tprints_field_name("loads"); print_local_array_ex(((tcp)), ((si).loads), (sizeof((si).loads) / sizeof(((si).loads)[0]) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(typeof(((si).loads)), typeof(&((si).loads)[0])))]) * 0)), sizeof(((si).loads)[0]), ((print_kulong_array_member)), ((void *)0), 0, ((void *)0), ((void *)0)); } while (0);
  tprint_struct_next();
  do { tprints_field_name("totalram"); tprintf("%llu", (sizeof((si).totalram) == sizeof(char) ? (unsigned long long) (unsigned char) ((si).totalram) : sizeof((si).totalram) == sizeof(short) ? (unsigned long long) (unsigned short) ((si).totalram) : sizeof((si).totalram) == sizeof(int) ? (unsigned long long) (unsigned int) ((si).totalram) : sizeof((si).totalram) == sizeof(long) ? (unsigned long long) (unsigned long) ((si).totalram) : (unsigned long long) ((si).totalram))); } while (0);
  tprint_struct_next();
  do { tprints_field_name("freeram"); tprintf("%llu", (sizeof((si).freeram) == sizeof(char) ? (unsigned long long) (unsigned char) ((si).freeram) : sizeof((si).freeram) == sizeof(short) ? (unsigned long long) (unsigned short) ((si).freeram) : sizeof((si).freeram) == sizeof(int) ? (unsigned long long) (unsigned int) ((si).freeram) : sizeof((si).freeram) == sizeof(long) ? (unsigned long long) (unsigned long) ((si).freeram) : (unsigned long long) ((si).freeram))); } while (0);
  tprint_struct_next();
  do { tprints_field_name("sharedram"); tprintf("%llu", (sizeof((si).sharedram) == sizeof(char) ? (unsigned long long) (unsigned char) ((si).sharedram) : sizeof((si).sharedram) == sizeof(short) ? (unsigned long long) (unsigned short) ((si).sharedram) : sizeof((si).sharedram) == sizeof(int) ? (unsigned long long) (unsigned int) ((si).sharedram) : sizeof((si).sharedram) == sizeof(long) ? (unsigned long long) (unsigned long) ((si).sharedram) : (unsigned long long) ((si).sharedram))); } while (0);
  tprint_struct_next();
  do { tprints_field_name("bufferram"); tprintf("%llu", (sizeof((si).bufferram) == sizeof(char) ? (unsigned long long) (unsigned char) ((si).bufferram) : sizeof((si).bufferram) == sizeof(short) ? (unsigned long long) (unsigned short) ((si).bufferram) : sizeof((si).bufferram) == sizeof(int) ? (unsigned long long) (unsigned int) ((si).bufferram) : sizeof((si).bufferram) == sizeof(long) ? (unsigned long long) (unsigned long) ((si).bufferram) : (unsigned long long) ((si).bufferram))); } while (0);
  tprint_struct_next();
  do { tprints_field_name("totalswap"); tprintf("%llu", (sizeof((si).totalswap) == sizeof(char) ? (unsigned long long) (unsigned char) ((si).totalswap) : sizeof((si).totalswap) == sizeof(short) ? (unsigned long long) (unsigned short) ((si).totalswap) : sizeof((si).totalswap) == sizeof(int) ? (unsigned long long) (unsigned int) ((si).totalswap) : sizeof((si).totalswap) == sizeof(long) ? (unsigned long long) (unsigned long) ((si).totalswap) : (unsigned long long) ((si).totalswap))); } while (0);
  tprint_struct_next();
  do { tprints_field_name("freeswap"); tprintf("%llu", (sizeof((si).freeswap) == sizeof(char) ? (unsigned long long) (unsigned char) ((si).freeswap) : sizeof((si).freeswap) == sizeof(short) ? (unsigned long long) (unsigned short) ((si).freeswap) : sizeof((si).freeswap) == sizeof(int) ? (unsigned long long) (unsigned int) ((si).freeswap) : sizeof((si).freeswap) == sizeof(long) ? (unsigned long long) (unsigned long) ((si).freeswap) : (unsigned long long) ((si).freeswap))); } while (0);
  tprint_struct_next();
  do { tprints_field_name("procs"); tprintf("%llu", (sizeof((si).procs) == sizeof(char) ? (unsigned long long) (unsigned char) ((si).procs) : sizeof((si).procs) == sizeof(short) ? (unsigned long long) (unsigned short) ((si).procs) : sizeof((si).procs) == sizeof(int) ? (unsigned long long) (unsigned int) ((si).procs) : sizeof((si).procs) == sizeof(long) ? (unsigned long long) (unsigned long) ((si).procs) : (unsigned long long) ((si).procs))); } while (0);
  tprint_struct_next();
  do { tprints_field_name("totalhigh"); tprintf("%llu", (sizeof((si).totalhigh) == sizeof(char) ? (unsigned long long) (unsigned char) ((si).totalhigh) : sizeof((si).totalhigh) == sizeof(short) ? (unsigned long long) (unsigned short) ((si).totalhigh) : sizeof((si).totalhigh) == sizeof(int) ? (unsigned long long) (unsigned int) ((si).totalhigh) : sizeof((si).totalhigh) == sizeof(long) ? (unsigned long long) (unsigned long) ((si).totalhigh) : (unsigned long long) ((si).totalhigh))); } while (0);
  tprint_struct_next();
  do { tprints_field_name("freehigh"); tprintf("%llu", (sizeof((si).freehigh) == sizeof(char) ? (unsigned long long) (unsigned char) ((si).freehigh) : sizeof((si).freehigh) == sizeof(short) ? (unsigned long long) (unsigned short) ((si).freehigh) : sizeof((si).freehigh) == sizeof(int) ? (unsigned long long) (unsigned int) ((si).freehigh) : sizeof((si).freehigh) == sizeof(long) ? (unsigned long long) (unsigned long) ((si).freehigh) : (unsigned long long) ((si).freehigh))); } while (0);
  tprint_struct_next();
  do { tprints_field_name("mem_unit"); tprintf("%llu", (sizeof((si).mem_unit) == sizeof(char) ? (unsigned long long) (unsigned char) ((si).mem_unit) : sizeof((si).mem_unit) == sizeof(short) ? (unsigned long long) (unsigned short) ((si).mem_unit) : sizeof((si).mem_unit) == sizeof(int) ? (unsigned long long) (unsigned int) ((si).mem_unit) : sizeof((si).mem_unit) == sizeof(long) ? (unsigned long long) (unsigned long) ((si).mem_unit) : (unsigned long long) ((si).mem_unit))); } while (0);
  tprint_struct_end();
 }
 return 0;
}
