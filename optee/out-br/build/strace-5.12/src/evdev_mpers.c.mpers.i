...
static void
print_ff_envelope(const struct ff_envelope * const arg)
{
 const struct ff_envelope *const p = arg;
 tprint_struct_begin();
 do { tprints_field_name("attack_length"); tprintf("%llu", (sizeof((*p).attack_length) == sizeof(char) ? (unsigned long long) (unsigned char) ((*p).attack_length) : sizeof((*p).attack_length) == sizeof(short) ? (unsigned long long) (unsigned short) ((*p).attack_length) : sizeof((*p).attack_length) == sizeof(int) ? (unsigned long long) (unsigned int) ((*p).attack_length) : sizeof((*p).attack_length) == sizeof(long) ? (unsigned long long) (unsigned long) ((*p).attack_length) : (unsigned long long) ((*p).attack_length))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("attack_level"); tprintf("%llu", (sizeof((*p).attack_level) == sizeof(char) ? (unsigned long long) (unsigned char) ((*p).attack_level) : sizeof((*p).attack_level) == sizeof(short) ? (unsigned long long) (unsigned short) ((*p).attack_level) : sizeof((*p).attack_level) == sizeof(int) ? (unsigned long long) (unsigned int) ((*p).attack_level) : sizeof((*p).attack_level) == sizeof(long) ? (unsigned long long) (unsigned long) ((*p).attack_level) : (unsigned long long) ((*p).attack_level))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("fade_length"); tprintf("%llu", (sizeof((*p).fade_length) == sizeof(char) ? (unsigned long long) (unsigned char) ((*p).fade_length) : sizeof((*p).fade_length) == sizeof(short) ? (unsigned long long) (unsigned short) ((*p).fade_length) : sizeof((*p).fade_length) == sizeof(int) ? (unsigned long long) (unsigned int) ((*p).fade_length) : sizeof((*p).fade_length) == sizeof(long) ? (unsigned long long) (unsigned long) ((*p).fade_length) : (unsigned long long) ((*p).fade_length))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("fade_level"); tprintf("%#llx", (sizeof((*p).fade_level) == sizeof(char) ? (unsigned long long) (unsigned char) ((*p).fade_level) : sizeof((*p).fade_level) == sizeof(short) ? (unsigned long long) (unsigned short) ((*p).fade_level) : sizeof((*p).fade_level) == sizeof(int) ? (unsigned long long) (unsigned int) ((*p).fade_level) : sizeof((*p).fade_level) == sizeof(long) ? (unsigned long long) (unsigned long) ((*p).fade_level) : (unsigned long long) ((*p).fade_level))); } while (0);
 tprint_struct_end();
}
static void
print_ff_trigger(const typeof(((struct_ff_effect *)0)->trigger) *const p)
{
 tprint_struct_begin();
 do { tprints_field_name("button"); tprintf("%llu", (sizeof((*p).button) == sizeof(char) ? (unsigned long long) (unsigned char) ((*p).button) : sizeof((*p).button) == sizeof(short) ? (unsigned long long) (unsigned short) ((*p).button) : sizeof((*p).button) == sizeof(int) ? (unsigned long long) (unsigned int) ((*p).button) : sizeof((*p).button) == sizeof(long) ? (unsigned long long) (unsigned long) ((*p).button) : (unsigned long long) ((*p).button))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("interval"); tprintf("%llu", (sizeof((*p).interval) == sizeof(char) ? (unsigned long long) (unsigned char) ((*p).interval) : sizeof((*p).interval) == sizeof(short) ? (unsigned long long) (unsigned short) ((*p).interval) : sizeof((*p).interval) == sizeof(int) ? (unsigned long long) (unsigned int) ((*p).interval) : sizeof((*p).interval) == sizeof(long) ? (unsigned long long) (unsigned long) ((*p).interval) : (unsigned long long) ((*p).interval))); } while (0);
 tprint_struct_end();
}
static void
print_ff_replay(const typeof(((struct_ff_effect *)0)->replay) *const p)
{
 tprint_struct_begin();
 do { tprints_field_name("length"); tprintf("%llu", (sizeof((*p).length) == sizeof(char) ? (unsigned long long) (unsigned char) ((*p).length) : sizeof((*p).length) == sizeof(short) ? (unsigned long long) (unsigned short) ((*p).length) : sizeof((*p).length) == sizeof(int) ? (unsigned long long) (unsigned int) ((*p).length) : sizeof((*p).length) == sizeof(long) ? (unsigned long long) (unsigned long) ((*p).length) : (unsigned long long) ((*p).length))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("delay"); tprintf("%llu", (sizeof((*p).delay) == sizeof(char) ? (unsigned long long) (unsigned char) ((*p).delay) : sizeof((*p).delay) == sizeof(short) ? (unsigned long long) (unsigned short) ((*p).delay) : sizeof((*p).delay) == sizeof(int) ? (unsigned long long) (unsigned int) ((*p).delay) : sizeof((*p).delay) == sizeof(long) ? (unsigned long long) (unsigned long) ((*p).delay) : (unsigned long long) ((*p).delay))); } while (0);
 tprint_struct_end();
}
static void
print_ff_constant_effect(const typeof(((struct_ff_effect *)0)->u.constant) *const p)
{
 tprint_struct_begin();
 do { tprints_field_name("level"); tprintf("%lld", (sizeof((*p).level) == sizeof(char) ? (long long) (char) ((*p).level) : sizeof((*p).level) == sizeof(short) ? (long long) (short) ((*p).level) : sizeof((*p).level) == sizeof(int) ? (long long) (int) ((*p).level) : sizeof((*p).level) == sizeof(long) ? (long long) (long) ((*p).level) : (long long) ((*p).level))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("envelope"); (print_ff_envelope)(&((*p).envelope)); } while (0);
 tprint_struct_end();
}
static void
print_ff_ramp_effect(const typeof(((struct_ff_effect *)0)->u.ramp) *const p)
{
 tprint_struct_begin();
 do { tprints_field_name("start_level"); tprintf("%lld", (sizeof((*p).start_level) == sizeof(char) ? (long long) (char) ((*p).start_level) : sizeof((*p).start_level) == sizeof(short) ? (long long) (short) ((*p).start_level) : sizeof((*p).start_level) == sizeof(int) ? (long long) (int) ((*p).start_level) : sizeof((*p).start_level) == sizeof(long) ? (long long) (long) ((*p).start_level) : (long long) ((*p).start_level))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("end_level"); tprintf("%lld", (sizeof((*p).end_level) == sizeof(char) ? (long long) (char) ((*p).end_level) : sizeof((*p).end_level) == sizeof(short) ? (long long) (short) ((*p).end_level) : sizeof((*p).end_level) == sizeof(int) ? (long long) (int) ((*p).end_level) : sizeof((*p).end_level) == sizeof(long) ? (long long) (long) ((*p).end_level) : (long long) ((*p).end_level))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("envelope"); (print_ff_envelope)(&((*p).envelope)); } while (0);
 tprint_struct_end();
}
static void
print_ff_periodic_effect(const typeof(((struct_ff_effect *)0)->u.periodic) *const p)
{
 tprint_struct_begin();
 do { tprints_field_name("waveform"); tprintf("%llu", (sizeof((*p).waveform) == sizeof(char) ? (unsigned long long) (unsigned char) ((*p).waveform) : sizeof((*p).waveform) == sizeof(short) ? (unsigned long long) (unsigned short) ((*p).waveform) : sizeof((*p).waveform) == sizeof(int) ? (unsigned long long) (unsigned int) ((*p).waveform) : sizeof((*p).waveform) == sizeof(long) ? (unsigned long long) (unsigned long) ((*p).waveform) : (unsigned long long) ((*p).waveform))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("period"); tprintf("%llu", (sizeof((*p).period) == sizeof(char) ? (unsigned long long) (unsigned char) ((*p).period) : sizeof((*p).period) == sizeof(short) ? (unsigned long long) (unsigned short) ((*p).period) : sizeof((*p).period) == sizeof(int) ? (unsigned long long) (unsigned int) ((*p).period) : sizeof((*p).period) == sizeof(long) ? (unsigned long long) (unsigned long) ((*p).period) : (unsigned long long) ((*p).period))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("magnitude"); tprintf("%lld", (sizeof((*p).magnitude) == sizeof(char) ? (long long) (char) ((*p).magnitude) : sizeof((*p).magnitude) == sizeof(short) ? (long long) (short) ((*p).magnitude) : sizeof((*p).magnitude) == sizeof(int) ? (long long) (int) ((*p).magnitude) : sizeof((*p).magnitude) == sizeof(long) ? (long long) (long) ((*p).magnitude) : (long long) ((*p).magnitude))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("offset"); tprintf("%lld", (sizeof((*p).offset) == sizeof(char) ? (long long) (char) ((*p).offset) : sizeof((*p).offset) == sizeof(short) ? (long long) (short) ((*p).offset) : sizeof((*p).offset) == sizeof(int) ? (long long) (int) ((*p).offset) : sizeof((*p).offset) == sizeof(long) ? (long long) (long) ((*p).offset) : (long long) ((*p).offset))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("phase"); tprintf("%llu", (sizeof((*p).phase) == sizeof(char) ? (unsigned long long) (unsigned char) ((*p).phase) : sizeof((*p).phase) == sizeof(short) ? (unsigned long long) (unsigned short) ((*p).phase) : sizeof((*p).phase) == sizeof(int) ? (unsigned long long) (unsigned int) ((*p).phase) : sizeof((*p).phase) == sizeof(long) ? (unsigned long long) (unsigned long) ((*p).phase) : (unsigned long long) ((*p).phase))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("envelope"); (print_ff_envelope)(&((*p).envelope)); } while (0);
 tprint_struct_next();
 do { tprints_field_name("custom_len"); tprintf("%llu", (sizeof((*p).custom_len) == sizeof(char) ? (unsigned long long) (unsigned char) ((*p).custom_len) : sizeof((*p).custom_len) == sizeof(short) ? (unsigned long long) (unsigned short) ((*p).custom_len) : sizeof((*p).custom_len) == sizeof(int) ? (unsigned long long) (unsigned int) ((*p).custom_len) : sizeof((*p).custom_len) == sizeof(long) ? (unsigned long long) (unsigned long) ((*p).custom_len) : (unsigned long long) ((*p).custom_len))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("custom_data"); printaddr((mpers_ptr_t) (*p).custom_data); } while (0);
 tprint_struct_end();
}
static void
print_ff_rumble_effect(const typeof(((struct_ff_effect *)0)->u.rumble) *const p)
{
 tprint_struct_begin();
 do { tprints_field_name("strong_magnitude"); tprintf("%llu", (sizeof((*p).strong_magnitude) == sizeof(char) ? (unsigned long long) (unsigned char) ((*p).strong_magnitude) : sizeof((*p).strong_magnitude) == sizeof(short) ? (unsigned long long) (unsigned short) ((*p).strong_magnitude) : sizeof((*p).strong_magnitude) == sizeof(int) ? (unsigned long long) (unsigned int) ((*p).strong_magnitude) : sizeof((*p).strong_magnitude) == sizeof(long) ? (unsigned long long) (unsigned long) ((*p).strong_magnitude) : (unsigned long long) ((*p).strong_magnitude))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("weak_magnitude"); tprintf("%llu", (sizeof((*p).weak_magnitude) == sizeof(char) ? (unsigned long long) (unsigned char) ((*p).weak_magnitude) : sizeof((*p).weak_magnitude) == sizeof(short) ? (unsigned long long) (unsigned short) ((*p).weak_magnitude) : sizeof((*p).weak_magnitude) == sizeof(int) ? (unsigned long long) (unsigned int) ((*p).weak_magnitude) : sizeof((*p).weak_magnitude) == sizeof(long) ? (unsigned long long) (unsigned long) ((*p).weak_magnitude) : (unsigned long long) ((*p).weak_magnitude))); } while (0);
 tprint_struct_end();
}
static int
ff_effect_ioctl(struct tcb *const tcp, const kernel_ulong_t arg)
{
 ...
 if (umoven_or_printaddr((tcp), (arg), sizeof(*(&ffe)), (void *) (&ffe)))
  return 0200;
 tprint_struct_begin();
 do { tprints_field_name("type"); (print_evdev_ff_type)((ffe).type); } while (0);
 tprint_struct_next();
 do { tprints_field_name("id"); tprintf("%lld", (sizeof((ffe).id) == sizeof(char) ? (long long) (char) ((ffe).id) : sizeof((ffe).id) == sizeof(short) ? (long long) (short) ((ffe).id) : sizeof((ffe).id) == sizeof(int) ? (long long) (int) ((ffe).id) : sizeof((ffe).id) == sizeof(long) ? (long long) (long) ((ffe).id) : (long long) ((ffe).id))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("direction"); tprintf("%llu", (sizeof((ffe).direction) == sizeof(char) ? (unsigned long long) (unsigned char) ((ffe).direction) : sizeof((ffe).direction) == sizeof(short) ? (unsigned long long) (unsigned short) ((ffe).direction) : sizeof((ffe).direction) == sizeof(int) ? (unsigned long long) (unsigned int) ((ffe).direction) : sizeof((ffe).direction) == sizeof(long) ? (unsigned long long) (unsigned long) ((ffe).direction) : (unsigned long long) ((ffe).direction))); } while (0);
 tprint_struct_next();
 ...
 do { tprints_field_name("trigger"); print_ff_trigger(&((ffe).trigger)); } while (0);
 tprint_struct_next();
 do { tprints_field_name("replay"); print_ff_replay(&((ffe).replay)); } while (0);
 switch (ffe.type) {
 case 0x52:
  tprint_struct_next();
  do { tprints_field_name("constant"); print_ff_constant_effect(&((ffe.u).constant)); } while (0);
  break;
 case 0x57:
  tprint_struct_next();
  do { tprints_field_name("ramp"); print_ff_ramp_effect(&((ffe.u).ramp)); } while (0);
  break;
 case 0x51:
  tprint_struct_next();
  do { tprints_field_name("periodic"); print_ff_periodic_effect(&((ffe.u).periodic)); } while (0);
  break;
 case 0x50:
  tprint_struct_next();
  do { tprints_field_name("rumble"); print_ff_rumble_effect(&((ffe.u).rumble)); } while (0);
  break;
 default:
  break;
 }
...
MPERS_PRINTER_DECL(int, evdev_write_ioctl_mpers, struct tcb *const tcp, const unsigned int code, const kernel_ulong_t arg)
{
 switch (code) {
 case (((1U) << (((0 +8)+8)+14)) | ((('E')) << (0 +8)) | (((0x80)) << 0) | ((((sizeof(struct ff_effect)))) << ((0 +8)+8))):
