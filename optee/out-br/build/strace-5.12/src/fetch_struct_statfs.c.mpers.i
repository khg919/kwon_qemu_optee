...
MPERS_PRINTER_DECL(_Bool, fetch_struct_statfs, struct tcb *const tcp, const kernel_ulong_t addr, struct strace_statfs *const p)
{
 struct_statfs b;
 if (umoven_or_printaddr((tcp), (addr), sizeof(*(&b)), (void *) (&b)))
  return 0;
 p->f_type = (sizeof(b.f_type) == sizeof(char) ? (unsigned long long) (unsigned char) (b.f_type) : sizeof(b.f_type) == sizeof(short) ? (unsigned long long) (unsigned short) (b.f_type) : sizeof(b.f_type) == sizeof(int) ? (unsigned long long) (unsigned int) (b.f_type) : sizeof(b.f_type) == sizeof(long) ? (unsigned long long) (unsigned long) (b.f_type) : (unsigned long long) (b.f_type));
 p->f_bsize = (sizeof(b.f_bsize) == sizeof(char) ? (unsigned long long) (unsigned char) (b.f_bsize) : sizeof(b.f_bsize) == sizeof(short) ? (unsigned long long) (unsigned short) (b.f_bsize) : sizeof(b.f_bsize) == sizeof(int) ? (unsigned long long) (unsigned int) (b.f_bsize) : sizeof(b.f_bsize) == sizeof(long) ? (unsigned long long) (unsigned long) (b.f_bsize) : (unsigned long long) (b.f_bsize));
 p->f_blocks = (sizeof(b.f_blocks) == sizeof(char) ? (unsigned long long) (unsigned char) (b.f_blocks) : sizeof(b.f_blocks) == sizeof(short) ? (unsigned long long) (unsigned short) (b.f_blocks) : sizeof(b.f_blocks) == sizeof(int) ? (unsigned long long) (unsigned int) (b.f_blocks) : sizeof(b.f_blocks) == sizeof(long) ? (unsigned long long) (unsigned long) (b.f_blocks) : (unsigned long long) (b.f_blocks));
 p->f_bfree = (sizeof(b.f_bfree) == sizeof(char) ? (unsigned long long) (unsigned char) (b.f_bfree) : sizeof(b.f_bfree) == sizeof(short) ? (unsigned long long) (unsigned short) (b.f_bfree) : sizeof(b.f_bfree) == sizeof(int) ? (unsigned long long) (unsigned int) (b.f_bfree) : sizeof(b.f_bfree) == sizeof(long) ? (unsigned long long) (unsigned long) (b.f_bfree) : (unsigned long long) (b.f_bfree));
 p->f_bavail = (sizeof(b.f_bavail) == sizeof(char) ? (unsigned long long) (unsigned char) (b.f_bavail) : sizeof(b.f_bavail) == sizeof(short) ? (unsigned long long) (unsigned short) (b.f_bavail) : sizeof(b.f_bavail) == sizeof(int) ? (unsigned long long) (unsigned int) (b.f_bavail) : sizeof(b.f_bavail) == sizeof(long) ? (unsigned long long) (unsigned long) (b.f_bavail) : (unsigned long long) (b.f_bavail));
 p->f_files = (sizeof(b.f_files) == sizeof(char) ? (unsigned long long) (unsigned char) (b.f_files) : sizeof(b.f_files) == sizeof(short) ? (unsigned long long) (unsigned short) (b.f_files) : sizeof(b.f_files) == sizeof(int) ? (unsigned long long) (unsigned int) (b.f_files) : sizeof(b.f_files) == sizeof(long) ? (unsigned long long) (unsigned long) (b.f_files) : (unsigned long long) (b.f_files));
 p->f_ffree = (sizeof(b.f_ffree) == sizeof(char) ? (unsigned long long) (unsigned char) (b.f_ffree) : sizeof(b.f_ffree) == sizeof(short) ? (unsigned long long) (unsigned short) (b.f_ffree) : sizeof(b.f_ffree) == sizeof(int) ? (unsigned long long) (unsigned int) (b.f_ffree) : sizeof(b.f_ffree) == sizeof(long) ? (unsigned long long) (unsigned long) (b.f_ffree) : (unsigned long long) (b.f_ffree));
 p->f_fsid.val[0] = (sizeof(b.f_fsid.val[0]) == sizeof(char) ? (unsigned long long) (unsigned char) (b.f_fsid.val[0]) : sizeof(b.f_fsid.val[0]) == sizeof(short) ? (unsigned long long) (unsigned short) (b.f_fsid.val[0]) : sizeof(b.f_fsid.val[0]) == sizeof(int) ? (unsigned long long) (unsigned int) (b.f_fsid.val[0]) : sizeof(b.f_fsid.val[0]) == sizeof(long) ? (unsigned long long) (unsigned long) (b.f_fsid.val[0]) : (unsigned long long) (b.f_fsid.val[0]));
 p->f_fsid.val[1] = (sizeof(b.f_fsid.val[1]) == sizeof(char) ? (unsigned long long) (unsigned char) (b.f_fsid.val[1]) : sizeof(b.f_fsid.val[1]) == sizeof(short) ? (unsigned long long) (unsigned short) (b.f_fsid.val[1]) : sizeof(b.f_fsid.val[1]) == sizeof(int) ? (unsigned long long) (unsigned int) (b.f_fsid.val[1]) : sizeof(b.f_fsid.val[1]) == sizeof(long) ? (unsigned long long) (unsigned long) (b.f_fsid.val[1]) : (unsigned long long) (b.f_fsid.val[1]));
 p->f_namelen = (sizeof(b.f_namelen) == sizeof(char) ? (unsigned long long) (unsigned char) (b.f_namelen) : sizeof(b.f_namelen) == sizeof(short) ? (unsigned long long) (unsigned short) (b.f_namelen) : sizeof(b.f_namelen) == sizeof(int) ? (unsigned long long) (unsigned int) (b.f_namelen) : sizeof(b.f_namelen) == sizeof(long) ? (unsigned long long) (unsigned long) (b.f_namelen) : (unsigned long long) (b.f_namelen));
 p->f_frsize = (sizeof(b.f_frsize) == sizeof(char) ? (unsigned long long) (unsigned char) (b.f_frsize) : sizeof(b.f_frsize) == sizeof(short) ? (unsigned long long) (unsigned short) (b.f_frsize) : sizeof(b.f_frsize) == sizeof(int) ? (unsigned long long) (unsigned int) (b.f_frsize) : sizeof(b.f_frsize) == sizeof(long) ? (unsigned long long) (unsigned long) (b.f_frsize) : (unsigned long long) (b.f_frsize));
 p->f_flags = (sizeof(b.f_flags) == sizeof(char) ? (unsigned long long) (unsigned char) (b.f_flags) : sizeof(b.f_flags) == sizeof(short) ? (unsigned long long) (unsigned short) (b.f_flags) : sizeof(b.f_flags) == sizeof(int) ? (unsigned long long) (unsigned int) (b.f_flags) : sizeof(b.f_flags) == sizeof(long) ? (unsigned long long) (unsigned long) (b.f_flags) : (unsigned long long) (b.f_flags));
 return 1;
}
MPERS_PRINTER_DECL(_Bool, fetch_struct_statfs64, struct tcb *const tcp, const kernel_ulong_t addr, const kernel_ulong_t size, struct strace_statfs *const p)
{
 struct_statfs64 b;
 if (sizeof(b) != size
     && sizeof(b) != (sizeof(struct_statfs64) + 4)
    ) {
  printaddr(addr);
  return 0;
 }
