...
static const struct xlat_data mtd_mode_options_xdata[] = {
 [MTD_OPS_PLACE_OOB] = { (unsigned)(MTD_OPS_PLACE_OOB), "MTD_OPS_PLACE_OOB" },
 [MTD_OPS_AUTO_OOB] = { (unsigned)(MTD_OPS_AUTO_OOB), "MTD_OPS_AUTO_OOB" },
 [MTD_OPS_RAW] = { (unsigned)(MTD_OPS_RAW), "MTD_OPS_RAW" },
};
static
const struct xlat mtd_mode_options[1] = { {
 .data = mtd_mode_options_xdata,
 .size = (sizeof(mtd_mode_options_xdata) / sizeof((mtd_mode_options_xdata)[0]) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(typeof((mtd_mode_options_xdata)), typeof(&(mtd_mode_options_xdata)[0])))]) * 0)),
 .type = XT_INDEXED,
 .flags_mask = 0
  | ((unsigned) (MTD_OPS_PLACE_OOB))
  | ((unsigned) (MTD_OPS_AUTO_OOB))
  | ((unsigned) (MTD_OPS_RAW))
  ,
 .flags_strsz = 0
  + sizeof("MTD_OPS_PLACE_OOB")
  + sizeof("MTD_OPS_AUTO_OOB")
  + sizeof("MTD_OPS_RAW")
  ,
} };
static const struct xlat_data mtd_file_mode_options_xdata[] = {
 [MTD_FILE_MODE_NORMAL] = { (unsigned)(MTD_FILE_MODE_NORMAL), "MTD_FILE_MODE_NORMAL" },
 [MTD_FILE_MODE_OTP_FACTORY] = { (unsigned)(MTD_FILE_MODE_OTP_FACTORY), "MTD_FILE_MODE_OTP_FACTORY" },
 [MTD_FILE_MODE_OTP_USER] = { (unsigned)(MTD_FILE_MODE_OTP_USER), "MTD_FILE_MODE_OTP_USER" },
 [MTD_FILE_MODE_RAW] = { (unsigned)(MTD_FILE_MODE_RAW), "MTD_FILE_MODE_RAW" },
};
static
const struct xlat mtd_file_mode_options[1] = { {
 .data = mtd_file_mode_options_xdata,
 .size = (sizeof(mtd_file_mode_options_xdata) / sizeof((mtd_file_mode_options_xdata)[0]) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(typeof((mtd_file_mode_options_xdata)), typeof(&(mtd_file_mode_options_xdata)[0])))]) * 0)),
 .type = XT_INDEXED,
 .flags_mask = 0
  | ((unsigned) (MTD_FILE_MODE_NORMAL))
  | ((unsigned) (MTD_FILE_MODE_OTP_FACTORY))
  | ((unsigned) (MTD_FILE_MODE_OTP_USER))
  | ((unsigned) (MTD_FILE_MODE_RAW))
  ,
 .flags_strsz = 0
  + sizeof("MTD_FILE_MODE_NORMAL")
  + sizeof("MTD_FILE_MODE_OTP_FACTORY")
  + sizeof("MTD_FILE_MODE_OTP_USER")
  + sizeof("MTD_FILE_MODE_RAW")
  ,
} };
static const struct xlat_data mtd_type_options_xdata[] = {
 [0] = { (unsigned)(0), "MTD_ABSENT" },
 [1] = { (unsigned)(1), "MTD_RAM" },
 [2] = { (unsigned)(2), "MTD_ROM" },
 [3] = { (unsigned)(3), "MTD_NORFLASH" },
 [4] = { (unsigned)(4), "MTD_NANDFLASH" },
 [6] = { (unsigned)(6), "MTD_DATAFLASH" },
 [7] = { (unsigned)(7), "MTD_UBIVOLUME" },
 [8] = { (unsigned)(8), "MTD_MLCNANDFLASH" },
};
static
const struct xlat mtd_type_options[1] = { {
 .data = mtd_type_options_xdata,
 .size = (sizeof(mtd_type_options_xdata) / sizeof((mtd_type_options_xdata)[0]) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(typeof((mtd_type_options_xdata)), typeof(&(mtd_type_options_xdata)[0])))]) * 0)),
 .type = XT_INDEXED,
 .flags_mask = 0
  | ((unsigned) (0))
  | ((unsigned) (1))
 ...
 .flags_strsz = 0
  ...
  + sizeof("MTD_ROM")
  + sizeof("MTD_NORFLASH")
  + sizeof("MTD_NANDFLASH")
  + sizeof("MTD_DATAFLASH")
  + sizeof("MTD_UBIVOLUME")
  + sizeof("MTD_MLCNANDFLASH")
  ,
} };
static const struct xlat_data mtd_flags_options_xdata[] = {
 { (unsigned)(0x400), "MTD_WRITEABLE" },
 { (unsigned)(0x800), "MTD_BIT_WRITEABLE" },
 { (unsigned)(0x1000), "MTD_NO_ERASE" },
 { (unsigned)(0x2000), "MTD_POWERUP_LOCK" },
 { (unsigned)(0x4000), "MTD_SLC_ON_MLC_EMULATION" },
};
static
const struct xlat mtd_flags_options[1] = { {
 .data = mtd_flags_options_xdata,
 .size = (sizeof(mtd_flags_options_xdata) / sizeof((mtd_flags_options_xdata)[0]) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(typeof((mtd_flags_options_xdata)), typeof(&(mtd_flags_options_xdata)[0])))]) * 0)),
 .type = XT_NORMAL,
 .flags_mask = 0
  | ((unsigned) (0x400))
  | ((unsigned) (0x800))
  ...
  ,
 .flags_strsz = 0
  + sizeof("MTD_WRITEABLE")
  + sizeof("MTD_BIT_WRITEABLE")
  + sizeof("MTD_NO_ERASE")
  + sizeof("MTD_POWERUP_LOCK")
  + sizeof("MTD_SLC_ON_MLC_EMULATION")
  ,
} };
static const struct xlat_data mtd_otp_options_xdata[] = {
 [0] = { (unsigned)(0), "MTD_OTP_OFF" },
 [1] = { (unsigned)(1), "MTD_OTP_FACTORY" },
 [2] = { (unsigned)(2), "MTD_OTP_USER" },
};
static
const struct xlat mtd_otp_options[1] = { {
 .data = mtd_otp_options_xdata,
 .size = (sizeof(mtd_otp_options_xdata) / sizeof((mtd_otp_options_xdata)[0]) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(typeof((mtd_otp_options_xdata)), typeof(&(mtd_otp_options_xdata)[0])))]) * 0)),
 .type = XT_INDEXED,
 .flags_mask = 0
  | ((unsigned) (0))
  | ((unsigned) (1))
 ...
 .flags_strsz = 0
  + sizeof("MTD_OTP_OFF")
  + sizeof("MTD_OTP_FACTORY")
  + sizeof("MTD_OTP_USER")
  ,
} };
static const struct xlat_data mtd_nandecc_options_xdata[] = {
 [0] = { (unsigned)(0), "MTD_NANDECC_OFF" },
 [1] = { (unsigned)(1), "MTD_NANDECC_PLACE" },
 [2] = { (unsigned)(2), "MTD_NANDECC_AUTOPLACE" },
 [3] = { (unsigned)(3), "MTD_NANDECC_PLACEONLY" },
 [4] = { (unsigned)(4), "MTD_NANDECC_AUTOPL_USR" },
};
static
const struct xlat mtd_nandecc_options[1] = { {
 .data = mtd_nandecc_options_xdata,
 .size = (sizeof(mtd_nandecc_options_xdata) / sizeof((mtd_nandecc_options_xdata)[0]) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(typeof((mtd_nandecc_options_xdata)), typeof(&(mtd_nandecc_options_xdata)[0])))]) * 0)),
 .type = XT_INDEXED,
 .flags_mask = 0
  | ((unsigned) (0))
  | ((unsigned) (1))
  ...
  ,
 .flags_strsz = 0
  + sizeof("MTD_NANDECC_OFF")
  + sizeof("MTD_NANDECC_PLACE")
  + sizeof("MTD_NANDECC_AUTOPLACE")
  + sizeof("MTD_NANDECC_PLACEONLY")
  + sizeof("MTD_NANDECC_AUTOPL_USR")
  ,
} };
static void
decode_erase_info_user(struct tcb *const tcp, const kernel_ulong_t addr)
{
 ...
 if (umoven_or_printaddr((tcp), (addr), sizeof(*(&einfo)), (void *) (&einfo)))
  return;
 tprint_struct_begin();
 do { tprints_field_name("start"); tprintf("%#llx", (sizeof((einfo).start) == sizeof(char) ? (unsigned long long) (unsigned char) ((einfo).start) : sizeof((einfo).start) == sizeof(short) ? (unsigned long long) (unsigned short) ((einfo).start) : sizeof((einfo).start) == sizeof(int) ? (unsigned long long) (unsigned int) ((einfo).start) : sizeof((einfo).start) == sizeof(long) ? (unsigned long long) (unsigned long) ((einfo).start) : (unsigned long long) ((einfo).start))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("length"); tprintf("%#llx", (sizeof((einfo).length) == sizeof(char) ? (unsigned long long) (unsigned char) ((einfo).length) : sizeof((einfo).length) == sizeof(short) ? (unsigned long long) (unsigned short) ((einfo).length) : sizeof((einfo).length) == sizeof(int) ? (unsigned long long) (unsigned int) ((einfo).length) : sizeof((einfo).length) == sizeof(long) ? (unsigned long long) (unsigned long) ((einfo).length) : (unsigned long long) ((einfo).length))); } while (0);
 tprint_struct_end();
}
static void
decode_erase_info_user64(struct tcb *const tcp, const kernel_ulong_t addr)
{
 ...
 if (umoven_or_printaddr((tcp), (addr), sizeof(*(&einfo64)), (void *) (&einfo64)))
  return;
 tprint_struct_begin();
 do { tprints_field_name("start"); tprintf("%#llx", (sizeof((einfo64).start) == sizeof(char) ? (unsigned long long) (unsigned char) ((einfo64).start) : sizeof((einfo64).start) == sizeof(short) ? (unsigned long long) (unsigned short) ((einfo64).start) : sizeof((einfo64).start) == sizeof(int) ? (unsigned long long) (unsigned int) ((einfo64).start) : sizeof((einfo64).start) == sizeof(long) ? (unsigned long long) (unsigned long) ((einfo64).start) : (unsigned long long) ((einfo64).start))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("length"); tprintf("%#llx", (sizeof((einfo64).length) == sizeof(char) ? (unsigned long long) (unsigned char) ((einfo64).length) : sizeof((einfo64).length) == sizeof(short) ? (unsigned long long) (unsigned short) ((einfo64).length) : sizeof((einfo64).length) == sizeof(int) ? (unsigned long long) (unsigned int) ((einfo64).length) : sizeof((einfo64).length) == sizeof(long) ? (unsigned long long) (unsigned long) ((einfo64).length) : (unsigned long long) ((einfo64).length))); } while (0);
 tprint_struct_end();
}
static void
decode_mtd_oob_buf(struct tcb *const tcp, const kernel_ulong_t addr)
{
 ...
 if (umoven_or_printaddr((tcp), (addr), sizeof(*(&mbuf)), (void *) (&mbuf)))
  return;
 tprint_struct_begin();
 do { tprints_field_name("start"); tprintf("%#llx", (sizeof((mbuf).start) == sizeof(char) ? (unsigned long long) (unsigned char) ((mbuf).start) : sizeof((mbuf).start) == sizeof(short) ? (unsigned long long) (unsigned short) ((mbuf).start) : sizeof((mbuf).start) == sizeof(int) ? (unsigned long long) (unsigned int) ((mbuf).start) : sizeof((mbuf).start) == sizeof(long) ? (unsigned long long) (unsigned long) ((mbuf).start) : (unsigned long long) ((mbuf).start))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("length"); tprintf("%#llx", (sizeof((mbuf).length) == sizeof(char) ? (unsigned long long) (unsigned char) ((mbuf).length) : sizeof((mbuf).length) == sizeof(short) ? (unsigned long long) (unsigned short) ((mbuf).length) : sizeof((mbuf).length) == sizeof(int) ? (unsigned long long) (unsigned int) ((mbuf).length) : sizeof((mbuf).length) == sizeof(long) ? (unsigned long long) (unsigned long) ((mbuf).length) : (unsigned long long) ((mbuf).length))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("ptr"); printaddr((mpers_ptr_t) (mbuf).ptr); } while (0);
 tprint_struct_end();
}
static void
decode_mtd_oob_buf64(struct tcb *const tcp, const kernel_ulong_t addr)
{
 ...
 if (umoven_or_printaddr((tcp), (addr), sizeof(*(&mbuf64)), (void *) (&mbuf64)))
  return;
 tprint_struct_begin();
 do { tprints_field_name("start"); tprintf("%#llx", (sizeof((mbuf64).start) == sizeof(char) ? (unsigned long long) (unsigned char) ((mbuf64).start) : sizeof((mbuf64).start) == sizeof(short) ? (unsigned long long) (unsigned short) ((mbuf64).start) : sizeof((mbuf64).start) == sizeof(int) ? (unsigned long long) (unsigned int) ((mbuf64).start) : sizeof((mbuf64).start) == sizeof(long) ? (unsigned long long) (unsigned long) ((mbuf64).start) : (unsigned long long) ((mbuf64).start))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("length"); tprintf("%#llx", (sizeof((mbuf64).length) == sizeof(char) ? (unsigned long long) (unsigned char) ((mbuf64).length) : sizeof((mbuf64).length) == sizeof(short) ? (unsigned long long) (unsigned short) ((mbuf64).length) : sizeof((mbuf64).length) == sizeof(int) ? (unsigned long long) (unsigned int) ((mbuf64).length) : sizeof((mbuf64).length) == sizeof(long) ? (unsigned long long) (unsigned long) ((mbuf64).length) : (unsigned long long) ((mbuf64).length))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("usr_ptr"); printaddr64((mbuf64).usr_ptr); } while (0);
 tprint_struct_end();
}
static void
decode_otp_info(struct tcb *const tcp, const kernel_ulong_t addr)
{
 ...
 if (umoven_or_printaddr((tcp), (addr), sizeof(*(&oinfo)), (void *) (&oinfo)))
  return;
 tprint_struct_begin();
 do { tprints_field_name("start"); tprintf("%#llx", (sizeof((oinfo).start) == sizeof(char) ? (unsigned long long) (unsigned char) ((oinfo).start) : sizeof((oinfo).start) == sizeof(short) ? (unsigned long long) (unsigned short) ((oinfo).start) : sizeof((oinfo).start) == sizeof(int) ? (unsigned long long) (unsigned int) ((oinfo).start) : sizeof((oinfo).start) == sizeof(long) ? (unsigned long long) (unsigned long) ((oinfo).start) : (unsigned long long) ((oinfo).start))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("length"); tprintf("%#llx", (sizeof((oinfo).length) == sizeof(char) ? (unsigned long long) (unsigned char) ((oinfo).length) : sizeof((oinfo).length) == sizeof(short) ? (unsigned long long) (unsigned short) ((oinfo).length) : sizeof((oinfo).length) == sizeof(int) ? (unsigned long long) (unsigned int) ((oinfo).length) : sizeof((oinfo).length) == sizeof(long) ? (unsigned long long) (unsigned long) ((oinfo).length) : (unsigned long long) ((oinfo).length))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("locked"); tprintf("%llu", (sizeof((oinfo).locked) == sizeof(char) ? (unsigned long long) (unsigned char) ((oinfo).locked) : sizeof((oinfo).locked) == sizeof(short) ? (unsigned long long) (unsigned short) ((oinfo).locked) : sizeof((oinfo).locked) == sizeof(int) ? (unsigned long long) (unsigned int) ((oinfo).locked) : sizeof((oinfo).locked) == sizeof(long) ? (unsigned long long) (unsigned long) ((oinfo).locked) : (unsigned long long) ((oinfo).locked))); } while (0);
 tprint_struct_end();
}
static void
...
{
 unsigned int i;
 if (umoven_or_printaddr((tcp), (addr), sizeof(*(&i)), (void *) (&i)))
  return;
...
decode_mtd_write_req(struct tcb *const tcp, const kernel_ulong_t addr)
{
 ...
 if (umoven_or_printaddr((tcp), (addr), sizeof(*(&mreq)), (void *) (&mreq)))
  return;
 tprint_struct_begin();
 do { tprints_field_name("start"); tprintf("%#llx", (sizeof((mreq).start) == sizeof(char) ? (unsigned long long) (unsigned char) ((mreq).start) : sizeof((mreq).start) == sizeof(short) ? (unsigned long long) (unsigned short) ((mreq).start) : sizeof((mreq).start) == sizeof(int) ? (unsigned long long) (unsigned int) ((mreq).start) : sizeof((mreq).start) == sizeof(long) ? (unsigned long long) (unsigned long) ((mreq).start) : (unsigned long long) ((mreq).start))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("len"); tprintf("%#llx", (sizeof((mreq).len) == sizeof(char) ? (unsigned long long) (unsigned char) ((mreq).len) : sizeof((mreq).len) == sizeof(short) ? (unsigned long long) (unsigned short) ((mreq).len) : sizeof((mreq).len) == sizeof(int) ? (unsigned long long) (unsigned int) ((mreq).len) : sizeof((mreq).len) == sizeof(long) ? (unsigned long long) (unsigned long) ((mreq).len) : (unsigned long long) ((mreq).len))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("ooblen"); tprintf("%#llx", (sizeof((mreq).ooblen) == sizeof(char) ? (unsigned long long) (unsigned char) ((mreq).ooblen) : sizeof((mreq).ooblen) == sizeof(short) ? (unsigned long long) (unsigned short) ((mreq).ooblen) : sizeof((mreq).ooblen) == sizeof(int) ? (unsigned long long) (unsigned int) ((mreq).ooblen) : sizeof((mreq).ooblen) == sizeof(long) ? (unsigned long long) (unsigned long) ((mreq).ooblen) : (unsigned long long) ((mreq).ooblen))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("usr_data"); printaddr64((mreq).usr_data); } while (0);
 tprint_struct_next();
 do { tprints_field_name("usr_oob"); printaddr64((mreq).usr_oob); } while (0);
 tprint_struct_next();
 do { tprints_field_name("mode"); printxval64((mtd_mode_options), (sizeof((mreq).mode) == sizeof(char) ? (unsigned long long) (unsigned char) ((mreq).mode) : sizeof((mreq).mode) == sizeof(short) ? (unsigned long long) (unsigned short) ((mreq).mode) : sizeof((mreq).mode) == sizeof(int) ? (unsigned long long) (unsigned int) ((mreq).mode) : sizeof((mreq).mode) == sizeof(long) ? (unsigned long long) (unsigned long) ((mreq).mode) : (unsigned long long) ((mreq).mode)), ("MTD_OPS_???")); } while (0);
 tprint_struct_end();
}
static void
decode_mtd_info_user(struct tcb *const tcp, const kernel_ulong_t addr)
{
 ...
 if (umoven_or_printaddr((tcp), (addr), sizeof(*(&minfo)), (void *) (&minfo)))
  return;
 tprint_struct_begin();
 do { tprints_field_name("type"); printxval64((mtd_type_options), (sizeof((minfo).type) == sizeof(char) ? (unsigned long long) (unsigned char) ((minfo).type) : sizeof((minfo).type) == sizeof(short) ? (unsigned long long) (unsigned short) ((minfo).type) : sizeof((minfo).type) == sizeof(int) ? (unsigned long long) (unsigned int) ((minfo).type) : sizeof((minfo).type) == sizeof(long) ? (unsigned long long) (unsigned long) ((minfo).type) : (unsigned long long) ((minfo).type)), ("MTD_???")); } while (0);
 tprint_struct_next();
 do { tprints_field_name("flags"); printflags64((mtd_flags_options), (sizeof((minfo).flags) == sizeof(char) ? (unsigned long long) (unsigned char) ((minfo).flags) : sizeof((minfo).flags) == sizeof(short) ? (unsigned long long) (unsigned short) ((minfo).flags) : sizeof((minfo).flags) == sizeof(int) ? (unsigned long long) (unsigned int) ((minfo).flags) : sizeof((minfo).flags) == sizeof(long) ? (unsigned long long) (unsigned long) ((minfo).flags) : (unsigned long long) ((minfo).flags)), ("MTD_???")); } while (0);
 tprint_struct_next();
 do { tprints_field_name("size"); tprintf("%#llx", (sizeof((minfo).size) == sizeof(char) ? (unsigned long long) (unsigned char) ((minfo).size) : sizeof((minfo).size) == sizeof(short) ? (unsigned long long) (unsigned short) ((minfo).size) : sizeof((minfo).size) == sizeof(int) ? (unsigned long long) (unsigned int) ((minfo).size) : sizeof((minfo).size) == sizeof(long) ? (unsigned long long) (unsigned long) ((minfo).size) : (unsigned long long) ((minfo).size))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("erasesize"); tprintf("%#llx", (sizeof((minfo).erasesize) == sizeof(char) ? (unsigned long long) (unsigned char) ((minfo).erasesize) : sizeof((minfo).erasesize) == sizeof(short) ? (unsigned long long) (unsigned short) ((minfo).erasesize) : sizeof((minfo).erasesize) == sizeof(int) ? (unsigned long long) (unsigned int) ((minfo).erasesize) : sizeof((minfo).erasesize) == sizeof(long) ? (unsigned long long) (unsigned long) ((minfo).erasesize) : (unsigned long long) ((minfo).erasesize))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("writesize"); tprintf("%#llx", (sizeof((minfo).writesize) == sizeof(char) ? (unsigned long long) (unsigned char) ((minfo).writesize) : sizeof((minfo).writesize) == sizeof(short) ? (unsigned long long) (unsigned short) ((minfo).writesize) : sizeof((minfo).writesize) == sizeof(int) ? (unsigned long long) (unsigned int) ((minfo).writesize) : sizeof((minfo).writesize) == sizeof(long) ? (unsigned long long) (unsigned long) ((minfo).writesize) : (unsigned long long) ((minfo).writesize))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("oobsize"); tprintf("%#llx", (sizeof((minfo).oobsize) == sizeof(char) ? (unsigned long long) (unsigned char) ((minfo).oobsize) : sizeof((minfo).oobsize) == sizeof(short) ? (unsigned long long) (unsigned short) ((minfo).oobsize) : sizeof((minfo).oobsize) == sizeof(int) ? (unsigned long long) (unsigned int) ((minfo).oobsize) : sizeof((minfo).oobsize) == sizeof(long) ? (unsigned long long) (unsigned long) ((minfo).oobsize) : (unsigned long long) ((minfo).oobsize))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("padding"); tprintf("%#llx", (sizeof((minfo).padding) == sizeof(char) ? (unsigned long long) (unsigned char) ((minfo).padding) : sizeof((minfo).padding) == sizeof(short) ? (unsigned long long) (unsigned short) ((minfo).padding) : sizeof((minfo).padding) == sizeof(int) ? (unsigned long long) (unsigned int) ((minfo).padding) : sizeof((minfo).padding) == sizeof(long) ? (unsigned long long) (unsigned long) ((minfo).padding) : (unsigned long long) ((minfo).padding))); } while (0);
 tprint_struct_end();
}
static _Bool
       ...
       void *data)
{
 print_local_array_ex(tcp, elem_buf, 2, sizeof(int),
        print_xint32_array_member, ((void *)0), 0, ((void *)0), ((void *)0));
 return 1;
}
static void
decode_nand_oobinfo(struct tcb *const tcp, const kernel_ulong_t addr)
{
 ...
 if (umoven_or_printaddr((tcp), (addr), sizeof(*(&ninfo)), (void *) (&ninfo)))
  return;
 tprint_struct_begin();
 do { tprints_field_name("useecc"); printxval64((mtd_nandecc_options), (sizeof((ninfo).useecc) == sizeof(char) ? (unsigned long long) (unsigned char) ((ninfo).useecc) : sizeof((ninfo).useecc) == sizeof(short) ? (unsigned long long) (unsigned short) ((ninfo).useecc) : sizeof((ninfo).useecc) == sizeof(int) ? (unsigned long long) (unsigned int) ((ninfo).useecc) : sizeof((ninfo).useecc) == sizeof(long) ? (unsigned long long) (unsigned long) ((ninfo).useecc) : (unsigned long long) ((ninfo).useecc)), ("MTD_NANDECC_???")); } while (0);
 tprint_struct_next();
 do { tprints_field_name("eccbytes"); tprintf("%#llx", (sizeof((ninfo).eccbytes) == sizeof(char) ? (unsigned long long) (unsigned char) ((ninfo).eccbytes) : sizeof((ninfo).eccbytes) == sizeof(short) ? (unsigned long long) (unsigned short) ((ninfo).eccbytes) : sizeof((ninfo).eccbytes) == sizeof(int) ? (unsigned long long) (unsigned int) ((ninfo).eccbytes) : sizeof((ninfo).eccbytes) == sizeof(long) ? (unsigned long long) (unsigned long) ((ninfo).eccbytes) : (unsigned long long) ((ninfo).eccbytes))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("oobfree"); print_local_array_ex(((tcp)), ((ninfo).oobfree), (sizeof((ninfo).oobfree) / sizeof(((ninfo).oobfree)[0]) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(typeof(((ninfo).oobfree)), typeof(&((ninfo).oobfree)[0])))]) * 0)), sizeof(((ninfo).oobfree)[0]), ((print_xint32x2_array_member)), ((void *)0), 0, ((void *)0), ((void *)0)); } while (0);
 tprint_struct_next();
 do { tprints_field_name("eccpos"); print_local_array_ex(((tcp)), ((ninfo).eccpos), (sizeof((ninfo).eccpos) / sizeof(((ninfo).eccpos)[0]) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(typeof(((ninfo).eccpos)), typeof(&((ninfo).eccpos)[0])))]) * 0)), sizeof(((ninfo).eccpos)[0]), ((print_xint32_array_member)), ((void *)0), 0, ((void *)0), ((void *)0)); } while (0);
 tprint_struct_end();
}
static _Bool
    ...
    size_t elem_size, void *data)
{
 ...
 tprint_struct_begin();
 do { tprints_field_name("offset"); tprintf("%#llx", (sizeof((*p).offset) == sizeof(char) ? (unsigned long long) (unsigned char) ((*p).offset) : sizeof((*p).offset) == sizeof(short) ? (unsigned long long) (unsigned short) ((*p).offset) : sizeof((*p).offset) == sizeof(int) ? (unsigned long long) (unsigned int) ((*p).offset) : sizeof((*p).offset) == sizeof(long) ? (unsigned long long) (unsigned long) ((*p).offset) : (unsigned long long) ((*p).offset))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("length"); tprintf("%#llx", (sizeof((*p).length) == sizeof(char) ? (unsigned long long) (unsigned char) ((*p).length) : sizeof((*p).length) == sizeof(short) ? (unsigned long long) (unsigned short) ((*p).length) : sizeof((*p).length) == sizeof(int) ? (unsigned long long) (unsigned int) ((*p).length) : sizeof((*p).length) == sizeof(long) ? (unsigned long long) (unsigned long) ((*p).length) : (unsigned long long) ((*p).length))); } while (0);
 tprint_struct_end();
 return 1;
}
static void
decode_nand_ecclayout_user(struct tcb *const tcp, const kernel_ulong_t addr)
{
 ...
 if (umoven_or_printaddr((tcp), (addr), sizeof(*(&nlay)), (void *) (&nlay)))
  return;
 tprint_struct_begin();
 do { tprints_field_name("eccbytes"); tprintf("%#llx", (sizeof((nlay).eccbytes) == sizeof(char) ? (unsigned long long) (unsigned char) ((nlay).eccbytes) : sizeof((nlay).eccbytes) == sizeof(short) ? (unsigned long long) (unsigned short) ((nlay).eccbytes) : sizeof((nlay).eccbytes) == sizeof(int) ? (unsigned long long) (unsigned int) ((nlay).eccbytes) : sizeof((nlay).eccbytes) == sizeof(long) ? (unsigned long long) (unsigned long) ((nlay).eccbytes) : (unsigned long long) ((nlay).eccbytes))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("eccpos"); print_local_array_ex(((tcp)), ((nlay).eccpos), (sizeof((nlay).eccpos) / sizeof(((nlay).eccpos)[0]) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(typeof(((nlay).eccpos)), typeof(&((nlay).eccpos)[0])))]) * 0)), sizeof(((nlay).eccpos)[0]), ((print_xint32_array_member)), ((void *)0), 0, ((void *)0), ((void *)0)); } while (0);
 tprint_struct_next();
 do { tprints_field_name("oobavail"); tprintf("%#llx", (sizeof((nlay).oobavail) == sizeof(char) ? (unsigned long long) (unsigned char) ((nlay).oobavail) : sizeof((nlay).oobavail) == sizeof(short) ? (unsigned long long) (unsigned short) ((nlay).oobavail) : sizeof((nlay).oobavail) == sizeof(int) ? (unsigned long long) (unsigned int) ((nlay).oobavail) : sizeof((nlay).oobavail) == sizeof(long) ? (unsigned long long) (unsigned long) ((nlay).oobavail) : (unsigned long long) ((nlay).oobavail))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("oobfree"); print_local_array_ex(((tcp)), ((nlay).oobfree), (sizeof((nlay).oobfree) / sizeof(((nlay).oobfree)[0]) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(typeof(((nlay).oobfree)), typeof(&((nlay).oobfree)[0])))]) * 0)), sizeof(((nlay).oobfree)[0]), ((print_nand_oobfree_array_member)), ((void *)0), 0, ((void *)0), ((void *)0)); } while (0);
 tprint_struct_end();
}
static void
decode_mtd_ecc_stats(struct tcb *const tcp, const kernel_ulong_t addr)
{
 ...
 if (umoven_or_printaddr((tcp), (addr), sizeof(*(&es)), (void *) (&es)))
  return;
 tprint_struct_begin();
 do { tprints_field_name("corrected"); tprintf("%#llx", (sizeof((es).corrected) == sizeof(char) ? (unsigned long long) (unsigned char) ((es).corrected) : sizeof((es).corrected) == sizeof(short) ? (unsigned long long) (unsigned short) ((es).corrected) : sizeof((es).corrected) == sizeof(int) ? (unsigned long long) (unsigned int) ((es).corrected) : sizeof((es).corrected) == sizeof(long) ? (unsigned long long) (unsigned long) ((es).corrected) : (unsigned long long) ((es).corrected))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("failed"); tprintf("%#llx", (sizeof((es).failed) == sizeof(char) ? (unsigned long long) (unsigned char) ((es).failed) : sizeof((es).failed) == sizeof(short) ? (unsigned long long) (unsigned short) ((es).failed) : sizeof((es).failed) == sizeof(int) ? (unsigned long long) (unsigned int) ((es).failed) : sizeof((es).failed) == sizeof(long) ? (unsigned long long) (unsigned long) ((es).failed) : (unsigned long long) ((es).failed))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("badblocks"); tprintf("%#llx", (sizeof((es).badblocks) == sizeof(char) ? (unsigned long long) (unsigned char) ((es).badblocks) : sizeof((es).badblocks) == sizeof(short) ? (unsigned long long) (unsigned short) ((es).badblocks) : sizeof((es).badblocks) == sizeof(int) ? (unsigned long long) (unsigned int) ((es).badblocks) : sizeof((es).badblocks) == sizeof(long) ? (unsigned long long) (unsigned long) ((es).badblocks) : (unsigned long long) ((es).badblocks))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("bbtblocks"); tprintf("%#llx", (sizeof((es).bbtblocks) == sizeof(char) ? (unsigned long long) (unsigned char) ((es).bbtblocks) : sizeof((es).bbtblocks) == sizeof(short) ? (unsigned long long) (unsigned short) ((es).bbtblocks) : sizeof((es).bbtblocks) == sizeof(int) ? (unsigned long long) (unsigned int) ((es).bbtblocks) : sizeof((es).bbtblocks) == sizeof(long) ? (unsigned long long) (unsigned long) ((es).bbtblocks) : (unsigned long long) ((es).bbtblocks))); } while (0);
 tprint_struct_end();
}
MPERS_PRINTER_DECL(int, mtd_ioctl, struct tcb *const tcp, const unsigned int code, const kernel_ulong_t arg)
{
 switch (code) {
 case (((1U) << (((0 +8)+8)+14)) | ((('M')) << (0 +8)) | (((2)) << 0) | ((((sizeof(struct erase_info_user)))) << ((0 +8)+8))):
 case (((1U) << (((0 +8)+8)+14)) | ((('M')) << (0 +8)) | (((5)) << 0) | ((((sizeof(struct erase_info_user)))) << ((0 +8)+8))):
 case (((1U) << (((0 +8)+8)+14)) | ((('M')) << (0 +8)) | (((6)) << 0) | ((((sizeof(struct erase_info_user)))) << ((0 +8)+8))):
 case (((2U) << (((0 +8)+8)+14)) | ((('M')) << (0 +8)) | (((23)) << 0) | ((((sizeof(struct erase_info_user)))) << ((0 +8)+8))):
  tprint_arg_next();
  decode_erase_info_user(tcp, arg);
  break;
 case (((1U) << (((0 +8)+8)+14)) | ((('M')) << (0 +8)) | (((20)) << 0) | ((((sizeof(struct erase_info_user64)))) << ((0 +8)+8))):
  tprint_arg_next();
  decode_erase_info_user64(tcp, arg);
  break;
 case (((2U|1U) << (((0 +8)+8)+14)) | ((('M')) << (0 +8)) | (((3)) << 0) | ((((sizeof(struct mtd_oob_buf)))) << ((0 +8)+8))):
 case (((2U|1U) << (((0 +8)+8)+14)) | ((('M')) << (0 +8)) | (((4)) << 0) | ((((sizeof(struct mtd_oob_buf)))) << ((0 +8)+8))):
  tprint_arg_next();
  decode_mtd_oob_buf(tcp, arg);
  break;
 case (((2U|1U) << (((0 +8)+8)+14)) | ((('M')) << (0 +8)) | (((21)) << 0) | ((((sizeof(struct mtd_oob_buf64)))) << ((0 +8)+8))):
 case (((2U|1U) << (((0 +8)+8)+14)) | ((('M')) << (0 +8)) | (((22)) << 0) | ((((sizeof(struct mtd_oob_buf64)))) << ((0 +8)+8))):
  tprint_arg_next();
  decode_mtd_oob_buf64(tcp, arg);
  break;
 case (((2U|1U) << (((0 +8)+8)+14)) | ((('M')) << (0 +8)) | (((24)) << 0) | ((((sizeof(struct mtd_write_req)))) << ((0 +8)+8))):
  tprint_arg_next();
  decode_mtd_write_req(tcp, arg);
  break;
 case (((1U) << (((0 +8)+8)+14)) | ((('M')) << (0 +8)) | (((15)) << 0) | ((((sizeof(struct otp_info)))) << ((0 +8)+8))):
  if ((!((tcp)->flags & 0x04)))
   return 0;
  __attribute__((__fallthrough__));
 case (((2U) << (((0 +8)+8)+14)) | ((('M')) << (0 +8)) | (((16)) << 0) | ((((sizeof(struct otp_info)))) << ((0 +8)+8))):
  tprint_arg_next();
  decode_otp_info(tcp, arg);
  break;
 case (((2U) << (((0 +8)+8)+14)) | ((('M')) << (0 +8)) | (((13)) << 0) | ((((sizeof(int)))) << ((0 +8)+8))):
  tprint_arg_next();
  decode_otp_select(tcp, arg);
  break;
 case (((0U) << (((0 +8)+8)+14)) | ((('M')) << (0 +8)) | (((19)) << 0) | ((0) << ((0 +8)+8))):
  tprint_arg_next();
  printxval64(mtd_file_mode_options, arg, "MTD_FILE_MODE_???");
  break;
 case (((1U) << (((0 +8)+8)+14)) | ((('M')) << (0 +8)) | (((11)) << 0) | ((((sizeof(__kernel_loff_t)))) << ((0 +8)+8))):
 case (((1U) << (((0 +8)+8)+14)) | ((('M')) << (0 +8)) | (((12)) << 0) | ((((sizeof(__kernel_loff_t)))) << ((0 +8)+8))):
  tprint_arg_next();
  printnum_int64(tcp, arg, "%" "ll" "u");
  break;
 case (((2U) << (((0 +8)+8)+14)) | ((('M')) << (0 +8)) | (((1)) << 0) | ((((sizeof(struct mtd_info_user)))) << ((0 +8)+8))):
  if ((!((tcp)->flags & 0x04)))
   return 0;
  tprint_arg_next();
  decode_mtd_info_user(tcp, arg);
  break;
 case (((2U) << (((0 +8)+8)+14)) | ((('M')) << (0 +8)) | (((10)) << 0) | ((((sizeof(struct nand_oobinfo)))) << ((0 +8)+8))):
  if ((!((tcp)->flags & 0x04)))
   return 0;
  tprint_arg_next();
  decode_nand_oobinfo(tcp, arg);
  break;
 case (((2U) << (((0 +8)+8)+14)) | ((('M')) << (0 +8)) | (((17)) << 0) | ((((sizeof(struct nand_ecclayout_user)))) << ((0 +8)+8))):
  if ((!((tcp)->flags & 0x04)))
   return 0;
  tprint_arg_next();
  decode_nand_ecclayout_user(tcp, arg);
  break;
 case (((2U) << (((0 +8)+8)+14)) | ((('M')) << (0 +8)) | (((18)) << 0) | ((((sizeof(struct mtd_ecc_stats)))) << ((0 +8)+8))):
  if ((!((tcp)->flags & 0x04)))
   return 0;
  tprint_arg_next();
  decode_mtd_ecc_stats(tcp, arg);
  break;
 case (((1U) << (((0 +8)+8)+14)) | ((('M')) << (0 +8)) | (((14)) << 0) | ((((sizeof(int)))) << ((0 +8)+8))):
  if ((!((tcp)->flags & 0x04)))
   return 0;
  tprint_arg_next();
  printnum_int(tcp, arg, "%u");
  break;
 case (((2U) << (((0 +8)+8)+14)) | ((('M')) << (0 +8)) | (((7)) << 0) | ((((sizeof(int)))) << ((0 +8)+8))):
  if ((!((tcp)->flags & 0x04)))
   return 0;
  tprint_arg_next();
  printnum_int(tcp, arg, "%d");
  break;
 case (((2U|1U) << (((0 +8)+8)+14)) | ((('M')) << (0 +8)) | (((8)) << 0) | ((((sizeof(struct region_info_user)))) << ((0 +8)+8))):
  if ((!((tcp)->flags & 0x04))) {
   struct region_info_user rinfo;
   tprint_arg_next();
   if (umoven_or_printaddr((tcp), (arg), sizeof(*(&rinfo)), (void *) (&rinfo)))
    break;
   tprint_struct_begin();
   do { tprints_field_name("regionindex"); tprintf("%#llx", (sizeof((rinfo).regionindex) == sizeof(char) ? (unsigned long long) (unsigned char) ((rinfo).regionindex) : sizeof((rinfo).regionindex) == sizeof(short) ? (unsigned long long) (unsigned short) ((rinfo).regionindex) : sizeof((rinfo).regionindex) == sizeof(int) ? (unsigned long long) (unsigned int) ((rinfo).regionindex) : sizeof((rinfo).regionindex) == sizeof(long) ? (unsigned long long) (unsigned long) ((rinfo).regionindex) : (unsigned long long) ((rinfo).regionindex))); } while (0);
   return 0;
  } else {
   struct region_info_user rinfo;
   if (!((tcp)->u_error != 0) && !umoven((tcp), (arg), sizeof(*(&rinfo)), (void *) (&rinfo))) {
    tprint_struct_next();
    do { tprints_field_name("offset"); tprintf("%#llx", (sizeof((rinfo).offset) == sizeof(char) ? (unsigned long long) (unsigned char) ((rinfo).offset) : sizeof((rinfo).offset) == sizeof(short) ? (unsigned long long) (unsigned short) ((rinfo).offset) : sizeof((rinfo).offset) == sizeof(int) ? (unsigned long long) (unsigned int) ((rinfo).offset) : sizeof((rinfo).offset) == sizeof(long) ? (unsigned long long) (unsigned long) ((rinfo).offset) : (unsigned long long) ((rinfo).offset))); } while (0);
    tprint_struct_next();
    do { tprints_field_name("erasesize"); tprintf("%#llx", (sizeof((rinfo).erasesize) == sizeof(char) ? (unsigned long long) (unsigned char) ((rinfo).erasesize) : sizeof((rinfo).erasesize) == sizeof(short) ? (unsigned long long) (unsigned short) ((rinfo).erasesize) : sizeof((rinfo).erasesize) == sizeof(int) ? (unsigned long long) (unsigned int) ((rinfo).erasesize) : sizeof((rinfo).erasesize) == sizeof(long) ? (unsigned long long) (unsigned long) ((rinfo).erasesize) : (unsigned long long) ((rinfo).erasesize))); } while (0);
    tprint_struct_next();
    do { tprints_field_name("numblocks"); tprintf("%#llx", (sizeof((rinfo).numblocks) == sizeof(char) ? (unsigned long long) (unsigned char) ((rinfo).numblocks) : sizeof((rinfo).numblocks) == sizeof(short) ? (unsigned long long) (unsigned short) ((rinfo).numblocks) : sizeof((rinfo).numblocks) == sizeof(int) ? (unsigned long long) (unsigned int) ((rinfo).numblocks) : sizeof((rinfo).numblocks) == sizeof(long) ? (unsigned long long) (unsigned long) ((rinfo).numblocks) : (unsigned long long) ((rinfo).numblocks))); } while (0);
   }
   tprint_struct_end();
   break;
  }
