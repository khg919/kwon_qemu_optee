...
{
 tprint_struct_begin();
 do { tprints_field_name("tv_sec"); tprintf("%lld", (sizeof((*t).tv_sec) == sizeof(char) ? (long long) (char) ((*t).tv_sec) : sizeof((*t).tv_sec) == sizeof(short) ? (long long) (short) ((*t).tv_sec) : sizeof((*t).tv_sec) == sizeof(int) ? (long long) (int) ((*t).tv_sec) : sizeof((*t).tv_sec) == sizeof(long) ? (long long) (long) ((*t).tv_sec) : (long long) ((*t).tv_sec))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("tv_usec"); tprintf("%llu", (sizeof((*t).tv_usec) == sizeof(char) ? (unsigned long long) (unsigned char) ((*t).tv_usec) : sizeof((*t).tv_usec) == sizeof(short) ? (unsigned long long) (unsigned short) ((*t).tv_usec) : sizeof((*t).tv_usec) == sizeof(int) ? (unsigned long long) (unsigned int) ((*t).tv_usec) : sizeof((*t).tv_usec) == sizeof(long) ? (unsigned long long) (unsigned long) ((*t).tv_usec) : (unsigned long long) ((*t).tv_usec))); } while (0);
 tprint_struct_end();
}
static _Bool
        ...
        void *data)
{
 ...
 tprints_comment(sprinttime_usec(t->tv_sec,
  (sizeof(t->tv_usec) == sizeof(char) ? (unsigned long long) (unsigned char) (t->tv_usec) : sizeof(t->tv_usec) == sizeof(short) ? (unsigned long long) (unsigned short) (t->tv_usec) : sizeof(t->tv_usec) == sizeof(int) ? (unsigned long long) (unsigned int) (t->tv_usec) : sizeof(t->tv_usec) == sizeof(long) ? (unsigned long long) (unsigned long) (t->tv_usec) : (unsigned long long) (t->tv_usec))));
 return 1;
}
...
MPERS_PRINTER_DECL(_Bool, print_struct_timeval_data_size, const void *arg, const size_t size)
{
...
MPERS_PRINTER_DECL(int, print_timeval, struct tcb *const tcp, const kernel_ulong_t addr)
{
 timeval_t t;
 if (umoven_or_printaddr((tcp), (addr), sizeof(*(&t)), (void *) (&t)))
  return -1;
 print_timeval_t(&t);
 return 0;
}
MPERS_PRINTER_DECL(int, print_timeval_utimes, struct tcb *const tcp, const kernel_ulong_t addr)
{
 timeval_t t[2];
 if (umoven_or_printaddr((tcp), (addr), sizeof(*(&t)), (void *) (&t)))
  return -1;
 print_local_array_ex((tcp), (t), (sizeof(t) / sizeof((t)[0]) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(typeof((t)), typeof(&(t)[0])))]) * 0)), sizeof((t)[0]), (print_timeval_t_utime), ((void *)0), 0, ((void *)0), ((void *)0));
 return 0;
}
MPERS_PRINTER_DECL(const char *, sprint_timeval, struct tcb *const tcp, const kernel_ulong_t addr)
{
 timeval_t t;
 static char buf[sizeof(timeval_fmt) + 3 * sizeof(t)];
 if (!addr) {
  strcpy(buf, "NULL");
 } else if (!((tcp)->qual_flg & 0x004) || (((tcp)->flags & 0x04) && ((tcp)->u_error != 0)) ||
     umoven((tcp), (addr), sizeof(*(&t)), (void *) (&t))) {
  xsnprintf_(((buf)), (sizeof(buf) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(typeof((buf)), typeof(&(buf)[0])))]) * 0)), __func__, "(\"%#\" \"l\"\"x\")" ", " "addr", (("%#" "l""x")), addr);
 } else {
  xsnprintf_(((buf)), (sizeof(buf) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(typeof((buf)), typeof(&(buf)[0])))]) * 0)), __func__, "(timeval_fmt)" ", " "(long long) t.tv_sec, (sizeof(t.tv_usec) == sizeof(char) ? (unsigned long long) (unsigned char) (t.tv_usec) : sizeof(t.tv_usec) == sizeof(short) ? (unsigned long long) (unsigned short) (t.tv_usec) : sizeof(t.tv_usec) == sizeof(int) ? (unsigned long long) (unsigned int) (t.tv_usec) : sizeof(t.tv_usec) == sizeof(long) ? (unsigned long long) (unsigned long) (t.tv_usec) : (unsigned long long) (t.tv_usec))", ((timeval_fmt)), (long long) t.tv_sec, (sizeof(t.tv_usec) == sizeof(char) ? (unsigned long long) (unsigned char) (t.tv_usec) : sizeof(t.tv_usec) == sizeof(short) ? (unsigned long long) (unsigned short) (t.tv_usec) : sizeof(t.tv_usec) == sizeof(int) ? (unsigned long long) (unsigned int) (t.tv_usec) : sizeof(t.tv_usec) == sizeof(long) ? (unsigned long long) (unsigned long) (t.tv_usec) : (unsigned long long) (t.tv_usec)));
 }
 return buf;
}
MPERS_PRINTER_DECL(int, print_itimerval, struct tcb *const tcp, const kernel_ulong_t addr)
{
 struct { timeval_t it_interval, it_value; } t;
 if (umoven_or_printaddr((tcp), (addr), sizeof(*(&t)), (void *) (&t)))
  return -1;
 tprint_struct_begin();
 do { tprints_field_name("it_interval"); (print_timeval_t)(&((t).it_interval)); } while (0);
 tprint_struct_next();
 do { tprints_field_name("it_value"); (print_timeval_t)(&((t).it_value)); } while (0);
 tprint_struct_end();
 return 0;
}
