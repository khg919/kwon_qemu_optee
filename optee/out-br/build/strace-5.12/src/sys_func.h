...
extern SYS_FUNC(adjtimex32);
extern SYS_FUNC(adjtimex64);
...
extern SYS_FUNC(clock_adjtime32);
extern SYS_FUNC(clock_adjtime64);
extern SYS_FUNC(clock_gettime32);
extern SYS_FUNC(clock_gettime64);
extern SYS_FUNC(clock_nanosleep_time32);
extern SYS_FUNC(clock_nanosleep_time64);
extern SYS_FUNC(clock_settime32);
extern SYS_FUNC(clock_settime64);
extern SYS_FUNC(clock_sparc64_adjtime);
...
extern SYS_FUNC(futex_time32);
extern SYS_FUNC(futex_time64);
...
extern SYS_FUNC(io_getevents_time32);
extern SYS_FUNC(io_getevents_time64);
extern SYS_FUNC(ioperm);
extern SYS_FUNC(io_pgetevents_time32);
extern SYS_FUNC(io_pgetevents_time64);
...
extern SYS_FUNC(mq_timedreceive_time32);
extern SYS_FUNC(mq_timedreceive_time64);
extern SYS_FUNC(mq_timedsend_time32);
extern SYS_FUNC(mq_timedsend_time64);
...
extern SYS_FUNC(nanosleep_time32);
extern SYS_FUNC(nanosleep_time64);
...
extern SYS_FUNC(poll_time32);
extern SYS_FUNC(poll_time64);
extern SYS_FUNC(ppoll_time32);
extern SYS_FUNC(ppoll_time64);
...
extern SYS_FUNC(pselect6_time32);
extern SYS_FUNC(pselect6_time64);
...
extern SYS_FUNC(recvmmsg_time32);
extern SYS_FUNC(recvmmsg_time64);
...
extern SYS_FUNC(rt_sigtimedwait_time32);
extern SYS_FUNC(rt_sigtimedwait_time64);
...
extern SYS_FUNC(sched_rr_get_interval_time32);
extern SYS_FUNC(sched_rr_get_interval_time64);
...
extern SYS_FUNC(semtimedop_time32);
extern SYS_FUNC(semtimedop_time64);
...
extern SYS_FUNC(timerfd_gettime32);
extern SYS_FUNC(timerfd_gettime64);
extern SYS_FUNC(timerfd_settime32);
extern SYS_FUNC(timerfd_settime64);
extern SYS_FUNC(timer_gettime32);
extern SYS_FUNC(timer_gettime64);
extern SYS_FUNC(timer_settime32);
extern SYS_FUNC(timer_settime64);
...
extern SYS_FUNC(utimensat_time32);
extern SYS_FUNC(utimensat_time64);
