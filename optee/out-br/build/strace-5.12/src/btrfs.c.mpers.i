...
const struct xlat btrfs_balance_args[1] = { {
 ...
 .size = (sizeof(btrfs_balance_args_xdata) / sizeof((btrfs_balance_args_xdata)[0]) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(typeof((btrfs_balance_args_xdata)), typeof(&(btrfs_balance_args_xdata)[0])))]) * 0)),
 .type = XT_NORMAL,
 .flags_mask = 0
  | ((uint64_t) ((1ULL << 0)))
  | ((uint64_t) ((1ULL << 1)))
...
const struct xlat btrfs_balance_ctl_cmds[1] = { {
 ...
 .size = (sizeof(btrfs_balance_ctl_cmds_xdata) / sizeof((btrfs_balance_ctl_cmds_xdata)[0]) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(typeof((btrfs_balance_ctl_cmds_xdata)), typeof(&(btrfs_balance_ctl_cmds_xdata)[0])))]) * 0)),
 .type = XT_INDEXED,
 .flags_mask = 0
  | ((unsigned) (1))
  | ((unsigned) (2))
...
const struct xlat btrfs_balance_flags[1] = { {
 ...
 .size = (sizeof(btrfs_balance_flags_xdata) / sizeof((btrfs_balance_flags_xdata)[0]) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(typeof((btrfs_balance_flags_xdata)), typeof(&(btrfs_balance_flags_xdata)[0])))]) * 0)),
 .type = XT_NORMAL,
 .flags_mask = 0
  | ((uint64_t) ((1ULL << 0)))
  | ((uint64_t) ((1ULL << 1)))
...
const struct xlat btrfs_balance_state[1] = { {
 ...
 .size = (sizeof(btrfs_balance_state_xdata) / sizeof((btrfs_balance_state_xdata)[0]) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(typeof((btrfs_balance_state_xdata)), typeof(&(btrfs_balance_state_xdata)[0])))]) * 0)),
 .type = XT_NORMAL,
 .flags_mask = 0
  | ((unsigned) ((1ULL << 0)))
  | ((unsigned) ((1ULL << 1)))
...
const struct xlat btrfs_compress_types[1] = { {
 ...
 .size = (sizeof(btrfs_compress_types_xdata) / sizeof((btrfs_compress_types_xdata)[0]) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(typeof((btrfs_compress_types_xdata)), typeof(&(btrfs_compress_types_xdata)[0])))]) * 0)),
 .type = XT_INDEXED,
 .flags_mask = 0
  | ((unsigned) (0))
  | ((unsigned) (1))
...
const struct xlat btrfs_cont_reading_from_srcdev_mode[1] = { {
 ...
 .size = (sizeof(btrfs_cont_reading_from_srcdev_mode_xdata) / sizeof((btrfs_cont_reading_from_srcdev_mode_xdata)[0]) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(typeof((btrfs_cont_reading_from_srcdev_mode_xdata)), typeof(&(btrfs_cont_reading_from_srcdev_mode_xdata)[0])))]) * 0)),
 .type = XT_INDEXED,
 .flags_mask = 0
  | ((unsigned) (0))
  | ((unsigned) (1))
...
const struct xlat btrfs_defrag_flags[1] = { {
 ...
 .size = (sizeof(btrfs_defrag_flags_xdata) / sizeof((btrfs_defrag_flags_xdata)[0]) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(typeof((btrfs_defrag_flags_xdata)), typeof(&(btrfs_defrag_flags_xdata)[0])))]) * 0)),
 .type = XT_NORMAL,
 .flags_mask = 0
  | ((uint64_t) (1))
  | ((uint64_t) (2))
...
const struct xlat btrfs_dev_replace_cmds[1] = { {
 ...
 .size = (sizeof(btrfs_dev_replace_cmds_xdata) / sizeof((btrfs_dev_replace_cmds_xdata)[0]) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(typeof((btrfs_dev_replace_cmds_xdata)), typeof(&(btrfs_dev_replace_cmds_xdata)[0])))]) * 0)),
 .type = XT_NORMAL,
 .flags_mask = 0
  | ((uint64_t) (0))
  | ((uint64_t) (1))
...
const struct xlat btrfs_dev_replace_results[1] = { {
 ...
 .size = (sizeof(btrfs_dev_replace_results_xdata) / sizeof((btrfs_dev_replace_results_xdata)[0]) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(typeof((btrfs_dev_replace_results_xdata)), typeof(&(btrfs_dev_replace_results_xdata)[0])))]) * 0)),
 .type = XT_NORMAL,
 .flags_mask = 0
  | ((uint64_t) (0))
  | ((uint64_t) (1))
...
const struct xlat btrfs_dev_replace_state[1] = { {
 ...
 .size = (sizeof(btrfs_dev_replace_state_xdata) / sizeof((btrfs_dev_replace_state_xdata)[0]) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(typeof((btrfs_dev_replace_state_xdata)), typeof(&(btrfs_dev_replace_state_xdata)[0])))]) * 0)),
 .type = XT_NORMAL,
 .flags_mask = 0
  | ((uint64_t) (0))
  | ((uint64_t) (1))
...
const struct xlat btrfs_dev_stats_flags[1] = { {
 ...
 .size = (sizeof(btrfs_dev_stats_flags_xdata) / sizeof((btrfs_dev_stats_flags_xdata)[0]) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(typeof((btrfs_dev_stats_flags_xdata)), typeof(&(btrfs_dev_stats_flags_xdata)[0])))]) * 0)),
 .type = XT_NORMAL,
 .flags_mask = 0
  | ((uint64_t) ((1ULL << 0)))
  ,
...
const struct xlat btrfs_dev_stats_values[1] = { {
 ...
 .size = (sizeof(btrfs_dev_stats_values_xdata) / sizeof((btrfs_dev_stats_values_xdata)[0]) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(typeof((btrfs_dev_stats_values_xdata)), typeof(&(btrfs_dev_stats_values_xdata)[0])))]) * 0)),
 .type = XT_INDEXED,
 .flags_mask = 0
...
const struct xlat btrfs_features_compat[1] = { {
 ...
 .size = (sizeof(btrfs_features_compat_xdata) / sizeof((btrfs_features_compat_xdata)[0]) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(typeof((btrfs_features_compat_xdata)), typeof(&(btrfs_features_compat_xdata)[0])))]) * 0)),
 .type = XT_NORMAL,
 .flags_mask = 0
  ,
 .flags_strsz = 0
...
const struct xlat btrfs_features_compat_ro[1] = { {
 ...
 .size = (sizeof(btrfs_features_compat_ro_xdata) / sizeof((btrfs_features_compat_ro_xdata)[0]) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(typeof((btrfs_features_compat_ro_xdata)), typeof(&(btrfs_features_compat_ro_xdata)[0])))]) * 0)),
 .type = XT_NORMAL,
 .flags_mask = 0
  | ((uint64_t) ((1ULL << 0)))
  | ((uint64_t) ((1ULL << 1)))
...
const struct xlat btrfs_features_incompat[1] = { {
 ...
 .size = (sizeof(btrfs_features_incompat_xdata) / sizeof((btrfs_features_incompat_xdata)[0]) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(typeof((btrfs_features_incompat_xdata)), typeof(&(btrfs_features_incompat_xdata)[0])))]) * 0)),
 .type = XT_NORMAL,
 .flags_mask = 0
  | ((uint64_t) ((1ULL << 0)))
  | ((uint64_t) ((1ULL << 1)))
...
const struct xlat btrfs_key_types[1] = { {
 ...
 .size = (sizeof(btrfs_key_types_xdata) / sizeof((btrfs_key_types_xdata)[0]) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(typeof((btrfs_key_types_xdata)), typeof(&(btrfs_key_types_xdata)[0])))]) * 0)),
 .type = XT_NORMAL,
 .flags_mask = 0
  | ((uint64_t) (1))
  | ((uint64_t) (12))
 ...
 .flags_strsz = 0
  ...
  + sizeof("BTRFS_BALANCE_ITEM_KEY")
  + sizeof("BTRFS_TEMPORARY_ITEM_KEY")
  + sizeof("BTRFS_DEV_STATS_KEY")
...
const struct xlat btrfs_logical_ino_args_flags[1] = { {
 ...
 .size = (sizeof(btrfs_logical_ino_args_flags_xdata) / sizeof((btrfs_logical_ino_args_flags_xdata)[0]) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(typeof((btrfs_logical_ino_args_flags_xdata)), typeof(&(btrfs_logical_ino_args_flags_xdata)[0])))]) * 0)),
 .type = XT_NORMAL,
 .flags_mask = 0
  | ((unsigned) ((1ULL << 0)))
  ,
...
const struct xlat btrfs_qgroup_ctl_cmds[1] = { {
 ...
 .size = (sizeof(btrfs_qgroup_ctl_cmds_xdata) / sizeof((btrfs_qgroup_ctl_cmds_xdata)[0]) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(typeof((btrfs_qgroup_ctl_cmds_xdata)), typeof(&(btrfs_qgroup_ctl_cmds_xdata)[0])))]) * 0)),
 .type = XT_NORMAL,
 .flags_mask = 0
  | ((uint64_t) (1))
  | ((uint64_t) (2))
...
const struct xlat btrfs_qgroup_inherit_flags[1] = { {
 ...
 .size = (sizeof(btrfs_qgroup_inherit_flags_xdata) / sizeof((btrfs_qgroup_inherit_flags_xdata)[0]) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(typeof((btrfs_qgroup_inherit_flags_xdata)), typeof(&(btrfs_qgroup_inherit_flags_xdata)[0])))]) * 0)),
 .type = XT_NORMAL,
 .flags_mask = 0
  | ((uint64_t) ((1ULL << 0)))
  ,
...
const struct xlat btrfs_qgroup_limit_flags[1] = { {
 ...
 .size = (sizeof(btrfs_qgroup_limit_flags_xdata) / sizeof((btrfs_qgroup_limit_flags_xdata)[0]) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(typeof((btrfs_qgroup_limit_flags_xdata)), typeof(&(btrfs_qgroup_limit_flags_xdata)[0])))]) * 0)),
 .type = XT_NORMAL,
 .flags_mask = 0
  | ((uint64_t) ((1ULL << 0)))
  | ((uint64_t) ((1ULL << 1)))
...
const struct xlat btrfs_qgroup_status_flags[1] = { {
 ...
 .size = (sizeof(btrfs_qgroup_status_flags_xdata) / sizeof((btrfs_qgroup_status_flags_xdata)[0]) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(typeof((btrfs_qgroup_status_flags_xdata)), typeof(&(btrfs_qgroup_status_flags_xdata)[0])))]) * 0)),
 .type = XT_NORMAL,
 .flags_mask = 0
  | ((uint64_t) ((1ULL << 0)))
  | ((uint64_t) ((1ULL << 1)))
...
const struct xlat btrfs_scrub_flags[1] = { {
 ...
 .size = (sizeof(btrfs_scrub_flags_xdata) / sizeof((btrfs_scrub_flags_xdata)[0]) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(typeof((btrfs_scrub_flags_xdata)), typeof(&(btrfs_scrub_flags_xdata)[0])))]) * 0)),
 .type = XT_NORMAL,
 .flags_mask = 0
  | ((uint64_t) (1))
  ,
...
const struct xlat btrfs_send_flags[1] = { {
 ...
 .size = (sizeof(btrfs_send_flags_xdata) / sizeof((btrfs_send_flags_xdata)[0]) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(typeof((btrfs_send_flags_xdata)), typeof(&(btrfs_send_flags_xdata)[0])))]) * 0)),
 .type = XT_NORMAL,
 .flags_mask = 0
  | ((unsigned) (0x1))
  | ((unsigned) (0x2))
...
const struct xlat btrfs_snap_flags_v2[1] = { {
 ...
 .size = (sizeof(btrfs_snap_flags_v2_xdata) / sizeof((btrfs_snap_flags_v2_xdata)[0]) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(typeof((btrfs_snap_flags_v2_xdata)), typeof(&(btrfs_snap_flags_v2_xdata)[0])))]) * 0)),
 .type = XT_NORMAL,
 .flags_mask = 0
  | ((uint64_t) ((1ULL << 0)))
  | ((uint64_t) ((1ULL << 1)))
...
const struct xlat btrfs_space_info_flags[1] = { {
 ...
 .size = (sizeof(btrfs_space_info_flags_xdata) / sizeof((btrfs_space_info_flags_xdata)[0]) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(typeof((btrfs_space_info_flags_xdata)), typeof(&(btrfs_space_info_flags_xdata)[0])))]) * 0)),
 .type = XT_NORMAL,
 .flags_mask = 0
  | ((uint64_t) ((1ULL << 0)))
  | ((uint64_t) ((1ULL << 1)))
...
const struct xlat btrfs_tree_objectids[1] = { {
 ...
 .size = (sizeof(btrfs_tree_objectids_xdata) / sizeof((btrfs_tree_objectids_xdata)[0]) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(typeof((btrfs_tree_objectids_xdata)), typeof(&(btrfs_tree_objectids_xdata)[0])))]) * 0)),
 .type = XT_NORMAL,
 .flags_mask = 0
  | ((uint64_t) (1ULL))
  | ((uint64_t) (2ULL))
...
btrfs_print_balance_args(const struct btrfs_balance_args *const bba)
{
 ...
 tprint_struct_next();
 do { tprints_field_name("usage"); if ((sizeof((*bba).usage) == sizeof(char) ? (unsigned long long) (unsigned char) ((*bba).usage) : sizeof((*bba).usage) == sizeof(short) ? (unsigned long long) (unsigned short) ((*bba).usage) : sizeof((*bba).usage) == sizeof(int) ? (unsigned long long) (unsigned int) ((*bba).usage) : sizeof((*bba).usage) == sizeof(long) ? (unsigned long long) (unsigned long) ((*bba).usage) : (unsigned long long) ((*bba).usage)) == (18446744073709551615ULL)) print_xlat_ex(((18446744073709551615ULL)), "UINT64_MAX", XLAT_STYLE_FMT_U); else tprintf("%llu", (sizeof((*bba).usage) == sizeof(char) ? (unsigned long long) (unsigned char) ((*bba).usage) : sizeof((*bba).usage) == sizeof(short) ? (unsigned long long) (unsigned short) ((*bba).usage) : sizeof((*bba).usage) == sizeof(int) ? (unsigned long long) (unsigned int) ((*bba).usage) : sizeof((*bba).usage) == sizeof(long) ? (unsigned long long) (unsigned long) ((*bba).usage) : (unsigned long long) ((*bba).usage))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("devid"); print_dev_t((*bba).devid); } while (0);
 tprint_struct_next();
 do { tprints_field_name("pstart"); if ((sizeof((*bba).pstart) == sizeof(char) ? (unsigned long long) (unsigned char) ((*bba).pstart) : sizeof((*bba).pstart) == sizeof(short) ? (unsigned long long) (unsigned short) ((*bba).pstart) : sizeof((*bba).pstart) == sizeof(int) ? (unsigned long long) (unsigned int) ((*bba).pstart) : sizeof((*bba).pstart) == sizeof(long) ? (unsigned long long) (unsigned long) ((*bba).pstart) : (unsigned long long) ((*bba).pstart)) == (18446744073709551615ULL)) print_xlat_ex(((18446744073709551615ULL)), "UINT64_MAX", XLAT_STYLE_FMT_U); else tprintf("%llu", (sizeof((*bba).pstart) == sizeof(char) ? (unsigned long long) (unsigned char) ((*bba).pstart) : sizeof((*bba).pstart) == sizeof(short) ? (unsigned long long) (unsigned short) ((*bba).pstart) : sizeof((*bba).pstart) == sizeof(int) ? (unsigned long long) (unsigned int) ((*bba).pstart) : sizeof((*bba).pstart) == sizeof(long) ? (unsigned long long) (unsigned long) ((*bba).pstart) : (unsigned long long) ((*bba).pstart))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("pend"); if ((sizeof((*bba).pend) == sizeof(char) ? (unsigned long long) (unsigned char) ((*bba).pend) : sizeof((*bba).pend) == sizeof(short) ? (unsigned long long) (unsigned short) ((*bba).pend) : sizeof((*bba).pend) == sizeof(int) ? (unsigned long long) (unsigned int) ((*bba).pend) : sizeof((*bba).pend) == sizeof(long) ? (unsigned long long) (unsigned long) ((*bba).pend) : (unsigned long long) ((*bba).pend)) == (18446744073709551615ULL)) print_xlat_ex(((18446744073709551615ULL)), "UINT64_MAX", XLAT_STYLE_FMT_U); else tprintf("%llu", (sizeof((*bba).pend) == sizeof(char) ? (unsigned long long) (unsigned char) ((*bba).pend) : sizeof((*bba).pend) == sizeof(short) ? (unsigned long long) (unsigned short) ((*bba).pend) : sizeof((*bba).pend) == sizeof(int) ? (unsigned long long) (unsigned int) ((*bba).pend) : sizeof((*bba).pend) == sizeof(long) ? (unsigned long long) (unsigned long) ((*bba).pend) : (unsigned long long) ((*bba).pend))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("vstart"); if ((sizeof((*bba).vstart) == sizeof(char) ? (unsigned long long) (unsigned char) ((*bba).vstart) : sizeof((*bba).vstart) == sizeof(short) ? (unsigned long long) (unsigned short) ((*bba).vstart) : sizeof((*bba).vstart) == sizeof(int) ? (unsigned long long) (unsigned int) ((*bba).vstart) : sizeof((*bba).vstart) == sizeof(long) ? (unsigned long long) (unsigned long) ((*bba).vstart) : (unsigned long long) ((*bba).vstart)) == (18446744073709551615ULL)) print_xlat_ex(((18446744073709551615ULL)), "UINT64_MAX", XLAT_STYLE_FMT_U); else tprintf("%llu", (sizeof((*bba).vstart) == sizeof(char) ? (unsigned long long) (unsigned char) ((*bba).vstart) : sizeof((*bba).vstart) == sizeof(short) ? (unsigned long long) (unsigned short) ((*bba).vstart) : sizeof((*bba).vstart) == sizeof(int) ? (unsigned long long) (unsigned int) ((*bba).vstart) : sizeof((*bba).vstart) == sizeof(long) ? (unsigned long long) (unsigned long) ((*bba).vstart) : (unsigned long long) ((*bba).vstart))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("vend"); if ((sizeof((*bba).vend) == sizeof(char) ? (unsigned long long) (unsigned char) ((*bba).vend) : sizeof((*bba).vend) == sizeof(short) ? (unsigned long long) (unsigned short) ((*bba).vend) : sizeof((*bba).vend) == sizeof(int) ? (unsigned long long) (unsigned int) ((*bba).vend) : sizeof((*bba).vend) == sizeof(long) ? (unsigned long long) (unsigned long) ((*bba).vend) : (unsigned long long) ((*bba).vend)) == (18446744073709551615ULL)) print_xlat_ex(((18446744073709551615ULL)), "UINT64_MAX", XLAT_STYLE_FMT_U); else tprintf("%llu", (sizeof((*bba).vend) == sizeof(char) ? (unsigned long long) (unsigned char) ((*bba).vend) : sizeof((*bba).vend) == sizeof(short) ? (unsigned long long) (unsigned short) ((*bba).vend) : sizeof((*bba).vend) == sizeof(int) ? (unsigned long long) (unsigned int) ((*bba).vend) : sizeof((*bba).vend) == sizeof(long) ? (unsigned long long) (unsigned long) ((*bba).vend) : (unsigned long long) ((*bba).vend))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("target"); if ((sizeof((*bba).target) == sizeof(char) ? (unsigned long long) (unsigned char) ((*bba).target) : sizeof((*bba).target) == sizeof(short) ? (unsigned long long) (unsigned short) ((*bba).target) : sizeof((*bba).target) == sizeof(int) ? (unsigned long long) (unsigned int) ((*bba).target) : sizeof((*bba).target) == sizeof(long) ? (unsigned long long) (unsigned long) ((*bba).target) : (unsigned long long) ((*bba).target)) == (18446744073709551615ULL)) print_xlat_ex(((18446744073709551615ULL)), "UINT64_MAX", XLAT_STYLE_FMT_U); else tprintf("%llu", (sizeof((*bba).target) == sizeof(char) ? (unsigned long long) (unsigned char) ((*bba).target) : sizeof((*bba).target) == sizeof(short) ? (unsigned long long) (unsigned short) ((*bba).target) : sizeof((*bba).target) == sizeof(int) ? (unsigned long long) (unsigned int) ((*bba).target) : sizeof((*bba).target) == sizeof(long) ? (unsigned long long) (unsigned long) ((*bba).target) : (unsigned long long) ((*bba).target))); } while (0);
 tprint_struct_next();
        ...
        const _Bool is_entering, const _Bool is_not_abbrev)
{
 ...
 if (is_entering) {
  ...
  tprint_struct_next();
  do { tprints_field_name("min_offset"); if ((sizeof((*key).min_offset) == sizeof(char) ? (unsigned long long) (unsigned char) ((*key).min_offset) : sizeof((*key).min_offset) == sizeof(short) ? (unsigned long long) (unsigned short) ((*key).min_offset) : sizeof((*key).min_offset) == sizeof(int) ? (unsigned long long) (unsigned int) ((*key).min_offset) : sizeof((*key).min_offset) == sizeof(long) ? (unsigned long long) (unsigned long) ((*key).min_offset) : (unsigned long long) ((*key).min_offset)) == (18446744073709551615ULL)) print_xlat_ex(((18446744073709551615ULL)), "UINT64_MAX", XLAT_STYLE_FMT_U); else tprintf("%llu", (sizeof((*key).min_offset) == sizeof(char) ? (unsigned long long) (unsigned char) ((*key).min_offset) : sizeof((*key).min_offset) == sizeof(short) ? (unsigned long long) (unsigned short) ((*key).min_offset) : sizeof((*key).min_offset) == sizeof(int) ? (unsigned long long) (unsigned int) ((*key).min_offset) : sizeof((*key).min_offset) == sizeof(long) ? (unsigned long long) (unsigned long) ((*key).min_offset) : (unsigned long long) ((*key).min_offset))); } while (0);
  tprint_struct_next();
  do { tprints_field_name("max_offset"); if ((sizeof((*key).max_offset) == sizeof(char) ? (unsigned long long) (unsigned char) ((*key).max_offset) : sizeof((*key).max_offset) == sizeof(short) ? (unsigned long long) (unsigned short) ((*key).max_offset) : sizeof((*key).max_offset) == sizeof(int) ? (unsigned long long) (unsigned int) ((*key).max_offset) : sizeof((*key).max_offset) == sizeof(long) ? (unsigned long long) (unsigned long) ((*key).max_offset) : (unsigned long long) ((*key).max_offset)) == (18446744073709551615ULL)) print_xlat_ex(((18446744073709551615ULL)), "UINT64_MAX", XLAT_STYLE_FMT_U); else tprintf("%llu", (sizeof((*key).max_offset) == sizeof(char) ? (unsigned long long) (unsigned char) ((*key).max_offset) : sizeof((*key).max_offset) == sizeof(short) ? (unsigned long long) (unsigned short) ((*key).max_offset) : sizeof((*key).max_offset) == sizeof(int) ? (unsigned long long) (unsigned int) ((*key).max_offset) : sizeof((*key).max_offset) == sizeof(long) ? (unsigned long long) (unsigned long) ((*key).max_offset) : (unsigned long long) ((*key).max_offset))); } while (0);
  tprint_struct_next();
  do { tprints_field_name("min_transid"); if ((sizeof((*key).min_transid) == sizeof(char) ? (unsigned long long) (unsigned char) ((*key).min_transid) : sizeof((*key).min_transid) == sizeof(short) ? (unsigned long long) (unsigned short) ((*key).min_transid) : sizeof((*key).min_transid) == sizeof(int) ? (unsigned long long) (unsigned int) ((*key).min_transid) : sizeof((*key).min_transid) == sizeof(long) ? (unsigned long long) (unsigned long) ((*key).min_transid) : (unsigned long long) ((*key).min_transid)) == (18446744073709551615ULL)) print_xlat_ex(((18446744073709551615ULL)), "UINT64_MAX", XLAT_STYLE_FMT_U); else tprintf("%llu", (sizeof((*key).min_transid) == sizeof(char) ? (unsigned long long) (unsigned char) ((*key).min_transid) : sizeof((*key).min_transid) == sizeof(short) ? (unsigned long long) (unsigned short) ((*key).min_transid) : sizeof((*key).min_transid) == sizeof(int) ? (unsigned long long) (unsigned int) ((*key).min_transid) : sizeof((*key).min_transid) == sizeof(long) ? (unsigned long long) (unsigned long) ((*key).min_transid) : (unsigned long long) ((*key).min_transid))); } while (0);
  tprint_struct_next();
  do { tprints_field_name("max_transid"); if ((sizeof((*key).max_transid) == sizeof(char) ? (unsigned long long) (unsigned char) ((*key).max_transid) : sizeof((*key).max_transid) == sizeof(short) ? (unsigned long long) (unsigned short) ((*key).max_transid) : sizeof((*key).max_transid) == sizeof(int) ? (unsigned long long) (unsigned int) ((*key).max_transid) : sizeof((*key).max_transid) == sizeof(long) ? (unsigned long long) (unsigned long) ((*key).max_transid) : (unsigned long long) ((*key).max_transid)) == (18446744073709551615ULL)) print_xlat_ex(((18446744073709551615ULL)), "UINT64_MAX", XLAT_STYLE_FMT_U); else tprintf("%llu", (sizeof((*key).max_transid) == sizeof(char) ? (unsigned long long) (unsigned char) ((*key).max_transid) : sizeof((*key).max_transid) == sizeof(short) ? (unsigned long long) (unsigned short) ((*key).max_transid) : sizeof((*key).max_transid) == sizeof(int) ? (unsigned long long) (unsigned int) ((*key).max_transid) : sizeof((*key).max_transid) == sizeof(long) ? (unsigned long long) (unsigned long) ((*key).max_transid) : (unsigned long long) ((*key).max_transid))); } while (0);
  tprint_struct_next();
...
print_btrfs_replace_start_params(const typeof(((struct_btrfs_ioctl_dev_replace_args *)0)->start) *const p)
{
 ...
 tprint_struct_next();
 do { tprints_field_name("srcdev_name"); print_quoted_cstring((const char *) (*p).srcdev_name, sizeof((*p).srcdev_name) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(typeof(((*p).srcdev_name)), typeof(&((*p).srcdev_name)[0])))]) * 0)); } while (0);
 tprint_struct_next();
 do { tprints_field_name("tgtdev_name"); print_quoted_cstring((const char *) (*p).tgtdev_name, sizeof((*p).tgtdev_name) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(typeof(((*p).tgtdev_name)), typeof(&((*p).tgtdev_name)[0])))]) * 0)); } while (0);
 tprint_struct_end();
}
static void
...
MPERS_PRINTER_DECL(int, btrfs_ioctl, struct tcb *const tcp, const unsigned int code, const kernel_ulong_t arg)
{
 ...
 case (((1U) << (((0 +8)+8)+14)) | (((0x94)) << (0 +8)) | (((16)) << 0) | ((((sizeof(struct btrfs_ioctl_defrag_range_args)))) << ((0 +8)+8))): {
  ...
  tprint_struct_next();
  do { tprints_field_name("len"); if ((sizeof((args).len) == sizeof(char) ? (unsigned long long) (unsigned char) ((args).len) : sizeof((args).len) == sizeof(short) ? (unsigned long long) (unsigned short) ((args).len) : sizeof((args).len) == sizeof(int) ? (unsigned long long) (unsigned int) ((args).len) : sizeof((args).len) == sizeof(long) ? (unsigned long long) (unsigned long) ((args).len) : (unsigned long long) ((args).len)) == (18446744073709551615ULL)) print_xlat_ex(((18446744073709551615ULL)), "UINT64_MAX", XLAT_STYLE_FMT_U); else tprintf("%llu", (sizeof((args).len) == sizeof(char) ? (unsigned long long) (unsigned char) ((args).len) : sizeof((args).len) == sizeof(short) ? (unsigned long long) (unsigned short) ((args).len) : sizeof((args).len) == sizeof(int) ? (unsigned long long) (unsigned int) ((args).len) : sizeof((args).len) == sizeof(long) ? (unsigned long long) (unsigned long) ((args).len) : (unsigned long long) ((args).len))); } while (0);
  tprint_struct_next();
 ...
 case (((2U|1U) << (((0 +8)+8)+14)) | (((0x94)) << (0 +8)) | (((30)) << 0) | ((((sizeof(struct btrfs_ioctl_dev_info_args)))) << ((0 +8)+8))): {
  ...
  if ((!((tcp)->flags & 0x04))) {
   ...
   if (!is_filled((const char *) (args.uuid), 0, sizeof(args.uuid) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(typeof((args.uuid)), typeof(&(args.uuid)[0])))]) * 0))) {
    tprint_struct_next();
  ...
  tprint_struct_next();
  do { tprints_field_name("path"); print_quoted_cstring((const char *) (args).path, sizeof((args).path) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(typeof(((args).path)), typeof(&((args).path)[0])))]) * 0)); } while (0);
  tprint_struct_end();
  break;
 }
 ...
 case (((2U|1U) << (((0 +8)+8)+14)) | (((0x94)) << (0 +8)) | (((52)) << 0) | ((((sizeof(struct btrfs_ioctl_get_dev_stats)))) << ((0 +8)+8))): {
  ...
  for (uint64_t i = 0; i < args.nr_items; ++i) {
   if (i)
    tprint_array_next();
   if (i >= (sizeof(args.values) / sizeof((args.values)[0]) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(typeof((args.values)), typeof(&(args.values)[0])))]) * 0))) {
    tprint_more_data_follows();
    break;
   }
 ...
 case (((2U|1U) << (((0 +8)+8)+14)) | (((0x94)) << (0 +8)) | (((18)) << 0) | ((((sizeof(struct btrfs_ioctl_ino_lookup_args)))) << ((0 +8)+8))): {
  ...
  do { tprints_field_name("name"); print_quoted_cstring((const char *) (args).name, sizeof((args).name) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(typeof(((args).name)), typeof(&((args).name)[0])))]) * 0)); } while (0);
  tprint_struct_end();
  break;
 }
 ...
 case (((2U|1U) << (((0 +8)+8)+14)) | (((0x94)) << (0 +8)) | (((36)) << 0) | ((((sizeof(struct btrfs_ioctl_logical_ino_args)))) << ((0 +8)+8))): {
  ...
  if ((!((tcp)->flags & 0x04))) {
   ...
   tprint_struct_next();
   do { tprints_field_name("size"); tprintf("%llu", (sizeof((args).size) == sizeof(char) ? (unsigned long long) (unsigned char) ((args).size) : sizeof((args).size) == sizeof(short) ? (unsigned long long) (unsigned short) ((args).size) : sizeof((args).size) == sizeof(int) ? (unsigned long long) (unsigned int) ((args).size) : sizeof((args).size) == sizeof(long) ? (unsigned long long) (unsigned long) ((args).size) : (unsigned long long) ((args).size))); } while (0);
   if (!is_filled((const char *) (args.reserved), 0, sizeof(args.reserved) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(typeof((args.reserved)), typeof(&(args.reserved)[0])))]) * 0))) {
    tprint_struct_next();
    do { tprints_field_name("reserved"); for (size_t i_ = 0; i_ < (sizeof(((args)).reserved) / sizeof((((args)).reserved)[0]) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(typeof((((args)).reserved)), typeof(&(((args)).reserved)[0])))]) * 0)); ++i_) { if (i_) tprint_array_next(); else tprint_array_begin(); tprintf("%#llx", (sizeof(((args)).reserved[i_]) == sizeof(char) ? (unsigned long long) (unsigned char) (((args)).reserved[i_]) : sizeof(((args)).reserved[i_]) == sizeof(short) ? (unsigned long long) (unsigned short) (((args)).reserved[i_]) : sizeof(((args)).reserved[i_]) == sizeof(int) ? (unsigned long long) (unsigned int) (((args)).reserved[i_]) : sizeof(((args)).reserved[i_]) == sizeof(long) ? (unsigned long long) (unsigned long) (((args)).reserved[i_]) : (unsigned long long) (((args)).reserved[i_]))); } tprint_array_end(); } while (0);
   }
   tprint_struct_next();
 ...
 case (((2U|1U) << (((0 +8)+8)+14)) | (((0x94)) << (0 +8)) | (((29)) << 0) | ((((sizeof(struct btrfs_ioctl_scrub_args)))) << ((0 +8)+8))): {
  ...
  if ((!((tcp)->flags & 0x04))) {
   ...
   if (code == (((2U|1U) << (((0 +8)+8)+14)) | (((0x94)) << (0 +8)) | (((27)) << 0) | ((((sizeof(struct btrfs_ioctl_scrub_args)))) << ((0 +8)+8)))) {
    ...
    do { tprints_field_name("start"); tprintf("%llu", (sizeof((args).start) == sizeof(char) ? (unsigned long long) (unsigned char) ((args).start) : sizeof((args).start) == sizeof(short) ? (unsigned long long) (unsigned short) ((args).start) : sizeof((args).start) == sizeof(int) ? (unsigned long long) (unsigned int) ((args).start) : sizeof((args).start) == sizeof(long) ? (unsigned long long) (unsigned long) ((args).start) : (unsigned long long) ((args).start))); } while (0);
    tprint_struct_next();
    do { tprints_field_name("end"); if ((sizeof((args).end) == sizeof(char) ? (unsigned long long) (unsigned char) ((args).end) : sizeof((args).end) == sizeof(short) ? (unsigned long long) (unsigned short) ((args).end) : sizeof((args).end) == sizeof(int) ? (unsigned long long) (unsigned int) ((args).end) : sizeof((args).end) == sizeof(long) ? (unsigned long long) (unsigned long) ((args).end) : (unsigned long long) ((args).end)) == (18446744073709551615ULL)) print_xlat_ex(((18446744073709551615ULL)), "UINT64_MAX", XLAT_STYLE_FMT_U); else tprintf("%llu", (sizeof((args).end) == sizeof(char) ? (unsigned long long) (unsigned char) ((args).end) : sizeof((args).end) == sizeof(short) ? (unsigned long long) (unsigned short) ((args).end) : sizeof((args).end) == sizeof(int) ? (unsigned long long) (unsigned int) ((args).end) : sizeof((args).end) == sizeof(long) ? (unsigned long long) (unsigned long) ((args).end) : (unsigned long long) ((args).end))); } while (0);
    tprint_struct_next();
