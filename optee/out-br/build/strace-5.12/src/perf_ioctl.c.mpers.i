...
static const struct xlat_data perf_ioctl_flags_xdata[] = {
 { (unsigned)((1U << 0)), "PERF_IOC_FLAG_GROUP" },
};
static
const struct xlat perf_ioctl_flags[1] = { {
 .data = perf_ioctl_flags_xdata,
 .size = (sizeof(perf_ioctl_flags_xdata) / sizeof((perf_ioctl_flags_xdata)[0]) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(typeof((perf_ioctl_flags_xdata)), typeof(&(perf_ioctl_flags_xdata)[0])))]) * 0)),
 .type = XT_NORMAL,
 .flags_mask = 0
  | ((unsigned) ((1U << 0)))
  ,
 .flags_strsz = 0
  + sizeof("PERF_IOC_FLAG_GROUP")
  ,
} };
static int
perf_ioctl_query_bpf(struct tcb *const tcp, const kernel_ulong_t arg)
{
 ...
 if ((!((tcp)->flags & 0x04))) {
  ...
  tprintf("%llu", (sizeof(info) == sizeof(char) ? (unsigned long long) (unsigned char) (info) : sizeof(info) == sizeof(short) ? (unsigned long long) (unsigned short) (info) : sizeof(info) == sizeof(int) ? (unsigned long long) (unsigned int) (info) : sizeof(info) == sizeof(long) ? (unsigned long long) (unsigned long) (info) : (unsigned long long) (info)));
  tprint_struct_next();
  return 0;
 }
 if (((tcp)->u_error != 0) ||
     umoven((tcp), (arg + __builtin_offsetof (struct perf_event_query_bpf, prog_cnt)), sizeof(*(&info)), (void *) (&info))) {
 ...
 print_array(tcp, arg + __builtin_offsetof (struct perf_event_query_bpf, ids), info,
      &info, sizeof(info),
      tfetch_mem, print_uint32_array_member, ((void *)0));
 tprint_struct_end();
 return 0200;
}
static int
...
MPERS_PRINTER_DECL(int, perf_ioctl, struct tcb *const tcp, const unsigned int code, const kernel_ulong_t arg)
{
 switch (code) {
 case (((0U) << (((0 +8)+8)+14)) | ((('$')) << (0 +8)) | (((0)) << 0) | ((0) << ((0 +8)+8))):
 case (((0U) << (((0 +8)+8)+14)) | ((('$')) << (0 +8)) | (((1)) << 0) | ((0) << ((0 +8)+8))):
 case (((0U) << (((0 +8)+8)+14)) | ((('$')) << (0 +8)) | (((3)) << 0) | ((0) << ((0 +8)+8))):
  tprint_arg_next();
  printflags(perf_ioctl_flags, arg, "PERF_IOC_FLAG_???");
  return 0200;
 case (((0U) << (((0 +8)+8)+14)) | ((('$')) << (0 +8)) | (((2)) << 0) | ((0) << ((0 +8)+8))):
  tprint_arg_next();
  ...
  return 0200;
 case (((1U) << (((0 +8)+8)+14)) | ((('$')) << (0 +8)) | (((4)) << 0) | ((((sizeof(uint64_t)))) << ((0 +8)+8))):
  tprint_arg_next();
  printnum_int64(tcp, arg, "%" "ll" "u");
  return 0200;
 case (((0U) << (((0 +8)+8)+14)) | ((('$')) << (0 +8)) | (((5)) << 0) | ((0) << ((0 +8)+8))):
 case (((1U) << (((0 +8)+8)+14)) | ((('$')) << (0 +8)) | (((8)) << 0) | ((((sizeof(uint32_t)))) << ((0 +8)+8))):
  tprint_arg_next();
  printfd(tcp, (int) arg);
  return 0200;
 case (((1U) << (((0 +8)+8)+14)) | ((('$')) << (0 +8)) | (((9)) << 0) | ((((sizeof(uint32_t)))) << ((0 +8)+8))):
  tprint_arg_next();
  ...
  return 0200;
 case (((1U) << (((0 +8)+8)+14)) | ((('$')) << (0 +8)) | (((6)) << 0) | ((((sizeof(char *)))) << ((0 +8)+8))):
  tprint_arg_next();
  printstr_ex(tcp, arg, get_pagesize(), 0x01);
  return 0200;
 case (((2U) << (((0 +8)+8)+14)) | ((('$')) << (0 +8)) | (((7)) << 0) | ((((sizeof(uint64_t *)))) << ((0 +8)+8))):
  if ((!((tcp)->flags & 0x04)))
   return 0;
  tprint_arg_next();
  printnum_int64(tcp, arg, "%" "ll" "u");
  return 0200;
 case (((2U|1U) << (((0 +8)+8)+14)) | ((('$')) << (0 +8)) | (((10)) << 0) | ((((sizeof(struct perf_event_query_bpf *)))) << ((0 +8)+8))):
  return perf_ioctl_query_bpf(tcp, arg);
 case (((1U) << (((0 +8)+8)+14)) | ((('$')) << (0 +8)) | (((11)) << 0) | ((((sizeof(struct perf_event_attr *)))) << ((0 +8)+8))):
