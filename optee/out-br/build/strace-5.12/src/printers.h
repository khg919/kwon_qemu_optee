...
#define print_group_req MPERS_PRINTER_NAME(print_group_req)
 ...
 void (*print_kernel_sigset)(struct tcb *tcp, const kernel_ulong_t addr);
#define print_kernel_sigset MPERS_PRINTER_NAME(print_kernel_sigset)
...
#define print_struct_timeval_data_size MPERS_PRINTER_NAME(print_struct_timeval_data_size)
 ...
 int (*print_timeval)(struct tcb *const tcp, const kernel_ulong_t addr);
#define print_timeval MPERS_PRINTER_NAME(print_timeval)

 int (*print_timeval_utimes)(struct tcb *const tcp, const kernel_ulong_t addr);
...
#define sprint_timeval MPERS_PRINTER_NAME(sprint_timeval)
 ...
 int (*print_itimerval)(struct tcb *const tcp, const kernel_ulong_t addr);
