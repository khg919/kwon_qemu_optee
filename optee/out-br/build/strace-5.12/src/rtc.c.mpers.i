...
const struct xlat rtc_vl_flags[1] = { {
 ...
 .size = (sizeof(rtc_vl_flags_xdata) / sizeof((rtc_vl_flags_xdata)[0]) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(typeof((rtc_vl_flags_xdata)), typeof(&(rtc_vl_flags_xdata)[0])))]) * 0)),
 .type = XT_NORMAL,
 .flags_mask = 0
  | ((unsigned) ((1 << 0)))
  | ((unsigned) ((1 << 1)))
...
{
 tprint_struct_begin();
 do { tprints_field_name("tm_sec"); tprintf("%lld", (sizeof((*rt).tm_sec) == sizeof(char) ? (long long) (char) ((*rt).tm_sec) : sizeof((*rt).tm_sec) == sizeof(short) ? (long long) (short) ((*rt).tm_sec) : sizeof((*rt).tm_sec) == sizeof(int) ? (long long) (int) ((*rt).tm_sec) : sizeof((*rt).tm_sec) == sizeof(long) ? (long long) (long) ((*rt).tm_sec) : (long long) ((*rt).tm_sec))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("tm_min"); tprintf("%lld", (sizeof((*rt).tm_min) == sizeof(char) ? (long long) (char) ((*rt).tm_min) : sizeof((*rt).tm_min) == sizeof(short) ? (long long) (short) ((*rt).tm_min) : sizeof((*rt).tm_min) == sizeof(int) ? (long long) (int) ((*rt).tm_min) : sizeof((*rt).tm_min) == sizeof(long) ? (long long) (long) ((*rt).tm_min) : (long long) ((*rt).tm_min))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("tm_hour"); tprintf("%lld", (sizeof((*rt).tm_hour) == sizeof(char) ? (long long) (char) ((*rt).tm_hour) : sizeof((*rt).tm_hour) == sizeof(short) ? (long long) (short) ((*rt).tm_hour) : sizeof((*rt).tm_hour) == sizeof(int) ? (long long) (int) ((*rt).tm_hour) : sizeof((*rt).tm_hour) == sizeof(long) ? (long long) (long) ((*rt).tm_hour) : (long long) ((*rt).tm_hour))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("tm_mday"); tprintf("%lld", (sizeof((*rt).tm_mday) == sizeof(char) ? (long long) (char) ((*rt).tm_mday) : sizeof((*rt).tm_mday) == sizeof(short) ? (long long) (short) ((*rt).tm_mday) : sizeof((*rt).tm_mday) == sizeof(int) ? (long long) (int) ((*rt).tm_mday) : sizeof((*rt).tm_mday) == sizeof(long) ? (long long) (long) ((*rt).tm_mday) : (long long) ((*rt).tm_mday))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("tm_mon"); tprintf("%lld", (sizeof((*rt).tm_mon) == sizeof(char) ? (long long) (char) ((*rt).tm_mon) : sizeof((*rt).tm_mon) == sizeof(short) ? (long long) (short) ((*rt).tm_mon) : sizeof((*rt).tm_mon) == sizeof(int) ? (long long) (int) ((*rt).tm_mon) : sizeof((*rt).tm_mon) == sizeof(long) ? (long long) (long) ((*rt).tm_mon) : (long long) ((*rt).tm_mon))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("tm_year"); tprintf("%lld", (sizeof((*rt).tm_year) == sizeof(char) ? (long long) (char) ((*rt).tm_year) : sizeof((*rt).tm_year) == sizeof(short) ? (long long) (short) ((*rt).tm_year) : sizeof((*rt).tm_year) == sizeof(int) ? (long long) (int) ((*rt).tm_year) : sizeof((*rt).tm_year) == sizeof(long) ? (long long) (long) ((*rt).tm_year) : (long long) ((*rt).tm_year))); } while (0);
 if (((tcp)->qual_flg & 0x002)) {
  tprint_struct_next();
  tprint_more_data_follows();
 } else {
  tprint_struct_next();
  do { tprints_field_name("tm_wday"); tprintf("%lld", (sizeof((*rt).tm_wday) == sizeof(char) ? (long long) (char) ((*rt).tm_wday) : sizeof((*rt).tm_wday) == sizeof(short) ? (long long) (short) ((*rt).tm_wday) : sizeof((*rt).tm_wday) == sizeof(int) ? (long long) (int) ((*rt).tm_wday) : sizeof((*rt).tm_wday) == sizeof(long) ? (long long) (long) ((*rt).tm_wday) : (long long) ((*rt).tm_wday))); } while (0);
  tprint_struct_next();
  do { tprints_field_name("tm_yday"); tprintf("%lld", (sizeof((*rt).tm_yday) == sizeof(char) ? (long long) (char) ((*rt).tm_yday) : sizeof((*rt).tm_yday) == sizeof(short) ? (long long) (short) ((*rt).tm_yday) : sizeof((*rt).tm_yday) == sizeof(int) ? (long long) (int) ((*rt).tm_yday) : sizeof((*rt).tm_yday) == sizeof(long) ? (long long) (long) ((*rt).tm_yday) : (long long) ((*rt).tm_yday))); } while (0);
  tprint_struct_next();
  do { tprints_field_name("tm_isdst"); tprintf("%lld", (sizeof((*rt).tm_isdst) == sizeof(char) ? (long long) (char) ((*rt).tm_isdst) : sizeof((*rt).tm_isdst) == sizeof(short) ? (long long) (short) ((*rt).tm_isdst) : sizeof((*rt).tm_isdst) == sizeof(int) ? (long long) (int) ((*rt).tm_isdst) : sizeof((*rt).tm_isdst) == sizeof(long) ? (long long) (long) ((*rt).tm_isdst) : (long long) ((*rt).tm_isdst))); } while (0);
 }
 tprint_struct_end();
}
static void
...
decode_rtc_wkalrm(struct tcb *const tcp, const kernel_ulong_t addr)
{
 ...
 if (umoven_or_printaddr((tcp), (addr), sizeof(*(&wk)), (void *) (&wk)))
  return;
 tprint_struct_begin();
 do { tprints_field_name("enabled"); tprintf("%llu", (sizeof((wk).enabled) == sizeof(char) ? (unsigned long long) (unsigned char) ((wk).enabled) : sizeof((wk).enabled) == sizeof(short) ? (unsigned long long) (unsigned short) ((wk).enabled) : sizeof((wk).enabled) == sizeof(int) ? (unsigned long long) (unsigned int) ((wk).enabled) : sizeof((wk).enabled) == sizeof(long) ? (unsigned long long) (unsigned long) ((wk).enabled) : (unsigned long long) ((wk).enabled))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("pending"); tprintf("%llu", (sizeof((wk).pending) == sizeof(char) ? (unsigned long long) (unsigned char) ((wk).pending) : sizeof((wk).pending) == sizeof(short) ? (unsigned long long) (unsigned short) ((wk).pending) : sizeof((wk).pending) == sizeof(int) ? (unsigned long long) (unsigned int) ((wk).pending) : sizeof((wk).pending) == sizeof(long) ? (unsigned long long) (unsigned long) ((wk).pending) : (unsigned long long) ((wk).pending))); } while (0);
 tprint_struct_next();
...
decode_rtc_pll_info(struct tcb *const tcp, const kernel_ulong_t addr)
{
 ...
 if (umoven_or_printaddr((tcp), (addr), sizeof(*(&pll)), (void *) (&pll)))
  return;
 tprint_struct_begin();
 do { tprints_field_name("pll_ctrl"); tprintf("%lld", (sizeof((pll).pll_ctrl) == sizeof(char) ? (long long) (char) ((pll).pll_ctrl) : sizeof((pll).pll_ctrl) == sizeof(short) ? (long long) (short) ((pll).pll_ctrl) : sizeof((pll).pll_ctrl) == sizeof(int) ? (long long) (int) ((pll).pll_ctrl) : sizeof((pll).pll_ctrl) == sizeof(long) ? (long long) (long) ((pll).pll_ctrl) : (long long) ((pll).pll_ctrl))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("pll_value"); tprintf("%lld", (sizeof((pll).pll_value) == sizeof(char) ? (long long) (char) ((pll).pll_value) : sizeof((pll).pll_value) == sizeof(short) ? (long long) (short) ((pll).pll_value) : sizeof((pll).pll_value) == sizeof(int) ? (long long) (int) ((pll).pll_value) : sizeof((pll).pll_value) == sizeof(long) ? (long long) (long) ((pll).pll_value) : (long long) ((pll).pll_value))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("pll_max"); tprintf("%lld", (sizeof((pll).pll_max) == sizeof(char) ? (long long) (char) ((pll).pll_max) : sizeof((pll).pll_max) == sizeof(short) ? (long long) (short) ((pll).pll_max) : sizeof((pll).pll_max) == sizeof(int) ? (long long) (int) ((pll).pll_max) : sizeof((pll).pll_max) == sizeof(long) ? (long long) (long) ((pll).pll_max) : (long long) ((pll).pll_max))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("pll_min"); tprintf("%lld", (sizeof((pll).pll_min) == sizeof(char) ? (long long) (char) ((pll).pll_min) : sizeof((pll).pll_min) == sizeof(short) ? (long long) (short) ((pll).pll_min) : sizeof((pll).pll_min) == sizeof(int) ? (long long) (int) ((pll).pll_min) : sizeof((pll).pll_min) == sizeof(long) ? (long long) (long) ((pll).pll_min) : (long long) ((pll).pll_min))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("pll_posmult"); tprintf("%lld", (sizeof((pll).pll_posmult) == sizeof(char) ? (long long) (char) ((pll).pll_posmult) : sizeof((pll).pll_posmult) == sizeof(short) ? (long long) (short) ((pll).pll_posmult) : sizeof((pll).pll_posmult) == sizeof(int) ? (long long) (int) ((pll).pll_posmult) : sizeof((pll).pll_posmult) == sizeof(long) ? (long long) (long) ((pll).pll_posmult) : (long long) ((pll).pll_posmult))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("pll_negmult"); tprintf("%lld", (sizeof((pll).pll_negmult) == sizeof(char) ? (long long) (char) ((pll).pll_negmult) : sizeof((pll).pll_negmult) == sizeof(short) ? (long long) (short) ((pll).pll_negmult) : sizeof((pll).pll_negmult) == sizeof(int) ? (long long) (int) ((pll).pll_negmult) : sizeof((pll).pll_negmult) == sizeof(long) ? (long long) (long) ((pll).pll_negmult) : (long long) ((pll).pll_negmult))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("pll_clock"); tprintf("%lld", (sizeof((pll).pll_clock) == sizeof(char) ? (long long) (char) ((pll).pll_clock) : sizeof((pll).pll_clock) == sizeof(short) ? (long long) (short) ((pll).pll_clock) : sizeof((pll).pll_clock) == sizeof(int) ? (long long) (int) ((pll).pll_clock) : sizeof((pll).pll_clock) == sizeof(long) ? (long long) (long) ((pll).pll_clock) : (long long) ((pll).pll_clock))); } while (0);
 tprint_struct_end();
}
static void
