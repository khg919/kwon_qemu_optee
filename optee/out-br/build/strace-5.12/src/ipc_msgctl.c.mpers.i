...
#pragma GCC diagnostic ignored "-Wtautological-compare"
 ;
_Static_assert((11) == (11), "MSG_STAT != 11");
...
#pragma GCC diagnostic ignored "-Wtautological-compare"
 ;
_Static_assert((12) == (12), "MSG_INFO != 12");
...
#pragma GCC diagnostic ignored "-Wtautological-compare"
 ;
_Static_assert((13) == (13), "MSG_STAT_ANY != 13");
...
static const struct xlat_data msgctl_flags_xdata[] = {
 ...
 { (unsigned)(2), "IPC_STAT" },
 { (unsigned)(3), "IPC_INFO" },
 { (unsigned)(11), "MSG_STAT" },
 { (unsigned)(12), "MSG_INFO" },
 { (unsigned)(13), "MSG_STAT_ANY" },
};
static
const struct xlat msgctl_flags[1] = { {
 .data = msgctl_flags_xdata,
 .size = (sizeof(msgctl_flags_xdata) / sizeof((msgctl_flags_xdata)[0]) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(typeof((msgctl_flags_xdata)), typeof(&(msgctl_flags_xdata)[0])))]) * 0)),
 .type = XT_SORTED,
 .flags_mask = 0
  | ((unsigned) (0))
  | ((unsigned) (1))
...
static void
print_ipc_perm(const typeof(((msqid_ds_t *)0)->msg_perm) *const p,
...
{
 msqid_ds_t msqid_ds;
 if (umoven_or_printaddr((tcp), (addr), sizeof(*(&msqid_ds)), (void *) (&msqid_ds)))
  return;
 tprint_struct_begin();
 do { tprints_field_name("msg_perm"); (print_ipc_perm)(&((msqid_ds).msg_perm), cmd); } while (0);
 if (cmd != 1) {
  tprint_struct_next();
  do { tprints_field_name("msg_stime"); tprintf("%llu", (sizeof((msqid_ds).msg_stime) == sizeof(char) ? (unsigned long long) (unsigned char) ((msqid_ds).msg_stime) : sizeof((msqid_ds).msg_stime) == sizeof(short) ? (unsigned long long) (unsigned short) ((msqid_ds).msg_stime) : sizeof((msqid_ds).msg_stime) == sizeof(int) ? (unsigned long long) (unsigned int) ((msqid_ds).msg_stime) : sizeof((msqid_ds).msg_stime) == sizeof(long) ? (unsigned long long) (unsigned long) ((msqid_ds).msg_stime) : (unsigned long long) ((msqid_ds).msg_stime))); } while (0);
  tprint_struct_next();
  do { tprints_field_name("msg_rtime"); tprintf("%llu", (sizeof((msqid_ds).msg_rtime) == sizeof(char) ? (unsigned long long) (unsigned char) ((msqid_ds).msg_rtime) : sizeof((msqid_ds).msg_rtime) == sizeof(short) ? (unsigned long long) (unsigned short) ((msqid_ds).msg_rtime) : sizeof((msqid_ds).msg_rtime) == sizeof(int) ? (unsigned long long) (unsigned int) ((msqid_ds).msg_rtime) : sizeof((msqid_ds).msg_rtime) == sizeof(long) ? (unsigned long long) (unsigned long) ((msqid_ds).msg_rtime) : (unsigned long long) ((msqid_ds).msg_rtime))); } while (0);
  tprint_struct_next();
  do { tprints_field_name("msg_ctime"); tprintf("%llu", (sizeof((msqid_ds).msg_ctime) == sizeof(char) ? (unsigned long long) (unsigned char) ((msqid_ds).msg_ctime) : sizeof((msqid_ds).msg_ctime) == sizeof(short) ? (unsigned long long) (unsigned short) ((msqid_ds).msg_ctime) : sizeof((msqid_ds).msg_ctime) == sizeof(int) ? (unsigned long long) (unsigned int) ((msqid_ds).msg_ctime) : sizeof((msqid_ds).msg_ctime) == sizeof(long) ? (unsigned long long) (unsigned long) ((msqid_ds).msg_ctime) : (unsigned long long) ((msqid_ds).msg_ctime))); } while (0);
  tprint_struct_next();
  do { tprints_field_name("msg_qnum"); tprintf("%llu", (sizeof((msqid_ds).msg_qnum) == sizeof(char) ? (unsigned long long) (unsigned char) ((msqid_ds).msg_qnum) : sizeof((msqid_ds).msg_qnum) == sizeof(short) ? (unsigned long long) (unsigned short) ((msqid_ds).msg_qnum) : sizeof((msqid_ds).msg_qnum) == sizeof(int) ? (unsigned long long) (unsigned int) ((msqid_ds).msg_qnum) : sizeof((msqid_ds).msg_qnum) == sizeof(long) ? (unsigned long long) (unsigned long) ((msqid_ds).msg_qnum) : (unsigned long long) ((msqid_ds).msg_qnum))); } while (0);
 }
 tprint_struct_next();
 do { tprints_field_name("msg_qbytes"); tprintf("%llu", (sizeof((msqid_ds).msg_qbytes) == sizeof(char) ? (unsigned long long) (unsigned char) ((msqid_ds).msg_qbytes) : sizeof((msqid_ds).msg_qbytes) == sizeof(short) ? (unsigned long long) (unsigned short) ((msqid_ds).msg_qbytes) : sizeof((msqid_ds).msg_qbytes) == sizeof(int) ? (unsigned long long) (unsigned int) ((msqid_ds).msg_qbytes) : sizeof((msqid_ds).msg_qbytes) == sizeof(long) ? (unsigned long long) (unsigned long) ((msqid_ds).msg_qbytes) : (unsigned long long) ((msqid_ds).msg_qbytes))); } while (0);
 if (cmd != 1) {
  tprint_struct_next();
  do { tprints_field_name("msg_lspid"); tprintf("%lld", (sizeof((msqid_ds).msg_lspid) == sizeof(char) ? (long long) (char) ((msqid_ds).msg_lspid) : sizeof((msqid_ds).msg_lspid) == sizeof(short) ? (long long) (short) ((msqid_ds).msg_lspid) : sizeof((msqid_ds).msg_lspid) == sizeof(int) ? (long long) (int) ((msqid_ds).msg_lspid) : sizeof((msqid_ds).msg_lspid) == sizeof(long) ? (long long) (long) ((msqid_ds).msg_lspid) : (long long) ((msqid_ds).msg_lspid))); } while (0);
  tprint_struct_next();
  do { tprints_field_name("msg_lrpid"); tprintf("%lld", (sizeof((msqid_ds).msg_lrpid) == sizeof(char) ? (long long) (char) ((msqid_ds).msg_lrpid) : sizeof((msqid_ds).msg_lrpid) == sizeof(short) ? (long long) (short) ((msqid_ds).msg_lrpid) : sizeof((msqid_ds).msg_lrpid) == sizeof(int) ? (long long) (int) ((msqid_ds).msg_lrpid) : sizeof((msqid_ds).msg_lrpid) == sizeof(long) ? (long long) (long) ((msqid_ds).msg_lrpid) : (long long) ((msqid_ds).msg_lrpid))); } while (0);
 }
 tprint_struct_end();
}
static void
       ...
       const unsigned int cmd)
{
 ...
 if (umoven_or_printaddr((tcp), (addr), sizeof(*(&info)), (void *) (&info)))
  return;
 tprint_struct_begin();
 do { tprints_field_name("msgpool"); tprintf("%lld", (sizeof((info).msgpool) == sizeof(char) ? (long long) (char) ((info).msgpool) : sizeof((info).msgpool) == sizeof(short) ? (long long) (short) ((info).msgpool) : sizeof((info).msgpool) == sizeof(int) ? (long long) (int) ((info).msgpool) : sizeof((info).msgpool) == sizeof(long) ? (long long) (long) ((info).msgpool) : (long long) ((info).msgpool))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("msgmap"); tprintf("%lld", (sizeof((info).msgmap) == sizeof(char) ? (long long) (char) ((info).msgmap) : sizeof((info).msgmap) == sizeof(short) ? (long long) (short) ((info).msgmap) : sizeof((info).msgmap) == sizeof(int) ? (long long) (int) ((info).msgmap) : sizeof((info).msgmap) == sizeof(long) ? (long long) (long) ((info).msgmap) : (long long) ((info).msgmap))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("msgmax"); tprintf("%lld", (sizeof((info).msgmax) == sizeof(char) ? (long long) (char) ((info).msgmax) : sizeof((info).msgmax) == sizeof(short) ? (long long) (short) ((info).msgmax) : sizeof((info).msgmax) == sizeof(int) ? (long long) (int) ((info).msgmax) : sizeof((info).msgmax) == sizeof(long) ? (long long) (long) ((info).msgmax) : (long long) ((info).msgmax))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("msgmnb"); tprintf("%lld", (sizeof((info).msgmnb) == sizeof(char) ? (long long) (char) ((info).msgmnb) : sizeof((info).msgmnb) == sizeof(short) ? (long long) (short) ((info).msgmnb) : sizeof((info).msgmnb) == sizeof(int) ? (long long) (int) ((info).msgmnb) : sizeof((info).msgmnb) == sizeof(long) ? (long long) (long) ((info).msgmnb) : (long long) ((info).msgmnb))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("msgmni"); tprintf("%lld", (sizeof((info).msgmni) == sizeof(char) ? (long long) (char) ((info).msgmni) : sizeof((info).msgmni) == sizeof(short) ? (long long) (short) ((info).msgmni) : sizeof((info).msgmni) == sizeof(int) ? (long long) (int) ((info).msgmni) : sizeof((info).msgmni) == sizeof(long) ? (long long) (long) ((info).msgmni) : (long long) ((info).msgmni))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("msgssz"); tprintf("%lld", (sizeof((info).msgssz) == sizeof(char) ? (long long) (char) ((info).msgssz) : sizeof((info).msgssz) == sizeof(short) ? (long long) (short) ((info).msgssz) : sizeof((info).msgssz) == sizeof(int) ? (long long) (int) ((info).msgssz) : sizeof((info).msgssz) == sizeof(long) ? (long long) (long) ((info).msgssz) : (long long) ((info).msgssz))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("msgtql"); tprintf("%lld", (sizeof((info).msgtql) == sizeof(char) ? (long long) (char) ((info).msgtql) : sizeof((info).msgtql) == sizeof(short) ? (long long) (short) ((info).msgtql) : sizeof((info).msgtql) == sizeof(int) ? (long long) (int) ((info).msgtql) : sizeof((info).msgtql) == sizeof(long) ? (long long) (long) ((info).msgtql) : (long long) ((info).msgtql))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("msgseg"); tprintf("%llu", (sizeof((info).msgseg) == sizeof(char) ? (unsigned long long) (unsigned char) ((info).msgseg) : sizeof((info).msgseg) == sizeof(short) ? (unsigned long long) (unsigned short) ((info).msgseg) : sizeof((info).msgseg) == sizeof(int) ? (unsigned long long) (unsigned int) ((info).msgseg) : sizeof((info).msgseg) == sizeof(long) ? (unsigned long long) (unsigned long) ((info).msgseg) : (unsigned long long) ((info).msgseg))); } while (0);
 tprint_struct_end();
}
int sys_msgctl(struct tcb *tcp)
{
 ...
 if ((!((tcp)->flags & 0x04))) {
  ...
  tprint_arg_next();
  do { if ((tcp->u_arg[1]) & 0x0100) { print_xlat_ex((0x0100), "IPC_64", XLAT_STYLE_DEFAULT); tprints("|"); } printxval((msgctl_flags), (tcp->u_arg[1]) & ~0x0100, "MSG_???"); } while (0);
  tprint_arg_next();
  switch (cmd) {
  case 1:
