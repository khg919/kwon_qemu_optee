...
MPERS_PRINTER_DECL(_Bool, fetch_struct_stat64, struct tcb *const tcp, const kernel_ulong_t addr, struct strace_stat *const dst)
{
 struct_stat64 buf;
 if (umoven_or_printaddr((tcp), (addr), sizeof(*(&buf)), (void *) (&buf)))
  return 0;
 dst->dev = (sizeof(buf.st_dev) == sizeof(char) ? (unsigned long long) (unsigned char) (buf.st_dev) : sizeof(buf.st_dev) == sizeof(short) ? (unsigned long long) (unsigned short) (buf.st_dev) : sizeof(buf.st_dev) == sizeof(int) ? (unsigned long long) (unsigned int) (buf.st_dev) : sizeof(buf.st_dev) == sizeof(long) ? (unsigned long long) (unsigned long) (buf.st_dev) : (unsigned long long) (buf.st_dev));
 dst->ino = (sizeof(buf.st_ino) == sizeof(char) ? (unsigned long long) (unsigned char) (buf.st_ino) : sizeof(buf.st_ino) == sizeof(short) ? (unsigned long long) (unsigned short) (buf.st_ino) : sizeof(buf.st_ino) == sizeof(int) ? (unsigned long long) (unsigned int) (buf.st_ino) : sizeof(buf.st_ino) == sizeof(long) ? (unsigned long long) (unsigned long) (buf.st_ino) : (unsigned long long) (buf.st_ino));
 dst->rdev = (sizeof(buf.st_rdev) == sizeof(char) ? (unsigned long long) (unsigned char) (buf.st_rdev) : sizeof(buf.st_rdev) == sizeof(short) ? (unsigned long long) (unsigned short) (buf.st_rdev) : sizeof(buf.st_rdev) == sizeof(int) ? (unsigned long long) (unsigned int) (buf.st_rdev) : sizeof(buf.st_rdev) == sizeof(long) ? (unsigned long long) (unsigned long) (buf.st_rdev) : (unsigned long long) (buf.st_rdev));
 dst->size = (sizeof(buf.st_size) == sizeof(char) ? (unsigned long long) (unsigned char) (buf.st_size) : sizeof(buf.st_size) == sizeof(short) ? (unsigned long long) (unsigned short) (buf.st_size) : sizeof(buf.st_size) == sizeof(int) ? (unsigned long long) (unsigned int) (buf.st_size) : sizeof(buf.st_size) == sizeof(long) ? (unsigned long long) (unsigned long) (buf.st_size) : (unsigned long long) (buf.st_size));
 dst->blocks = (sizeof(buf.st_blocks) == sizeof(char) ? (unsigned long long) (unsigned char) (buf.st_blocks) : sizeof(buf.st_blocks) == sizeof(short) ? (unsigned long long) (unsigned short) (buf.st_blocks) : sizeof(buf.st_blocks) == sizeof(int) ? (unsigned long long) (unsigned int) (buf.st_blocks) : sizeof(buf.st_blocks) == sizeof(long) ? (unsigned long long) (unsigned long) (buf.st_blocks) : (unsigned long long) (buf.st_blocks));
 dst->blksize = (sizeof(buf.st_blksize) == sizeof(char) ? (unsigned long long) (unsigned char) (buf.st_blksize) : sizeof(buf.st_blksize) == sizeof(short) ? (unsigned long long) (unsigned short) (buf.st_blksize) : sizeof(buf.st_blksize) == sizeof(int) ? (unsigned long long) (unsigned int) (buf.st_blksize) : sizeof(buf.st_blksize) == sizeof(long) ? (unsigned long long) (unsigned long) (buf.st_blksize) : (unsigned long long) (buf.st_blksize));
 dst->mode = (sizeof(buf.st_mode) == sizeof(char) ? (unsigned long long) (unsigned char) (buf.st_mode) : sizeof(buf.st_mode) == sizeof(short) ? (unsigned long long) (unsigned short) (buf.st_mode) : sizeof(buf.st_mode) == sizeof(int) ? (unsigned long long) (unsigned int) (buf.st_mode) : sizeof(buf.st_mode) == sizeof(long) ? (unsigned long long) (unsigned long) (buf.st_mode) : (unsigned long long) (buf.st_mode));
 dst->nlink = (sizeof(buf.st_nlink) == sizeof(char) ? (unsigned long long) (unsigned char) (buf.st_nlink) : sizeof(buf.st_nlink) == sizeof(short) ? (unsigned long long) (unsigned short) (buf.st_nlink) : sizeof(buf.st_nlink) == sizeof(int) ? (unsigned long long) (unsigned int) (buf.st_nlink) : sizeof(buf.st_nlink) == sizeof(long) ? (unsigned long long) (unsigned long) (buf.st_nlink) : (unsigned long long) (buf.st_nlink));
 dst->uid = (sizeof(buf.st_uid) == sizeof(char) ? (unsigned long long) (unsigned char) (buf.st_uid) : sizeof(buf.st_uid) == sizeof(short) ? (unsigned long long) (unsigned short) (buf.st_uid) : sizeof(buf.st_uid) == sizeof(int) ? (unsigned long long) (unsigned int) (buf.st_uid) : sizeof(buf.st_uid) == sizeof(long) ? (unsigned long long) (unsigned long) (buf.st_uid) : (unsigned long long) (buf.st_uid));
 dst->gid = (sizeof(buf.st_gid) == sizeof(char) ? (unsigned long long) (unsigned char) (buf.st_gid) : sizeof(buf.st_gid) == sizeof(short) ? (unsigned long long) (unsigned short) (buf.st_gid) : sizeof(buf.st_gid) == sizeof(int) ? (unsigned long long) (unsigned int) (buf.st_gid) : sizeof(buf.st_gid) == sizeof(long) ? (unsigned long long) (unsigned long) (buf.st_gid) : (unsigned long long) (buf.st_gid));
 dst->atime = (sizeof(buf.st_atime) == sizeof(char) ? (long long) (char) (buf.st_atime) : sizeof(buf.st_atime) == sizeof(short) ? (long long) (short) (buf.st_atime) : sizeof(buf.st_atime) == sizeof(int) ? (long long) (int) (buf.st_atime) : sizeof(buf.st_atime) == sizeof(long) ? (long long) (long) (buf.st_atime) : (long long) (buf.st_atime));
 dst->ctime = (sizeof(buf.st_ctime) == sizeof(char) ? (long long) (char) (buf.st_ctime) : sizeof(buf.st_ctime) == sizeof(short) ? (long long) (short) (buf.st_ctime) : sizeof(buf.st_ctime) == sizeof(int) ? (long long) (int) (buf.st_ctime) : sizeof(buf.st_ctime) == sizeof(long) ? (long long) (long) (buf.st_ctime) : (long long) (buf.st_ctime));
 dst->mtime = (sizeof(buf.st_mtime) == sizeof(char) ? (long long) (char) (buf.st_mtime) : sizeof(buf.st_mtime) == sizeof(short) ? (long long) (short) (buf.st_mtime) : sizeof(buf.st_mtime) == sizeof(int) ? (long long) (int) (buf.st_mtime) : sizeof(buf.st_mtime) == sizeof(long) ? (long long) (long) (buf.st_mtime) : (long long) (buf.st_mtime));
 dst->atime_nsec = (sizeof(buf.st_atime_nsec) == sizeof(char) ? (unsigned long long) (unsigned char) (buf.st_atime_nsec) : sizeof(buf.st_atime_nsec) == sizeof(short) ? (unsigned long long) (unsigned short) (buf.st_atime_nsec) : sizeof(buf.st_atime_nsec) == sizeof(int) ? (unsigned long long) (unsigned int) (buf.st_atime_nsec) : sizeof(buf.st_atime_nsec) == sizeof(long) ? (unsigned long long) (unsigned long) (buf.st_atime_nsec) : (unsigned long long) (buf.st_atime_nsec));
 dst->ctime_nsec = (sizeof(buf.st_ctime_nsec) == sizeof(char) ? (unsigned long long) (unsigned char) (buf.st_ctime_nsec) : sizeof(buf.st_ctime_nsec) == sizeof(short) ? (unsigned long long) (unsigned short) (buf.st_ctime_nsec) : sizeof(buf.st_ctime_nsec) == sizeof(int) ? (unsigned long long) (unsigned int) (buf.st_ctime_nsec) : sizeof(buf.st_ctime_nsec) == sizeof(long) ? (unsigned long long) (unsigned long) (buf.st_ctime_nsec) : (unsigned long long) (buf.st_ctime_nsec));
 dst->mtime_nsec = (sizeof(buf.st_mtime_nsec) == sizeof(char) ? (unsigned long long) (unsigned char) (buf.st_mtime_nsec) : sizeof(buf.st_mtime_nsec) == sizeof(short) ? (unsigned long long) (unsigned short) (buf.st_mtime_nsec) : sizeof(buf.st_mtime_nsec) == sizeof(int) ? (unsigned long long) (unsigned int) (buf.st_mtime_nsec) : sizeof(buf.st_mtime_nsec) == sizeof(long) ? (unsigned long long) (unsigned long) (buf.st_mtime_nsec) : (unsigned long long) (buf.st_mtime_nsec));
 dst->has_nsec = 1;
 return 1;
}
