...
#pragma GCC diagnostic ignored "-Wtautological-compare"
 ;
_Static_assert((LO_FLAGS_READ_ONLY) == (1), "LO_FLAGS_READ_ONLY != 1");
...
#pragma GCC diagnostic ignored "-Wtautological-compare"
 ;
_Static_assert((LO_FLAGS_AUTOCLEAR) == (4), "LO_FLAGS_AUTOCLEAR != 4");
...
#pragma GCC diagnostic ignored "-Wtautological-compare"
 ;
_Static_assert((LO_FLAGS_PARTSCAN) == (8), "LO_FLAGS_PARTSCAN != 8");
...
#pragma GCC diagnostic ignored "-Wtautological-compare"
 ;
_Static_assert((LO_FLAGS_DIRECT_IO) == (16), "LO_FLAGS_DIRECT_IO != 16");

#pragma GCC diagnostic pop
;
static const struct xlat_data loop_flags_options_xdata[] = {
 { (unsigned)(LO_FLAGS_READ_ONLY), "LO_FLAGS_READ_ONLY" },
 { (unsigned)(2), "LO_FLAGS_USE_AOPS" },
 { (unsigned)(LO_FLAGS_AUTOCLEAR), "LO_FLAGS_AUTOCLEAR" },
 { (unsigned)(LO_FLAGS_PARTSCAN), "LO_FLAGS_PARTSCAN" },
 { (unsigned)(LO_FLAGS_DIRECT_IO), "LO_FLAGS_DIRECT_IO" },
};
static
const struct xlat loop_flags_options[1] = { {
 .data = loop_flags_options_xdata,
 .size = (sizeof(loop_flags_options_xdata) / sizeof((loop_flags_options_xdata)[0]) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(typeof((loop_flags_options_xdata)), typeof(&(loop_flags_options_xdata)[0])))]) * 0)),
 .type = XT_NORMAL,
 .flags_mask = 0
  | ((unsigned) (LO_FLAGS_READ_ONLY))
  | ((unsigned) (2))
  | ((unsigned) (LO_FLAGS_AUTOCLEAR))
  | ((unsigned) (LO_FLAGS_PARTSCAN))
  | ((unsigned) (LO_FLAGS_DIRECT_IO))
  ,
 .flags_strsz = 0
  + sizeof("LO_FLAGS_READ_ONLY")
  + sizeof("LO_FLAGS_USE_AOPS")
  + sizeof("LO_FLAGS_AUTOCLEAR")
  + sizeof("LO_FLAGS_PARTSCAN")
  + sizeof("LO_FLAGS_DIRECT_IO")
  ,
} };
static const struct xlat_data loop_crypt_type_options_xdata[] = {
 { (unsigned)(0), "LO_CRYPT_NONE" },
 { (unsigned)(1), "LO_CRYPT_XOR" },
 { (unsigned)(2), "LO_CRYPT_DES" },
 { (unsigned)(3), "LO_CRYPT_FISH2" },
 { (unsigned)(4), "LO_CRYPT_BLOW" },
 { (unsigned)(5), "LO_CRYPT_CAST128" },
 { (unsigned)(6), "LO_CRYPT_IDEA" },
 { (unsigned)(9), "LO_CRYPT_DUMMY" },
 { (unsigned)(10), "LO_CRYPT_SKIPJACK" },
 { (unsigned)(18), "LO_CRYPT_CRYPTOAPI" },
};
static
const struct xlat loop_crypt_type_options[1] = { {
 .data = loop_crypt_type_options_xdata,
 .size = (sizeof(loop_crypt_type_options_xdata) / sizeof((loop_crypt_type_options_xdata)[0]) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(typeof((loop_crypt_type_options_xdata)), typeof(&(loop_crypt_type_options_xdata)[0])))]) * 0)),
 .type = XT_NORMAL,
 .flags_mask = 0
  | ((unsigned) (0))
  | ((unsigned) (1))
  ...
  ,
 .flags_strsz = 0
  + sizeof("LO_CRYPT_NONE")
  + sizeof("LO_CRYPT_XOR")
  + sizeof("LO_CRYPT_DES")
  + sizeof("LO_CRYPT_FISH2")
  + sizeof("LO_CRYPT_BLOW")
  + sizeof("LO_CRYPT_CAST128")
  + sizeof("LO_CRYPT_IDEA")
  + sizeof("LO_CRYPT_DUMMY")
  + sizeof("LO_CRYPT_SKIPJACK")
  + sizeof("LO_CRYPT_CRYPTOAPI")
  ,
} };
static void
decode_loop_info(struct tcb *const tcp, const kernel_ulong_t addr)
{
 ...
 if (umoven_or_printaddr((tcp), (addr), sizeof(*(&info)), (void *) (&info)))
  return;
 tprint_struct_begin();
 do { tprints_field_name("lo_number"); tprintf("%lld", (sizeof((info).lo_number) == sizeof(char) ? (long long) (char) ((info).lo_number) : sizeof((info).lo_number) == sizeof(short) ? (long long) (short) ((info).lo_number) : sizeof((info).lo_number) == sizeof(int) ? (long long) (int) ((info).lo_number) : sizeof((info).lo_number) == sizeof(long) ? (long long) (long) ((info).lo_number) : (long long) ((info).lo_number))); } while (0);
 if (!((tcp)->qual_flg & 0x002)) {
  tprint_struct_next();
  do { tprints_field_name("lo_device"); print_dev_t((info).lo_device); } while (0);
  tprint_struct_next();
  do { tprints_field_name("lo_inode"); tprintf("%llu", (sizeof((info).lo_inode) == sizeof(char) ? (unsigned long long) (unsigned char) ((info).lo_inode) : sizeof((info).lo_inode) == sizeof(short) ? (unsigned long long) (unsigned short) ((info).lo_inode) : sizeof((info).lo_inode) == sizeof(int) ? (unsigned long long) (unsigned int) ((info).lo_inode) : sizeof((info).lo_inode) == sizeof(long) ? (unsigned long long) (unsigned long) ((info).lo_inode) : (unsigned long long) ((info).lo_inode))); } while (0);
  tprint_struct_next();
  do { tprints_field_name("lo_rdevice"); print_dev_t((info).lo_rdevice); } while (0);
 }
 tprint_struct_next();
 do { tprints_field_name("lo_offset"); tprintf("%#llx", (sizeof((info).lo_offset) == sizeof(char) ? (unsigned long long) (unsigned char) ((info).lo_offset) : sizeof((info).lo_offset) == sizeof(short) ? (unsigned long long) (unsigned short) ((info).lo_offset) : sizeof((info).lo_offset) == sizeof(int) ? (unsigned long long) (unsigned int) ((info).lo_offset) : sizeof((info).lo_offset) == sizeof(long) ? (unsigned long long) (unsigned long) ((info).lo_offset) : (unsigned long long) ((info).lo_offset))); } while (0);
 if (!((tcp)->qual_flg & 0x002) || info.lo_encrypt_type != 0) {
  tprint_struct_next();
  do { tprints_field_name("lo_encrypt_type"); printxval64((loop_crypt_type_options), (sizeof((info).lo_encrypt_type) == sizeof(char) ? (unsigned long long) (unsigned char) ((info).lo_encrypt_type) : sizeof((info).lo_encrypt_type) == sizeof(short) ? (unsigned long long) (unsigned short) ((info).lo_encrypt_type) : sizeof((info).lo_encrypt_type) == sizeof(int) ? (unsigned long long) (unsigned int) ((info).lo_encrypt_type) : sizeof((info).lo_encrypt_type) == sizeof(long) ? (unsigned long long) (unsigned long) ((info).lo_encrypt_type) : (unsigned long long) ((info).lo_encrypt_type)), ("LO_CRYPT_???")); } while (0);
  tprint_struct_next();
  do { tprints_field_name("lo_encrypt_key_size"); tprintf("%llu", (sizeof((info).lo_encrypt_key_size) == sizeof(char) ? (unsigned long long) (unsigned char) ((info).lo_encrypt_key_size) : sizeof((info).lo_encrypt_key_size) == sizeof(short) ? (unsigned long long) (unsigned short) ((info).lo_encrypt_key_size) : sizeof((info).lo_encrypt_key_size) == sizeof(int) ? (unsigned long long) (unsigned int) ((info).lo_encrypt_key_size) : sizeof((info).lo_encrypt_key_size) == sizeof(long) ? (unsigned long long) (unsigned long) ((info).lo_encrypt_key_size) : (unsigned long long) ((info).lo_encrypt_key_size))); } while (0);
 }
 tprint_struct_next();
 do { tprints_field_name("lo_flags"); printflags64((loop_flags_options), (sizeof((info).lo_flags) == sizeof(char) ? (unsigned long long) (unsigned char) ((info).lo_flags) : sizeof((info).lo_flags) == sizeof(short) ? (unsigned long long) (unsigned short) ((info).lo_flags) : sizeof((info).lo_flags) == sizeof(int) ? (unsigned long long) (unsigned int) ((info).lo_flags) : sizeof((info).lo_flags) == sizeof(long) ? (unsigned long long) (unsigned long) ((info).lo_flags) : (unsigned long long) ((info).lo_flags)), ("LO_FLAGS_???")); } while (0);
 tprint_struct_next();
 do { tprints_field_name("lo_name"); print_quoted_cstring((const char *) (info).lo_name, sizeof((info).lo_name) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(typeof(((info).lo_name)), typeof(&((info).lo_name)[0])))]) * 0)); } while (0);
 if (!((tcp)->qual_flg & 0x002) || info.lo_encrypt_type != 0) {
  const unsigned int lo_encrypt_key_size =
   ((((unsigned) info.lo_encrypt_key_size) < (32)) ? ((unsigned) info.lo_encrypt_key_size) : (32));
  tprint_struct_next();
  do { tprints_field_name("lo_encrypt_key"); print_quoted_string((const char *)(info).lo_encrypt_key, (lo_encrypt_key_size), (0)); } while (0);
 }
 if (!((tcp)->qual_flg & 0x002)) {
  tprint_struct_next();
  do { tprints_field_name("lo_init"); for (size_t i_ = 0; i_ < (sizeof(((info)).lo_init) / sizeof((((info)).lo_init)[0]) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(typeof((((info)).lo_init)), typeof(&(((info)).lo_init)[0])))]) * 0)); ++i_) { if (i_) tprint_array_next(); else tprint_array_begin(); tprintf("%#llx", (sizeof(((info)).lo_init[i_]) == sizeof(char) ? (unsigned long long) (unsigned char) (((info)).lo_init[i_]) : sizeof(((info)).lo_init[i_]) == sizeof(short) ? (unsigned long long) (unsigned short) (((info)).lo_init[i_]) : sizeof(((info)).lo_init[i_]) == sizeof(int) ? (unsigned long long) (unsigned int) (((info)).lo_init[i_]) : sizeof(((info)).lo_init[i_]) == sizeof(long) ? (unsigned long long) (unsigned long) (((info)).lo_init[i_]) : (unsigned long long) (((info)).lo_init[i_]))); } tprint_array_end(); } while (0);
  tprint_struct_next();
  do { tprints_field_name("reserved"); for (size_t i_ = 0; i_ < (sizeof(((info)).reserved) / sizeof((((info)).reserved)[0]) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(typeof((((info)).reserved)), typeof(&(((info)).reserved)[0])))]) * 0)); ++i_) { if (i_) tprint_array_next(); else tprint_array_begin(); tprintf("%#llx", (sizeof(((info)).reserved[i_]) == sizeof(char) ? (unsigned long long) (unsigned char) (((info)).reserved[i_]) : sizeof(((info)).reserved[i_]) == sizeof(short) ? (unsigned long long) (unsigned short) (((info)).reserved[i_]) : sizeof(((info)).reserved[i_]) == sizeof(int) ? (unsigned long long) (unsigned int) (((info)).reserved[i_]) : sizeof(((info)).reserved[i_]) == sizeof(long) ? (unsigned long long) (unsigned long) (((info)).reserved[i_]) : (unsigned long long) (((info)).reserved[i_]))); } tprint_array_end(); } while (0);
 } else {
  tprint_struct_next();
...
print_loop_info64(struct tcb *const tcp, const struct loop_info64 *const info64)
{
 if (!((tcp)->qual_flg & 0x002)) {
  tprint_struct_begin();
  do { tprints_field_name("lo_device"); print_dev_t((*info64).lo_device); } while (0);
  tprint_struct_next();
  do { tprints_field_name("lo_inode"); tprintf("%llu", (sizeof((*info64).lo_inode) == sizeof(char) ? (unsigned long long) (unsigned char) ((*info64).lo_inode) : sizeof((*info64).lo_inode) == sizeof(short) ? (unsigned long long) (unsigned short) ((*info64).lo_inode) : sizeof((*info64).lo_inode) == sizeof(int) ? (unsigned long long) (unsigned int) ((*info64).lo_inode) : sizeof((*info64).lo_inode) == sizeof(long) ? (unsigned long long) (unsigned long) ((*info64).lo_inode) : (unsigned long long) ((*info64).lo_inode))); } while (0);
  tprint_struct_next();
  do { tprints_field_name("lo_rdevice"); print_dev_t((*info64).lo_rdevice); } while (0);
  tprint_struct_next();
  do { tprints_field_name("lo_offset"); tprintf("%#llx", (sizeof((*info64).lo_offset) == sizeof(char) ? (unsigned long long) (unsigned char) ((*info64).lo_offset) : sizeof((*info64).lo_offset) == sizeof(short) ? (unsigned long long) (unsigned short) ((*info64).lo_offset) : sizeof((*info64).lo_offset) == sizeof(int) ? (unsigned long long) (unsigned int) ((*info64).lo_offset) : sizeof((*info64).lo_offset) == sizeof(long) ? (unsigned long long) (unsigned long) ((*info64).lo_offset) : (unsigned long long) ((*info64).lo_offset))); } while (0);
  tprint_struct_next();
  do { tprints_field_name("lo_sizelimit"); tprintf("%llu", (sizeof((*info64).lo_sizelimit) == sizeof(char) ? (unsigned long long) (unsigned char) ((*info64).lo_sizelimit) : sizeof((*info64).lo_sizelimit) == sizeof(short) ? (unsigned long long) (unsigned short) ((*info64).lo_sizelimit) : sizeof((*info64).lo_sizelimit) == sizeof(int) ? (unsigned long long) (unsigned int) ((*info64).lo_sizelimit) : sizeof((*info64).lo_sizelimit) == sizeof(long) ? (unsigned long long) (unsigned long) ((*info64).lo_sizelimit) : (unsigned long long) ((*info64).lo_sizelimit))); } while (0);
  tprint_struct_next();
  do { tprints_field_name("lo_number"); tprintf("%llu", (sizeof((*info64).lo_number) == sizeof(char) ? (unsigned long long) (unsigned char) ((*info64).lo_number) : sizeof((*info64).lo_number) == sizeof(short) ? (unsigned long long) (unsigned short) ((*info64).lo_number) : sizeof((*info64).lo_number) == sizeof(int) ? (unsigned long long) (unsigned int) ((*info64).lo_number) : sizeof((*info64).lo_number) == sizeof(long) ? (unsigned long long) (unsigned long) ((*info64).lo_number) : (unsigned long long) ((*info64).lo_number))); } while (0);
 } else {
  tprint_struct_begin();
  do { tprints_field_name("lo_offset"); tprintf("%#llx", (sizeof((*info64).lo_offset) == sizeof(char) ? (unsigned long long) (unsigned char) ((*info64).lo_offset) : sizeof((*info64).lo_offset) == sizeof(short) ? (unsigned long long) (unsigned short) ((*info64).lo_offset) : sizeof((*info64).lo_offset) == sizeof(int) ? (unsigned long long) (unsigned int) ((*info64).lo_offset) : sizeof((*info64).lo_offset) == sizeof(long) ? (unsigned long long) (unsigned long) ((*info64).lo_offset) : (unsigned long long) ((*info64).lo_offset))); } while (0);
  tprint_struct_next();
 ...
 if (!((tcp)->qual_flg & 0x002) || info64->lo_encrypt_type != 0) {
  tprint_struct_next();
  do { tprints_field_name("lo_encrypt_type"); printxval64((loop_crypt_type_options), (sizeof((*info64).lo_encrypt_type) == sizeof(char) ? (unsigned long long) (unsigned char) ((*info64).lo_encrypt_type) : sizeof((*info64).lo_encrypt_type) == sizeof(short) ? (unsigned long long) (unsigned short) ((*info64).lo_encrypt_type) : sizeof((*info64).lo_encrypt_type) == sizeof(int) ? (unsigned long long) (unsigned int) ((*info64).lo_encrypt_type) : sizeof((*info64).lo_encrypt_type) == sizeof(long) ? (unsigned long long) (unsigned long) ((*info64).lo_encrypt_type) : (unsigned long long) ((*info64).lo_encrypt_type)), ("LO_CRYPT_???")); } while (0);
  tprint_struct_next();
  do { tprints_field_name("lo_encrypt_key_size"); tprintf("%llu", (sizeof((*info64).lo_encrypt_key_size) == sizeof(char) ? (unsigned long long) (unsigned char) ((*info64).lo_encrypt_key_size) : sizeof((*info64).lo_encrypt_key_size) == sizeof(short) ? (unsigned long long) (unsigned short) ((*info64).lo_encrypt_key_size) : sizeof((*info64).lo_encrypt_key_size) == sizeof(int) ? (unsigned long long) (unsigned int) ((*info64).lo_encrypt_key_size) : sizeof((*info64).lo_encrypt_key_size) == sizeof(long) ? (unsigned long long) (unsigned long) ((*info64).lo_encrypt_key_size) : (unsigned long long) ((*info64).lo_encrypt_key_size))); } while (0);
 }
 tprint_struct_next();
 do { tprints_field_name("lo_flags"); printflags64((loop_flags_options), (sizeof((*info64).lo_flags) == sizeof(char) ? (unsigned long long) (unsigned char) ((*info64).lo_flags) : sizeof((*info64).lo_flags) == sizeof(short) ? (unsigned long long) (unsigned short) ((*info64).lo_flags) : sizeof((*info64).lo_flags) == sizeof(int) ? (unsigned long long) (unsigned int) ((*info64).lo_flags) : sizeof((*info64).lo_flags) == sizeof(long) ? (unsigned long long) (unsigned long) ((*info64).lo_flags) : (unsigned long long) ((*info64).lo_flags)), ("LO_FLAGS_???")); } while (0);
 tprint_struct_next();
 do { tprints_field_name("lo_file_name"); print_quoted_cstring((const char *) (*info64).lo_file_name, sizeof((*info64).lo_file_name) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(typeof(((*info64).lo_file_name)), typeof(&((*info64).lo_file_name)[0])))]) * 0)); } while (0);
 if (!((tcp)->qual_flg & 0x002) || info64->lo_encrypt_type != 0) {
  tprint_struct_next();
  do { tprints_field_name("lo_crypt_name"); print_quoted_cstring((const char *) (*info64).lo_crypt_name, sizeof((*info64).lo_crypt_name) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(typeof(((*info64).lo_crypt_name)), typeof(&((*info64).lo_crypt_name)[0])))]) * 0)); } while (0);
  const unsigned int lo_encrypt_key_size =
   ((((unsigned) info64->lo_encrypt_key_size) < (32)) ? ((unsigned) info64->lo_encrypt_key_size) : (32));
  tprint_struct_next();
  do { tprints_field_name("lo_encrypt_key"); print_quoted_string((const char *)(*info64).lo_encrypt_key, (lo_encrypt_key_size), (0)); } while (0);
 }
 if (!((tcp)->qual_flg & 0x002)) {
  tprint_struct_next();
  do { tprints_field_name("lo_init"); for (size_t i_ = 0; i_ < (sizeof(((*info64)).lo_init) / sizeof((((*info64)).lo_init)[0]) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(typeof((((*info64)).lo_init)), typeof(&(((*info64)).lo_init)[0])))]) * 0)); ++i_) { if (i_) tprint_array_next(); else tprint_array_begin(); tprintf("%#llx", (sizeof(((*info64)).lo_init[i_]) == sizeof(char) ? (unsigned long long) (unsigned char) (((*info64)).lo_init[i_]) : sizeof(((*info64)).lo_init[i_]) == sizeof(short) ? (unsigned long long) (unsigned short) (((*info64)).lo_init[i_]) : sizeof(((*info64)).lo_init[i_]) == sizeof(int) ? (unsigned long long) (unsigned int) (((*info64)).lo_init[i_]) : sizeof(((*info64)).lo_init[i_]) == sizeof(long) ? (unsigned long long) (unsigned long) (((*info64)).lo_init[i_]) : (unsigned long long) (((*info64)).lo_init[i_]))); } tprint_array_end(); } while (0);
 } else {
  tprint_struct_next();
  tprint_more_data_follows();
 }
...
decode_loop_info64(struct tcb *const tcp, const kernel_ulong_t addr)
{
 ...
 if (!umoven_or_printaddr((tcp), (addr), sizeof(*(&info64)), (void *) (&info64)))
...
decode_loop_config(struct tcb *const tcp, const kernel_ulong_t addr)
{
 ...
 if (umoven_or_printaddr((tcp), (addr), sizeof(*(&config)), (void *) (&config)))
  return;
 tprint_struct_begin();
 do { tprints_field_name("fd"); printfd((tcp), (config).fd); } while (0);
 tprint_struct_next();
 do { tprints_field_name("block_size"); tprintf("%llu", (sizeof((config).block_size) == sizeof(char) ? (unsigned long long) (unsigned char) ((config).block_size) : sizeof((config).block_size) == sizeof(short) ? (unsigned long long) (unsigned short) ((config).block_size) : sizeof((config).block_size) == sizeof(int) ? (unsigned long long) (unsigned int) ((config).block_size) : sizeof((config).block_size) == sizeof(long) ? (unsigned long long) (unsigned long) ((config).block_size) : (unsigned long long) ((config).block_size))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("info"); (print_loop_info64)((tcp), &((config).info)); } while (0);
 if (!is_filled((const char *) (config.__reserved), 0, sizeof(config.__reserved) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(typeof((config.__reserved)), typeof(&(config.__reserved)[0])))]) * 0))) {
  tprint_struct_next();
  do { tprints_field_name("__reserved"); for (size_t i_ = 0; i_ < (sizeof(((config)).__reserved) / sizeof((((config)).__reserved)[0]) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(typeof((((config)).__reserved)), typeof(&(((config)).__reserved)[0])))]) * 0)); ++i_) { if (i_) tprint_array_next(); else tprint_array_begin(); tprintf("%#llx", (sizeof(((config)).__reserved[i_]) == sizeof(char) ? (unsigned long long) (unsigned char) (((config)).__reserved[i_]) : sizeof(((config)).__reserved[i_]) == sizeof(short) ? (unsigned long long) (unsigned short) (((config)).__reserved[i_]) : sizeof(((config)).__reserved[i_]) == sizeof(int) ? (unsigned long long) (unsigned int) (((config)).__reserved[i_]) : sizeof(((config)).__reserved[i_]) == sizeof(long) ? (unsigned long long) (unsigned long) (((config)).__reserved[i_]) : (unsigned long long) (((config)).__reserved[i_]))); } tprint_array_end(); } while (0);
 }
 tprint_struct_end();
}
MPERS_PRINTER_DECL(int, loop_ioctl, struct tcb *tcp, const unsigned int code, const kernel_ulong_t arg)
{
 ...
 case 0x4C81:
  tprint_arg_next();
  tprintf("%lld", (sizeof((int) arg) == sizeof(char) ? (long long) (char) ((int) arg) : sizeof((int) arg) == sizeof(short) ? (long long) (short) ((int) arg) : sizeof((int) arg) == sizeof(int) ? (long long) (int) ((int) arg) : sizeof((int) arg) == sizeof(long) ? (long long) (long) ((int) arg) : (long long) ((int) arg)));
  break;
 case 0x4C08:
 case 0x4C09:
  tprint_arg_next();
  tprintf("%llu", (sizeof(arg) == sizeof(char) ? (unsigned long long) (unsigned char) (arg) : sizeof(arg) == sizeof(short) ? (unsigned long long) (unsigned short) (arg) : sizeof(arg) == sizeof(int) ? (unsigned long long) (unsigned int) (arg) : sizeof(arg) == sizeof(long) ? (unsigned long long) (unsigned long) (arg) : (unsigned long long) (arg)));
  break;
 default:
  return 0100;
 }
