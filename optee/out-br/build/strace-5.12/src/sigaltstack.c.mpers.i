...
#pragma GCC diagnostic ignored "-Wtautological-compare"
 ;
_Static_assert((SS_ONSTACK) == (1), "SS_ONSTACK != 1");
...
#pragma GCC diagnostic ignored "-Wtautological-compare"
 ;
_Static_assert((SS_DISABLE) == (2), "SS_DISABLE != 2");

#pragma GCC diagnostic pop
;
static const struct xlat_data sigaltstack_flags_xdata[] = {
 { (unsigned)(SS_ONSTACK), "SS_ONSTACK" },
 { (unsigned)(SS_DISABLE), "SS_DISABLE" },
 { (unsigned)((1U << 31)), "SS_AUTODISARM" },
};
static
const struct xlat sigaltstack_flags[1] = { {
 .data = sigaltstack_flags_xdata,
 .size = (sizeof(sigaltstack_flags_xdata) / sizeof((sigaltstack_flags_xdata)[0]) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(typeof((sigaltstack_flags_xdata)), typeof(&(sigaltstack_flags_xdata)[0])))]) * 0)),
 .type = XT_NORMAL,
 .flags_mask = 0
  | ((unsigned) (SS_ONSTACK))
  | ((unsigned) (SS_DISABLE))
...
{
 stack_t ss;
 if (umoven_or_printaddr((tcp), (addr), sizeof(*(&ss)), (void *) (&ss)))
  return;
 tprint_struct_begin();
 do { tprints_field_name("ss_sp"); printaddr((mpers_ptr_t) (ss).ss_sp); } while (0);
 tprint_struct_next();
 do { tprints_field_name("ss_flags"); printflags64((sigaltstack_flags), (sizeof((ss).ss_flags) == sizeof(char) ? (unsigned long long) (unsigned char) ((ss).ss_flags) : sizeof((ss).ss_flags) == sizeof(short) ? (unsigned long long) (unsigned short) ((ss).ss_flags) : sizeof((ss).ss_flags) == sizeof(int) ? (unsigned long long) (unsigned int) ((ss).ss_flags) : sizeof((ss).ss_flags) == sizeof(long) ? (unsigned long long) (unsigned long) ((ss).ss_flags) : (unsigned long long) ((ss).ss_flags)), ("SS_???")); } while (0);
 tprint_struct_next();
 do { tprints_field_name("ss_size"); tprintf("%llu", (sizeof((ss).ss_size) == sizeof(char) ? (unsigned long long) (unsigned char) ((ss).ss_size) : sizeof((ss).ss_size) == sizeof(short) ? (unsigned long long) (unsigned short) ((ss).ss_size) : sizeof((ss).ss_size) == sizeof(int) ? (unsigned long long) (unsigned int) ((ss).ss_size) : sizeof((ss).ss_size) == sizeof(long) ? (unsigned long long) (unsigned long) ((ss).ss_size) : (unsigned long long) ((ss).ss_size))); } while (0);
 tprint_struct_end();
}
int sys_sigaltstack(struct tcb *tcp)
{
 if ((!((tcp)->flags & 0x04))) {
