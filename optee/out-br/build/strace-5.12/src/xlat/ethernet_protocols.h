...
static const struct xlat_data ethernet_protocols_xdata[] = {
 ...
 XLAT(ETH_P_CFM),
 #define XLAT_VAL_79 ((unsigned) (ETH_P_CFM))
 #define XLAT_STR_79 STRINGIFY(ETH_P_CFM)
 XLAT(ETH_P_FCOE),
 #define XLAT_VAL_80 ((unsigned) (ETH_P_FCOE))
 #define XLAT_STR_80 STRINGIFY(ETH_P_FCOE)
 XLAT(ETH_P_TDLS),
 #define XLAT_VAL_81 ((unsigned) (ETH_P_TDLS))
 #define XLAT_STR_81 STRINGIFY(ETH_P_TDLS)
 XLAT(ETH_P_FIP),
 #define XLAT_VAL_82 ((unsigned) (ETH_P_FIP))
 #define XLAT_STR_82 STRINGIFY(ETH_P_FIP)
 XLAT(ETH_P_IBOE),
 #define XLAT_VAL_83 ((unsigned) (ETH_P_IBOE))
 #define XLAT_STR_83 STRINGIFY(ETH_P_IBOE)
 XLAT(ETH_P_80221),
 #define XLAT_VAL_84 ((unsigned) (ETH_P_80221))
 #define XLAT_STR_84 STRINGIFY(ETH_P_80221)
 XLAT(ETH_P_HSR),
 #define XLAT_VAL_85 ((unsigned) (ETH_P_HSR))
 #define XLAT_STR_85 STRINGIFY(ETH_P_HSR)
 XLAT(ETH_P_NSH),
 #define XLAT_VAL_86 ((unsigned) (ETH_P_NSH))
 #define XLAT_STR_86 STRINGIFY(ETH_P_NSH)
 XLAT(ETH_P_LOOPBACK),
 #define XLAT_VAL_87 ((unsigned) (ETH_P_LOOPBACK))
 #define XLAT_STR_87 STRINGIFY(ETH_P_LOOPBACK)
 XLAT(ETH_P_QINQ1),
 #define XLAT_VAL_88 ((unsigned) (ETH_P_QINQ1))
 #define XLAT_STR_88 STRINGIFY(ETH_P_QINQ1)
 XLAT(ETH_P_QINQ2),
 #define XLAT_VAL_89 ((unsigned) (ETH_P_QINQ2))
 #define XLAT_STR_89 STRINGIFY(ETH_P_QINQ2)
 XLAT(ETH_P_QINQ3),
 #define XLAT_VAL_90 ((unsigned) (ETH_P_QINQ3))
 #define XLAT_STR_90 STRINGIFY(ETH_P_QINQ3)
 XLAT(ETH_P_EDSA),
 #define XLAT_VAL_91 ((unsigned) (ETH_P_EDSA))
 #define XLAT_STR_91 STRINGIFY(ETH_P_EDSA)
 XLAT(ETH_P_DSA_8021Q),
 #define XLAT_VAL_92 ((unsigned) (ETH_P_DSA_8021Q))
 #define XLAT_STR_92 STRINGIFY(ETH_P_DSA_8021Q)
 XLAT(ETH_P_IFE),
 #define XLAT_VAL_93 ((unsigned) (ETH_P_IFE))
 #define XLAT_STR_93 STRINGIFY(ETH_P_IFE)
 XLAT(ETH_P_AF_IUCV),
 #define XLAT_VAL_94 ((unsigned) (ETH_P_AF_IUCV))
 #define XLAT_STR_94 STRINGIFY(ETH_P_AF_IUCV)
};
