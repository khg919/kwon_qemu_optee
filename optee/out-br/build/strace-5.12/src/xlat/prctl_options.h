...
#endif
#if defined(PR_SET_SYSCALL_USER_DISPATCH) || (defined(HAVE_DECL_PR_SET_SYSCALL_USER_DISPATCH) && HAVE_DECL_PR_SET_SYSCALL_USER_DISPATCH)
DIAG_PUSH_IGNORE_TAUTOLOGICAL_COMPARE
static_assert((PR_SET_SYSCALL_USER_DISPATCH) == (59), "PR_SET_SYSCALL_USER_DISPATCH != 59");
DIAG_POP_IGNORE_TAUTOLOGICAL_COMPARE
#else
...
static const struct xlat_data prctl_options_xdata[] = {
 ...
 XLAT(PR_SET_VMA),
 #define XLAT_VAL_55 ((unsigned) (PR_SET_VMA))
 #define XLAT_STR_55 STRINGIFY(PR_SET_VMA)
 XLAT(PR_SET_PTRACER),
 #define XLAT_VAL_56 ((unsigned) (PR_SET_PTRACER))
 #define XLAT_STR_56 STRINGIFY(PR_SET_PTRACER)
};
static
