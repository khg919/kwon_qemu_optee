...
const struct xlat v4l2_meta_fmts[1] = { {
 ...
 .size = (sizeof(v4l2_meta_fmts_xdata) / sizeof((v4l2_meta_fmts_xdata)[0]) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(typeof((v4l2_meta_fmts_xdata)), typeof(&(v4l2_meta_fmts_xdata)[0])))]) * 0)),
 .type = XT_SORTED,
 .flags_mask = 0
...
static const struct xlat_data v4l2_pix_fmts_xdata[] = {
 ...
 { (unsigned)(((__u32)('H') | ((__u32)('M') << 8) | ((__u32)('1') << 16) | ((__u32)('2') << 24))), "V4L2_PIX_FMT_HM12" },
 ...
 { (unsigned)(((__u32)('S') | ((__u32)('T') << 8) | ((__u32)('1') << 16) | ((__u32)('2') << 24))), "V4L2_PIX_FMT_SUNXI_TILED_NV12" },
...
const struct xlat v4l2_pix_fmts[1] = { {
 ...
 .size = (sizeof(v4l2_pix_fmts_xdata) / sizeof((v4l2_pix_fmts_xdata)[0]) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(typeof((v4l2_pix_fmts_xdata)), typeof(&(v4l2_pix_fmts_xdata)[0])))]) * 0)),
 .type = XT_SORTED,
 .flags_mask = 0
 ...
 .flags_strsz = 0
  ...
  + sizeof("V4L2_PIX_FMT_SUNXI_TILED_NV12")
...
const struct xlat v4l2_sdr_fmts[1] = { {
 ...
 .size = (sizeof(v4l2_sdr_fmts_xdata) / sizeof((v4l2_sdr_fmts_xdata)[0]) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(typeof((v4l2_sdr_fmts_xdata)), typeof(&(v4l2_sdr_fmts_xdata)[0])))]) * 0)),
 .type = XT_SORTED,
 .flags_mask = 0
...
print_pixelformat(uint32_t fourcc, const struct xlat *xlat)
{
 ...
 unsigned int i;
 tprints("v4l2_fourcc(");
 for (i = 0; i < (sizeof(a) / sizeof((a)[0]) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(typeof((a)), typeof(&(a)[0])))]) * 0)); ++i) {
  unsigned char c = a[i];
  if (i)
   tprints(", ");
  if (c == '\'' || c == '\\') {
   ...
   char hex[] = {
    '\'', '\\', 'x', hex_chars[((uint8_t) (c)) >> 4], hex_chars[((uint8_t) (c)) & 0xf], '\'',
    '\0'
   };
   tprints(hex);
  }
...
const struct xlat v4l2_device_capabilities_flags[1] = { {
 ...
 .size = (sizeof(v4l2_device_capabilities_flags_xdata) / sizeof((v4l2_device_capabilities_flags_xdata)[0]) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(typeof((v4l2_device_capabilities_flags_xdata)), typeof(&(v4l2_device_capabilities_flags_xdata)[0])))]) * 0)),
 .type = XT_NORMAL,
 .flags_mask = 0
  | ((unsigned) (0x00000001))
  | ((unsigned) (0x00000002))
...
print_v4l2_capability(struct tcb *const tcp, const kernel_ulong_t arg)
{
 ...
 if (umoven_or_printaddr((tcp), (arg), sizeof(*(&caps)), (void *) (&caps)))
  return 0200;
 tprint_struct_begin();
 do { tprints_field_name("driver"); print_quoted_cstring((const char *) (caps).driver, sizeof((caps).driver) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(typeof(((caps).driver)), typeof(&((caps).driver)[0])))]) * 0)); } while (0);
 tprint_struct_next();
 do { tprints_field_name("card"); print_quoted_cstring((const char *) (caps).card, sizeof((caps).card) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(typeof(((caps).card)), typeof(&((caps).card)[0])))]) * 0)); } while (0);
 tprint_struct_next();
 do { tprints_field_name("bus_info"); print_quoted_cstring((const char *) (caps).bus_info, sizeof((caps).bus_info) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(typeof(((caps).bus_info)), typeof(&((caps).bus_info)[0])))]) * 0)); } while (0);
 tprint_struct_next();
...
const struct xlat v4l2_buf_types[1] = { {
 ...
 .size = (sizeof(v4l2_buf_types_xdata) / sizeof((v4l2_buf_types_xdata)[0]) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(typeof((v4l2_buf_types_xdata)), typeof(&(v4l2_buf_types_xdata)[0])))]) * 0)),
 .type = XT_INDEXED,
 .flags_mask = 0
...
const struct xlat v4l2_format_description_flags[1] = { {
 ...
 .size = (sizeof(v4l2_format_description_flags_xdata) / sizeof((v4l2_format_description_flags_xdata)[0]) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(typeof((v4l2_format_description_flags_xdata)), typeof(&(v4l2_format_description_flags_xdata)[0])))]) * 0)),
 .type = XT_NORMAL,
 .flags_mask = 0
  | ((unsigned) (0x0001))
  | ((unsigned) (0x0002))
...
print_v4l2_fmtdesc(struct tcb *const tcp, const kernel_ulong_t arg)
{
 ...
 if (!((tcp)->u_error != 0) && !umoven((tcp), (arg), sizeof(*(&f)), (void *) (&f))) {
  ...
  tprint_struct_next();
  do { tprints_field_name("description"); print_quoted_cstring((const char *) (f).description, sizeof((f).description) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(typeof(((f).description)), typeof(&((f).description)[0])))]) * 0)); } while (0);
  tprint_struct_next();
...
const struct xlat v4l2_fields[1] = { {
 ...
 .size = (sizeof(v4l2_fields_xdata) / sizeof((v4l2_fields_xdata)[0]) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(typeof((v4l2_fields_xdata)), typeof(&(v4l2_fields_xdata)[0])))]) * 0)),
 .type = XT_INDEXED,
 .flags_mask = 0
...
const struct xlat v4l2_colorspaces[1] = { {
 ...
 .size = (sizeof(v4l2_colorspaces_xdata) / sizeof((v4l2_colorspaces_xdata)[0]) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(typeof((v4l2_colorspaces_xdata)), typeof(&(v4l2_colorspaces_xdata)[0])))]) * 0)),
 .type = XT_INDEXED,
 .flags_mask = 0
...
const struct xlat v4l2_vbi_flags[1] = { {
 ...
 .size = (sizeof(v4l2_vbi_flags_xdata) / sizeof((v4l2_vbi_flags_xdata)[0]) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(typeof((v4l2_vbi_flags_xdata)), typeof(&(v4l2_vbi_flags_xdata)[0])))]) * 0)),
 .type = XT_NORMAL,
 .flags_mask = 0
  | ((unsigned) ((1 << 0)))
  | ((unsigned) ((1 << 1)))
...
const struct xlat v4l2_sliced_flags[1] = { {
 ...
 .size = (sizeof(v4l2_sliced_flags_xdata) / sizeof((v4l2_sliced_flags_xdata)[0]) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(typeof((v4l2_sliced_flags_xdata)), typeof(&(v4l2_sliced_flags_xdata)[0])))]) * 0)),
 .type = XT_NORMAL,
 .flags_mask = 0
...
print_v4l2_format_fmt_pix_mp(struct tcb *const tcp, const typeof(((struct_v4l2_format *)0)->fmt.pix_mp) *const p)
{
 ...
 do { tprints_field_name("colorspace"); printxval64((v4l2_colorspaces), (sizeof((*p).colorspace) == sizeof(char) ? (unsigned long long) (unsigned char) ((*p).colorspace) : sizeof((*p).colorspace) == sizeof(short) ? (unsigned long long) (unsigned short) ((*p).colorspace) : sizeof((*p).colorspace) == sizeof(int) ? (unsigned long long) (unsigned int) ((*p).colorspace) : sizeof((*p).colorspace) == sizeof(long) ? (unsigned long long) (unsigned long) ((*p).colorspace) : (unsigned long long) ((*p).colorspace)), ("V4L2_COLORSPACE_???")); } while (0);
 tprint_struct_next();
 do { tprints_field_name("plane_fmt"); print_local_array_ex(((tcp)), ((*p).plane_fmt), ((((((((p->num_planes))) > (0)) ? (((p->num_planes))) : (0))) < ((typeof((p->num_planes))) (sizeof((*p).plane_fmt) / sizeof(((*p).plane_fmt)[0]) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(typeof(((*p).plane_fmt)), typeof(&((*p).plane_fmt)[0])))]) * 0)))) ? ((((((p->num_planes))) > (0)) ? (((p->num_planes))) : (0))) : ((typeof((p->num_planes))) (sizeof((*p).plane_fmt) / sizeof(((*p).plane_fmt)[0]) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(typeof(((*p).plane_fmt)), typeof(&((*p).plane_fmt)[0])))]) * 0)))), sizeof(((*p).plane_fmt)[0]), ((print_v4l2_plane_pix_format_array_member)), ((void *)0), 0, ((void *)0), ((void *)0)); } while (0);
 tprint_struct_next();
...
print_v4l2_format_fmt_vbi(struct tcb *const tcp, const typeof(((struct_v4l2_format *)0)->fmt.vbi) *const p)
{
 ...
 tprint_struct_next();
 do { tprints_field_name("start"); for (size_t i_ = 0; i_ < (sizeof(((*p)).start) / sizeof((((*p)).start)[0]) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(typeof((((*p)).start)), typeof(&(((*p)).start)[0])))]) * 0)); ++i_) { if (i_) tprint_array_next(); else tprint_array_begin(); tprintf("%lld", (sizeof(((*p)).start[i_]) == sizeof(char) ? (long long) (char) (((*p)).start[i_]) : sizeof(((*p)).start[i_]) == sizeof(short) ? (long long) (short) (((*p)).start[i_]) : sizeof(((*p)).start[i_]) == sizeof(int) ? (long long) (int) (((*p)).start[i_]) : sizeof(((*p)).start[i_]) == sizeof(long) ? (long long) (long) (((*p)).start[i_]) : (long long) (((*p)).start[i_]))); } tprint_array_end(); } while (0);
 tprint_struct_next();
 do { tprints_field_name("count"); for (size_t i_ = 0; i_ < (sizeof(((*p)).count) / sizeof((((*p)).count)[0]) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(typeof((((*p)).count)), typeof(&(((*p)).count)[0])))]) * 0)); ++i_) { if (i_) tprint_array_next(); else tprint_array_begin(); tprintf("%llu", (sizeof(((*p)).count[i_]) == sizeof(char) ? (unsigned long long) (unsigned char) (((*p)).count[i_]) : sizeof(((*p)).count[i_]) == sizeof(short) ? (unsigned long long) (unsigned short) (((*p)).count[i_]) : sizeof(((*p)).count[i_]) == sizeof(int) ? (unsigned long long) (unsigned int) (((*p)).count[i_]) : sizeof(((*p)).count[i_]) == sizeof(long) ? (unsigned long long) (unsigned long) (((*p)).count[i_]) : (unsigned long long) (((*p)).count[i_]))); } tprint_array_end(); } while (0);
 tprint_struct_next();
...
print_v4l2_format_fmt_sliced(struct tcb *const tcp, const typeof(((struct_v4l2_format *)0)->fmt.sliced) *const p)
{
 ...
 tprint_struct_next();
 do { tprints_field_name("service_lines"); for (size_t i_ = 0; i_ < (sizeof(((*p)).service_lines) / sizeof((((*p)).service_lines)[0]) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(typeof((((*p)).service_lines)), typeof(&(((*p)).service_lines)[0])))]) * 0)); ++i_) { if (i_) tprint_array_next(); else tprint_array_begin(); for (size_t j_ = 0; j_ < (sizeof(((*p)).service_lines[i_]) / sizeof((((*p)).service_lines[i_])[0]) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(typeof((((*p)).service_lines[i_])), typeof(&(((*p)).service_lines[i_])[0])))]) * 0)); ++j_) { if (j_) tprint_array_next(); else tprint_array_begin(); tprintf("%#llx", (sizeof(((*p)).service_lines[i_][j_]) == sizeof(char) ? (unsigned long long) (unsigned char) (((*p)).service_lines[i_][j_]) : sizeof(((*p)).service_lines[i_][j_]) == sizeof(short) ? (unsigned long long) (unsigned short) (((*p)).service_lines[i_][j_]) : sizeof(((*p)).service_lines[i_][j_]) == sizeof(int) ? (unsigned long long) (unsigned int) (((*p)).service_lines[i_][j_]) : sizeof(((*p)).service_lines[i_][j_]) == sizeof(long) ? (unsigned long long) (unsigned long) (((*p)).service_lines[i_][j_]) : (unsigned long long) (((*p)).service_lines[i_][j_]))); } tprint_array_end(); } tprint_array_end(); } while (0);
 tprint_struct_next();
...
const struct xlat v4l2_memories[1] = { {
 ...
 .size = (sizeof(v4l2_memories_xdata) / sizeof((v4l2_memories_xdata)[0]) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(typeof((v4l2_memories_xdata)), typeof(&(v4l2_memories_xdata)[0])))]) * 0)),
 .type = XT_INDEXED,
 .flags_mask = 0
...
const struct xlat v4l2_buf_flags[1] = { {
 ...
 .size = (sizeof(v4l2_buf_flags_xdata) / sizeof((v4l2_buf_flags_xdata)[0]) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(typeof((v4l2_buf_flags_xdata)), typeof(&(v4l2_buf_flags_xdata)[0])))]) * 0)),
 .type = XT_NORMAL,
 .flags_mask = 0
  | ((unsigned) (0x00000001))
  | ((unsigned) (0x00000002))
...
const struct xlat v4l2_buf_flags_ts_type[1] = { {
 ...
 .size = (sizeof(v4l2_buf_flags_ts_type_xdata) / sizeof((v4l2_buf_flags_ts_type_xdata)[0]) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(typeof((v4l2_buf_flags_ts_type_xdata)), typeof(&(v4l2_buf_flags_ts_type_xdata)[0])))]) * 0)),
 .type = XT_NORMAL,
 .flags_mask = 0
  | ((unsigned) (0x00000000))
  | ((unsigned) (0x00002000))
...
const struct xlat v4l2_buf_flags_ts_src[1] = { {
 ...
 .size = (sizeof(v4l2_buf_flags_ts_src_xdata) / sizeof((v4l2_buf_flags_ts_src_xdata)[0]) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(typeof((v4l2_buf_flags_ts_src_xdata)), typeof(&(v4l2_buf_flags_ts_src_xdata)[0])))]) * 0)),
 .type = XT_NORMAL,
 .flags_mask = 0
  | ((unsigned) (0x00000000))
  | ((unsigned) (0x00010000))
...
const struct xlat v4l2_streaming_capabilities[1] = { {
 ...
 .size = (sizeof(v4l2_streaming_capabilities_xdata) / sizeof((v4l2_streaming_capabilities_xdata)[0]) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(typeof((v4l2_streaming_capabilities_xdata)), typeof(&(v4l2_streaming_capabilities_xdata)[0])))]) * 0)),
 .type = XT_NORMAL,
 .flags_mask = 0
  | ((unsigned) (0x1000))
  ,
...
const struct xlat v4l2_capture_modes[1] = { {
 ...
 .size = (sizeof(v4l2_capture_modes_xdata) / sizeof((v4l2_capture_modes_xdata)[0]) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(typeof((v4l2_capture_modes_xdata)), typeof(&(v4l2_capture_modes_xdata)[0])))]) * 0)),
 .type = XT_NORMAL,
 .flags_mask = 0
  | ((unsigned) (0x0001))
  ,
...
print_v4l2_standard(struct tcb *const tcp, const kernel_ulong_t arg)
{
 ...
 if (!((tcp)->u_error != 0) && !umoven((tcp), (arg), sizeof(*(&s)), (void *) (&s))) {
  tprint_struct_next();
  do { tprints_field_name("name"); print_quoted_cstring((const char *) (s).name, sizeof((s).name) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(typeof(((s).name)), typeof(&((s).name)[0])))]) * 0)); } while (0);
  tprint_struct_next();
...
const struct xlat v4l2_input_types[1] = { {
 ...
 .size = (sizeof(v4l2_input_types_xdata) / sizeof((v4l2_input_types_xdata)[0]) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(typeof((v4l2_input_types_xdata)), typeof(&(v4l2_input_types_xdata)[0])))]) * 0)),
 .type = XT_INDEXED,
 .flags_mask = 0
  | ((unsigned) (1))
  | ((unsigned) (2))
...
print_v4l2_input(struct tcb *const tcp, const kernel_ulong_t arg)
{
 ...
 if (!((tcp)->u_error != 0) && !umoven((tcp), (arg), sizeof(*(&i)), (void *) (&i))) {
  tprint_struct_next();
  do { tprints_field_name("name"); print_quoted_cstring((const char *) (i).name, sizeof((i).name) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(typeof(((i).name)), typeof(&((i).name)[0])))]) * 0)); } while (0);
  tprint_struct_next();
...
const struct xlat v4l2_control_classes[1] = { {
 ...
 .size = (sizeof(v4l2_control_classes_xdata) / sizeof((v4l2_control_classes_xdata)[0]) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(typeof((v4l2_control_classes_xdata)), typeof(&(v4l2_control_classes_xdata)[0])))]) * 0)),
 .type = XT_SORTED,
 .flags_mask = 0
  | ((unsigned) (0x00980000))
  | ((unsigned) (0x00990000))
...
const struct xlat v4l2_control_id_bases[1] = { {
 ...
 .size = (sizeof(v4l2_control_id_bases_xdata) / sizeof((v4l2_control_id_bases_xdata)[0]) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(typeof((v4l2_control_id_bases_xdata)), typeof(&(v4l2_control_id_bases_xdata)[0])))]) * 0)),
 .type = XT_NORMAL,
 .flags_mask = 0
...
const struct xlat v4l2_control_ids[1] = { {
 ...
 .size = (sizeof(v4l2_control_ids_xdata) / sizeof((v4l2_control_ids_xdata)[0]) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(typeof((v4l2_control_ids_xdata)), typeof(&(v4l2_control_ids_xdata)[0])))]) * 0)),
 .type = XT_NORMAL,
 .flags_mask = 0
...
const struct xlat v4l2_control_query_flags[1] = { {
 ...
 .size = (sizeof(v4l2_control_query_flags_xdata) / sizeof((v4l2_control_query_flags_xdata)[0]) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(typeof((v4l2_control_query_flags_xdata)), typeof(&(v4l2_control_query_flags_xdata)[0])))]) * 0)),
 .type = XT_NORMAL,
 .flags_mask = 0
  | ((unsigned) (0x80000000))
  | ((unsigned) (0x40000000))
...
print_v4l2_cid(uint32_t cid, _Bool next_flags)
{
 ...
 xsnprintf_(((tmp_str)), (sizeof(tmp_str) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(typeof((tmp_str)), typeof(&(tmp_str)[0])))]) * 0)), __func__, "(\"%s+%#\" \"ll\" \"x\")" ", " "class_str, cid - class_id", (("%s+%#" "ll" "x")), class_str, cid - class_id);
...
const struct xlat v4l2_tuner_types[1] = { {
 ...
 .size = (sizeof(v4l2_tuner_types_xdata) / sizeof((v4l2_tuner_types_xdata)[0]) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(typeof((v4l2_tuner_types_xdata)), typeof(&(v4l2_tuner_types_xdata)[0])))]) * 0)),
 .type = XT_INDEXED,
 .flags_mask = 0
...
const struct xlat v4l2_tuner_capabilities[1] = { {
 ...
 .size = (sizeof(v4l2_tuner_capabilities_xdata) / sizeof((v4l2_tuner_capabilities_xdata)[0]) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(typeof((v4l2_tuner_capabilities_xdata)), typeof(&(v4l2_tuner_capabilities_xdata)[0])))]) * 0)),
 .type = XT_NORMAL,
 .flags_mask = 0
  | ((unsigned) (0x0001))
  | ((unsigned) (0x0002))
...
const struct xlat v4l2_tuner_rxsubchanses[1] = { {
 ...
 .size = (sizeof(v4l2_tuner_rxsubchanses_xdata) / sizeof((v4l2_tuner_rxsubchanses_xdata)[0]) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(typeof((v4l2_tuner_rxsubchanses_xdata)), typeof(&(v4l2_tuner_rxsubchanses_xdata)[0])))]) * 0)),
 .type = XT_NORMAL,
 .flags_mask = 0
  | ((unsigned) (0x0001))
  | ((unsigned) (0x0002))
...
const struct xlat v4l2_tuner_audmodes[1] = { {
 ...
 .size = (sizeof(v4l2_tuner_audmodes_xdata) / sizeof((v4l2_tuner_audmodes_xdata)[0]) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(typeof((v4l2_tuner_audmodes_xdata)), typeof(&(v4l2_tuner_audmodes_xdata)[0])))]) * 0)),
 .type = XT_INDEXED,
 .flags_mask = 0
  | ((unsigned) (0x0000))
  | ((unsigned) (0x0001))
   ...
   const _Bool is_get)
{
 ...
 do { tprints_field_name("name"); print_quoted_cstring((const char *) (c).name, sizeof((c).name) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(typeof(((c).name)), typeof(&((c).name)[0])))]) * 0)); } while (0);
 tprint_struct_next();
...
const struct xlat v4l2_control_types[1] = { {
 ...
 .size = (sizeof(v4l2_control_types_xdata) / sizeof((v4l2_control_types_xdata)[0]) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(typeof((v4l2_control_types_xdata)), typeof(&(v4l2_control_types_xdata)[0])))]) * 0)),
 .type = XT_SORTED,
 .flags_mask = 0
...
const struct xlat v4l2_control_flags[1] = { {
 ...
 .size = (sizeof(v4l2_control_flags_xdata) / sizeof((v4l2_control_flags_xdata)[0]) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(typeof((v4l2_control_flags_xdata)), typeof(&(v4l2_control_flags_xdata)[0])))]) * 0)),
 .type = XT_NORMAL,
 .flags_mask = 0
  | ((unsigned) (0x0001))
  | ((unsigned) (0x0002))
...
print_v4l2_queryctrl(struct tcb *const tcp, const kernel_ulong_t arg)
{
 ...
 if (!((tcp)->qual_flg & 0x002)) {
  ...
  if (!is_filled((const char *) (c.reserved), 0, sizeof(c.reserved) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(typeof((c.reserved)), typeof(&(c.reserved)[0])))]) * 0))) {
   tprint_struct_next();
   do { tprints_field_name("reserved"); print_local_array_ex(((tcp)), ((c).reserved), (sizeof((c).reserved) / sizeof(((c).reserved)[0]) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(typeof(((c).reserved)), typeof(&((c).reserved)[0])))]) * 0)), sizeof(((c).reserved)[0]), ((print_xint32_array_member)), ((void *)0), 0, ((void *)0), ((void *)0)); } while (0);
  }
 } else {
  tprint_struct_next();
  tprint_more_data_follows();
...
print_v4l2_query_ext_ctrl(struct tcb *const tcp, const kernel_ulong_t arg)
{
 ...
 if (!((tcp)->qual_flg & 0x002)) {
  ...
  tprint_struct_next();
  do { tprints_field_name("dims"); print_local_array_ex(((tcp)), ((c).dims), ((((((((c.nr_of_dims))) > (0)) ? (((c.nr_of_dims))) : (0))) < ((typeof((c.nr_of_dims))) (sizeof((c).dims) / sizeof(((c).dims)[0]) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(typeof(((c).dims)), typeof(&((c).dims)[0])))]) * 0)))) ? ((((((c.nr_of_dims))) > (0)) ? (((c.nr_of_dims))) : (0))) : ((typeof((c.nr_of_dims))) (sizeof((c).dims) / sizeof(((c).dims)[0]) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(typeof(((c).dims)), typeof(&((c).dims)[0])))]) * 0)))), sizeof(((c).dims)[0]), ((print_uint32_array_member)), ((void *)0), 0, ((void *)0), ((void *)0)); } while (0);
  if (!is_filled((const char *) (c.reserved), 0, sizeof(c.reserved) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(typeof((c.reserved)), typeof(&(c.reserved)[0])))]) * 0))) {
   tprint_struct_next();
   do { tprints_field_name("reserved"); print_local_array_ex(((tcp)), ((c).reserved), (sizeof((c).reserved) / sizeof(((c).reserved)[0]) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(typeof(((c).reserved)), typeof(&((c).reserved)[0])))]) * 0)), sizeof(((c).reserved)[0]), ((print_xint32_array_member)), ((void *)0), 0, ((void *)0), ((void *)0)); } while (0);
  }
...
const struct xlat v4l2_framesize_types[1] = { {
 ...
 .size = (sizeof(v4l2_framesize_types_xdata) / sizeof((v4l2_framesize_types_xdata)[0]) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(typeof((v4l2_framesize_types_xdata)), typeof(&(v4l2_framesize_types_xdata)[0])))]) * 0)),
 .type = XT_INDEXED,
 .flags_mask = 0
...
const struct xlat v4l2_frameinterval_types[1] = { {
 ...
 .size = (sizeof(v4l2_frameinterval_types_xdata) / sizeof((v4l2_frameinterval_types_xdata)[0]) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(typeof((v4l2_frameinterval_types_xdata)), typeof(&(v4l2_frameinterval_types_xdata)[0])))]) * 0)),
 .type = XT_INDEXED,
 .flags_mask = 0
...
print_v4l2_create_buffers(struct tcb *const tcp, const kernel_ulong_t arg)
{
 ...
 if (((tcp)->u_error != 0) || umoven((tcp), (arg), sizeof(*(&b)), (void *) (&b)))
  return 0200;
 xsnprintf_(((outstr)), (sizeof(outstr) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(typeof((outstr)), typeof(&(outstr)[0])))]) * 0)), __func__, "(fmt)" ", " "b.index, b.count", ((fmt)), b.index, b.count);
 tcp->auxstr = outstr;
 return 0200 | 020;
}
