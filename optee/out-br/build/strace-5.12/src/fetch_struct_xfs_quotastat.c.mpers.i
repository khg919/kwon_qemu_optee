...
MPERS_PRINTER_DECL(_Bool, fetch_struct_quotastat, struct tcb *const tcp, const kernel_ulong_t data, void *p)
{
 struct fs_quota_stat *dq = p;
 fs_quota_stat_t dqstat;
 if (umoven_or_printaddr((tcp), (data), sizeof(*(&dqstat)), (void *) (&dqstat)))
  return 0;
