...
#pragma GCC diagnostic ignored "-Wtautological-compare"
 ;
_Static_assert((IFF_UP) == ((1 << 0)), "IFF_UP != (1 << 0)");
...
#pragma GCC diagnostic ignored "-Wtautological-compare"
 ;
_Static_assert((IFF_BROADCAST) == ((1 << 1)), "IFF_BROADCAST != (1 << 1)");
...
#pragma GCC diagnostic ignored "-Wtautological-compare"
 ;
_Static_assert((IFF_DEBUG) == ((1 << 2)), "IFF_DEBUG != (1 << 2)");
...
#pragma GCC diagnostic ignored "-Wtautological-compare"
 ;
_Static_assert((IFF_LOOPBACK) == ((1 << 3)), "IFF_LOOPBACK != (1 << 3)");
...
#pragma GCC diagnostic ignored "-Wtautological-compare"
 ;
_Static_assert((IFF_POINTOPOINT) == ((1 << 4)), "IFF_POINTOPOINT != (1 << 4)");
...
#pragma GCC diagnostic ignored "-Wtautological-compare"
 ;
_Static_assert((IFF_NOTRAILERS) == ((1 << 5)), "IFF_NOTRAILERS != (1 << 5)");
...
#pragma GCC diagnostic ignored "-Wtautological-compare"
 ;
_Static_assert((IFF_RUNNING) == ((1 << 6)), "IFF_RUNNING != (1 << 6)");
...
#pragma GCC diagnostic ignored "-Wtautological-compare"
 ;
_Static_assert((IFF_NOARP) == ((1 << 7)), "IFF_NOARP != (1 << 7)");
...
#pragma GCC diagnostic ignored "-Wtautological-compare"
 ;
_Static_assert((IFF_PROMISC) == ((1 << 8)), "IFF_PROMISC != (1 << 8)");
...
#pragma GCC diagnostic ignored "-Wtautological-compare"
 ;
_Static_assert((IFF_ALLMULTI) == ((1 << 9)), "IFF_ALLMULTI != (1 << 9)");
...
#pragma GCC diagnostic ignored "-Wtautological-compare"
 ;
_Static_assert((IFF_MASTER) == ((1 << 10)), "IFF_MASTER != (1 << 10)");
...
#pragma GCC diagnostic ignored "-Wtautological-compare"
 ;
_Static_assert((IFF_SLAVE) == ((1 << 11)), "IFF_SLAVE != (1 << 11)");
...
#pragma GCC diagnostic ignored "-Wtautological-compare"
 ;
_Static_assert((IFF_MULTICAST) == ((1 << 12)), "IFF_MULTICAST != (1 << 12)");
...
#pragma GCC diagnostic ignored "-Wtautological-compare"
 ;
_Static_assert((IFF_PORTSEL) == ((1 << 13)), "IFF_PORTSEL != (1 << 13)");
...
#pragma GCC diagnostic ignored "-Wtautological-compare"
 ;
_Static_assert((IFF_AUTOMEDIA) == ((1 << 14)), "IFF_AUTOMEDIA != (1 << 14)");
...
#pragma GCC diagnostic ignored "-Wtautological-compare"
 ;
_Static_assert((IFF_DYNAMIC) == ((1 << 15)), "IFF_DYNAMIC != (1 << 15)");

#pragma GCC diagnostic pop
;
static const struct xlat_data iffflags_xdata[] = {
 { (unsigned)(IFF_UP), "IFF_UP" },
 { (unsigned)(IFF_BROADCAST), "IFF_BROADCAST" },
 { (unsigned)(IFF_DEBUG), "IFF_DEBUG" },
 { (unsigned)(IFF_LOOPBACK), "IFF_LOOPBACK" },
 { (unsigned)(IFF_POINTOPOINT), "IFF_POINTOPOINT" },
 { (unsigned)(IFF_NOTRAILERS), "IFF_NOTRAILERS" },
 { (unsigned)(IFF_RUNNING), "IFF_RUNNING" },
 { (unsigned)(IFF_NOARP), "IFF_NOARP" },
 { (unsigned)(IFF_PROMISC), "IFF_PROMISC" },
 { (unsigned)(IFF_ALLMULTI), "IFF_ALLMULTI" },
 { (unsigned)(IFF_MASTER), "IFF_MASTER" },
 { (unsigned)(IFF_SLAVE), "IFF_SLAVE" },
 { (unsigned)(IFF_MULTICAST), "IFF_MULTICAST" },
 { (unsigned)(IFF_PORTSEL), "IFF_PORTSEL" },
 { (unsigned)(IFF_AUTOMEDIA), "IFF_AUTOMEDIA" },
 { (unsigned)(IFF_DYNAMIC), "IFF_DYNAMIC" },
 { (unsigned)((1 << 16)), "IFF_LOWER_UP" },
 { (unsigned)((1 << 17)), "IFF_DORMANT" },
 { (unsigned)((1 << 18)), "IFF_ECHO" },
};
const struct xlat iffflags[1] = { {
 .data = iffflags_xdata,
 .size = (sizeof(iffflags_xdata) / sizeof((iffflags_xdata)[0]) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(typeof((iffflags_xdata)), typeof(&(iffflags_xdata)[0])))]) * 0)),
 .type = XT_SORTED,
 .flags_mask = 0
  | ((unsigned) (IFF_UP))
  | ((unsigned) (IFF_BROADCAST))
  | ((unsigned) (IFF_DEBUG))
  | ((unsigned) (IFF_LOOPBACK))
  | ((unsigned) (IFF_POINTOPOINT))
  | ((unsigned) (IFF_NOTRAILERS))
  | ((unsigned) (IFF_RUNNING))
  | ((unsigned) (IFF_NOARP))
  | ((unsigned) (IFF_PROMISC))
  | ((unsigned) (IFF_ALLMULTI))
  | ((unsigned) (IFF_MASTER))
  | ((unsigned) (IFF_SLAVE))
  | ((unsigned) (IFF_MULTICAST))
  | ((unsigned) (IFF_PORTSEL))
  | ((unsigned) (IFF_AUTOMEDIA))
  | ((unsigned) (IFF_DYNAMIC))
  | ((unsigned) ((1 << 16)))
  | ((unsigned) ((1 << 17)))
  | ((unsigned) ((1 << 18)))
  ,
 .flags_strsz = 0
  + sizeof("IFF_UP")
  + sizeof("IFF_BROADCAST")
  + sizeof("IFF_DEBUG")
  + sizeof("IFF_LOOPBACK")
  + sizeof("IFF_POINTOPOINT")
  + sizeof("IFF_NOTRAILERS")
  + sizeof("IFF_RUNNING")
  + sizeof("IFF_NOARP")
  + sizeof("IFF_PROMISC")
  + sizeof("IFF_ALLMULTI")
  + sizeof("IFF_MASTER")
  + sizeof("IFF_SLAVE")
  + sizeof("IFF_MULTICAST")
  + sizeof("IFF_PORTSEL")
  + sizeof("IFF_AUTOMEDIA")
  + sizeof("IFF_DYNAMIC")
  + sizeof("IFF_LOWER_UP")
  + sizeof("IFF_DORMANT")
  + sizeof("IFF_ECHO")
...
static void
print_ifr_hwaddr(const typeof(((struct_ifreq *)0)->ifr_ifru.ifru_hwaddr) *const p)
{
 tprint_struct_begin();
 do { tprints_field_name("sa_family"); printxval64((arp_hardware_types), (sizeof((*p).sa_family) == sizeof(char) ? (unsigned long long) (unsigned char) ((*p).sa_family) : sizeof((*p).sa_family) == sizeof(short) ? (unsigned long long) (unsigned short) ((*p).sa_family) : sizeof((*p).sa_family) == sizeof(int) ? (unsigned long long) (unsigned int) ((*p).sa_family) : sizeof((*p).sa_family) == sizeof(long) ? (unsigned long long) (unsigned long) ((*p).sa_family) : (unsigned long long) ((*p).sa_family)), ("ARPHRD_???")); } while (0);
 tprint_struct_next();
 do { _Static_assert(sizeof(((*p).sa_data)[0]) == 1, "hwaddress is not a byte array"); tprints_field_name("sa_data"); print_hwaddr("", (const uint8_t *) ((*p).sa_data), (sizeof(p->sa_data)), (p->sa_family)); } while (0);
 tprint_struct_end();
}
static void
print_ifr_map(const typeof(((struct_ifreq *)0)->ifr_ifru.ifru_map) *const p)
{
 tprint_struct_begin();
 do { tprints_field_name("mem_start"); tprintf("%#llx", (sizeof((*p).mem_start) == sizeof(char) ? (unsigned long long) (unsigned char) ((*p).mem_start) : sizeof((*p).mem_start) == sizeof(short) ? (unsigned long long) (unsigned short) ((*p).mem_start) : sizeof((*p).mem_start) == sizeof(int) ? (unsigned long long) (unsigned int) ((*p).mem_start) : sizeof((*p).mem_start) == sizeof(long) ? (unsigned long long) (unsigned long) ((*p).mem_start) : (unsigned long long) ((*p).mem_start))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("mem_end"); tprintf("%#llx", (sizeof((*p).mem_end) == sizeof(char) ? (unsigned long long) (unsigned char) ((*p).mem_end) : sizeof((*p).mem_end) == sizeof(short) ? (unsigned long long) (unsigned short) ((*p).mem_end) : sizeof((*p).mem_end) == sizeof(int) ? (unsigned long long) (unsigned int) ((*p).mem_end) : sizeof((*p).mem_end) == sizeof(long) ? (unsigned long long) (unsigned long) ((*p).mem_end) : (unsigned long long) ((*p).mem_end))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("base_addr"); tprintf("%#llx", (sizeof((*p).base_addr) == sizeof(char) ? (unsigned long long) (unsigned char) ((*p).base_addr) : sizeof((*p).base_addr) == sizeof(short) ? (unsigned long long) (unsigned short) ((*p).base_addr) : sizeof((*p).base_addr) == sizeof(int) ? (unsigned long long) (unsigned int) ((*p).base_addr) : sizeof((*p).base_addr) == sizeof(long) ? (unsigned long long) (unsigned long) ((*p).base_addr) : (unsigned long long) ((*p).base_addr))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("irq"); tprintf("%#llx", (sizeof((*p).irq) == sizeof(char) ? (unsigned long long) (unsigned char) ((*p).irq) : sizeof((*p).irq) == sizeof(short) ? (unsigned long long) (unsigned short) ((*p).irq) : sizeof((*p).irq) == sizeof(int) ? (unsigned long long) (unsigned int) ((*p).irq) : sizeof((*p).irq) == sizeof(long) ? (unsigned long long) (unsigned long) ((*p).irq) : (unsigned long long) ((*p).irq))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("dma"); tprintf("%#llx", (sizeof((*p).dma) == sizeof(char) ? (unsigned long long) (unsigned char) ((*p).dma) : sizeof((*p).dma) == sizeof(short) ? (unsigned long long) (unsigned short) ((*p).dma) : sizeof((*p).dma) == sizeof(int) ? (unsigned long long) (unsigned int) ((*p).dma) : sizeof((*p).dma) == sizeof(long) ? (unsigned long long) (unsigned long) ((*p).dma) : (unsigned long long) ((*p).dma))); } while (0);
 tprint_struct_next();
 do { tprints_field_name("port"); tprintf("%#llx", (sizeof((*p).port) == sizeof(char) ? (unsigned long long) (unsigned char) ((*p).port) : sizeof((*p).port) == sizeof(short) ? (unsigned long long) (unsigned short) ((*p).port) : sizeof((*p).port) == sizeof(int) ? (unsigned long long) (unsigned int) ((*p).port) : sizeof((*p).port) == sizeof(long) ? (unsigned long long) (unsigned long) ((*p).port) : (unsigned long long) ((*p).port))); } while (0);
 tprint_struct_end();
}
static void
     ...
     const kernel_ulong_t arg, const struct_ifreq *const ifr)
{
 ...
 case 0x8916:
 case 0x8915:
  do { tprints_field_name("ifr_addr"); print_sockaddr(tcp, &(*ifr).ifr_ifru.ifru_addr, sizeof((*ifr).ifr_ifru.ifru_addr)); } while (0);
  break;
 case 0x8918:
 case 0x8917:
  do { tprints_field_name("ifr_dstaddr"); print_sockaddr(tcp, &(*ifr).ifr_ifru.ifru_dstaddr, sizeof((*ifr).ifr_ifru.ifru_dstaddr)); } while (0);
  break;
 case 0x891a:
 case 0x8919:
  do { tprints_field_name("ifr_broadaddr"); print_sockaddr(tcp, &(*ifr).ifr_ifru.ifru_broadaddr, sizeof((*ifr).ifr_ifru.ifru_broadaddr)); } while (0);
  break;
 case 0x891c:
 case 0x891b:
  do { tprints_field_name("ifr_netmask"); print_sockaddr(tcp, &(*ifr).ifr_ifru.ifru_netmask, sizeof((*ifr).ifr_ifru.ifru_netmask)); } while (0);
  break;
 case 0x8931:
 case 0x8932:
 case 0x8927:
 case 0x8924:
 case 0x8937:
  do { tprints_field_name("ifr_hwaddr"); (print_ifr_hwaddr)(&((*ifr).ifr_ifru.ifru_hwaddr)); } while (0);
  break;
 case 0x8914:
 case 0x8913:
  do { tprints_field_name("ifr_flags"); printflags64((iffflags), (sizeof((*ifr).ifr_ifru.ifru_flags) == sizeof(char) ? (unsigned long long) (unsigned char) ((*ifr).ifr_ifru.ifru_flags) : sizeof((*ifr).ifr_ifru.ifru_flags) == sizeof(short) ? (unsigned long long) (unsigned short) ((*ifr).ifr_ifru.ifru_flags) : sizeof((*ifr).ifr_ifru.ifru_flags) == sizeof(int) ? (unsigned long long) (unsigned int) ((*ifr).ifr_ifru.ifru_flags) : sizeof((*ifr).ifr_ifru.ifru_flags) == sizeof(long) ? (unsigned long long) (unsigned long) ((*ifr).ifr_ifru.ifru_flags) : (unsigned long long) ((*ifr).ifr_ifru.ifru_flags)), ("IFF_???")); } while (0);
  break;
 case 0x8933:
  do { tprints_field_name("ifr_ifindex"); tprintf("%lld", (sizeof((*ifr).ifr_ifru.ifru_ivalue) == sizeof(char) ? (long long) (char) ((*ifr).ifr_ifru.ifru_ivalue) : sizeof((*ifr).ifr_ifru.ifru_ivalue) == sizeof(short) ? (long long) (short) ((*ifr).ifr_ifru.ifru_ivalue) : sizeof((*ifr).ifr_ifru.ifru_ivalue) == sizeof(int) ? (long long) (int) ((*ifr).ifr_ifru.ifru_ivalue) : sizeof((*ifr).ifr_ifru.ifru_ivalue) == sizeof(long) ? (long long) (long) ((*ifr).ifr_ifru.ifru_ivalue) : (long long) ((*ifr).ifr_ifru.ifru_ivalue))); } while (0);
  break;
 case 0x891e:
 case 0x891d:
  do { tprints_field_name("ifr_metric"); tprintf("%lld", (sizeof((*ifr).ifr_ifru.ifru_ivalue) == sizeof(char) ? (long long) (char) ((*ifr).ifr_ifru.ifru_ivalue) : sizeof((*ifr).ifr_ifru.ifru_ivalue) == sizeof(short) ? (long long) (short) ((*ifr).ifr_ifru.ifru_ivalue) : sizeof((*ifr).ifr_ifru.ifru_ivalue) == sizeof(int) ? (long long) (int) ((*ifr).ifr_ifru.ifru_ivalue) : sizeof((*ifr).ifr_ifru.ifru_ivalue) == sizeof(long) ? (long long) (long) ((*ifr).ifr_ifru.ifru_ivalue) : (long long) ((*ifr).ifr_ifru.ifru_ivalue))); } while (0);
  break;
 case 0x8922:
 case 0x8921:
  do { tprints_field_name("ifr_mtu"); tprintf("%lld", (sizeof((*ifr).ifr_ifru.ifru_mtu) == sizeof(char) ? (long long) (char) ((*ifr).ifr_ifru.ifru_mtu) : sizeof((*ifr).ifr_ifru.ifru_mtu) == sizeof(short) ? (long long) (short) ((*ifr).ifr_ifru.ifru_mtu) : sizeof((*ifr).ifr_ifru.ifru_mtu) == sizeof(int) ? (long long) (int) ((*ifr).ifr_ifru.ifru_mtu) : sizeof((*ifr).ifr_ifru.ifru_mtu) == sizeof(long) ? (long long) (long) ((*ifr).ifr_ifru.ifru_mtu) : (long long) ((*ifr).ifr_ifru.ifru_mtu))); } while (0);
  break;
 case 0x8930:
 case 0x8929:
  do { tprints_field_name("ifr_slave"); print_quoted_cstring((const char *) (*ifr).ifr_ifru.ifru_slave, sizeof((*ifr).ifr_ifru.ifru_slave) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(typeof(((*ifr).ifr_ifru.ifru_slave)), typeof(&((*ifr).ifr_ifru.ifru_slave)[0])))]) * 0)); } while (0);
  break;
 case 0x8923:
  do { tprints_field_name("ifr_newname"); print_quoted_cstring((const char *) (*ifr).ifr_ifru.ifru_newname, sizeof((*ifr).ifr_ifru.ifru_newname) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(typeof(((*ifr).ifr_ifru.ifru_newname)), typeof(&((*ifr).ifr_ifru.ifru_newname)[0])))]) * 0)); } while (0);
  break;
 case 0x8910:
  do { tprints_field_name("ifr_name"); print_quoted_cstring((const char *) (*ifr).ifr_ifrn.ifrn_name, sizeof((*ifr).ifr_ifrn.ifrn_name) + (sizeof(int[-1 + 2 * !!(!__builtin_types_compatible_p(typeof(((*ifr).ifr_ifrn.ifrn_name)), typeof(&((*ifr).ifr_ifrn.ifrn_name)[0])))]) * 0)); } while (0);
  break;
 case 0x8943:
 case 0x8942:
  do { tprints_field_name("ifr_qlen"); tprintf("%lld", (sizeof((*ifr).ifr_ifru.ifru_ivalue) == sizeof(char) ? (long long) (char) ((*ifr).ifr_ifru.ifru_ivalue) : sizeof((*ifr).ifr_ifru.ifru_ivalue) == sizeof(short) ? (long long) (short) ((*ifr).ifr_ifru.ifru_ivalue) : sizeof((*ifr).ifr_ifru.ifru_ivalue) == sizeof(int) ? (long long) (int) ((*ifr).ifr_ifru.ifru_ivalue) : sizeof((*ifr).ifr_ifru.ifru_ivalue) == sizeof(long) ? (long long) (long) ((*ifr).ifr_ifru.ifru_ivalue) : (long long) ((*ifr).ifr_ifru.ifru_ivalue))); } while (0);
  break;
 case 0x8971:
 case 0x8970:
  do { tprints_field_name("ifr_map"); (print_ifr_map)(&((*ifr).ifr_ifru.ifru_map)); } while (0);
  break;
 }
}
static unsigned int
...
{
 struct_ifconf *entering_ifc = ((void *)0);
 struct_ifconf *ifc =
  (!((tcp)->flags & 0x04)) ? malloc(sizeof(*ifc)) : __builtin_alloca (sizeof(*ifc));
 if (((tcp)->flags & 0x04)) {
  entering_ifc = get_tcb_priv_data(tcp);
  if (!entering_ifc) {
   error_msg("%s: " "where is my ifconf?", __func__);
   return 0;
  }
 }
 if (!ifc || umoven((tcp), (addr), sizeof(*(ifc)), (void *) (ifc)) < 0) {
  if ((!((tcp)->flags & 0x04))) {
   free(ifc);
   tprints(", ");
   printaddr(addr);
  } else {
   if (!entering_ifc->ifc_ifcu.ifcu_buf)
    print_ifc_len(entering_ifc->ifc_len);
   tprint_struct_next();
   do { tprints_field_name("ifc_buf"); printaddr((mpers_ptr_t) (*entering_ifc).ifc_ifcu.ifcu_buf); } while (0);
   tprint_struct_end();
  }
  return 0200;
 }
 ...
 if (entering_ifc->ifc_ifcu.ifcu_buf && (entering_ifc->ifc_len != ifc->ifc_len))
  tprint_value_changed();
 if (!entering_ifc->ifc_ifcu.ifcu_buf || (entering_ifc->ifc_len != ifc->ifc_len))
  print_ifc_len(ifc->ifc_len);
 if (!entering_ifc->ifc_ifcu.ifcu_buf || ((tcp)->u_error != 0)) {
  tprint_struct_next();
  do { tprints_field_name("ifc_buf"); printaddr((mpers_ptr_t) (*entering_ifc).ifc_ifcu.ifcu_buf); } while (0);
  if (entering_ifc->ifc_ifcu.ifcu_buf != ifc->ifc_ifcu.ifcu_buf) {
   tprint_value_changed();
   printaddr(((kernel_ulong_t) (unsigned long) (ifc->ifc_ifcu.ifcu_buf)));
  }
 } else {
  struct_ifreq ifr;
  tprint_struct_next();
  tprints_field_name("ifc_buf");
  print_array(tcp, ((kernel_ulong_t) (unsigned long) (ifc->ifc_ifcu.ifcu_buf)),
       ifc->ifc_len / sizeof(struct_ifreq),
       &ifr, sizeof(ifr),
       tfetch_mem, print_ifconf_ifreq, ((void *)0));
 }
 tprint_struct_end();
 return 0200;
}
MPERS_PRINTER_DECL(int, sock_ioctl, struct tcb *tcp, const unsigned int code, const kernel_ulong_t arg)
{
 struct_ifreq ifr;
 switch (code) {
 case 0x8912:
 ...
 case 0x89a1:
  tprint_arg_next();
  printstr_ex(tcp, arg, sizeof(ifr.ifr_ifrn.ifrn_name), 0x01);
  break;
 case 0x8903:
 case 0x8905:
 case 0x8925:
 ...
 case 0x89a3:
  tprints(", ");
  if (!umoven_or_printaddr((tcp), (arg), sizeof(*(&ifr)), (void *) (&ifr))) {
   tprint_struct_begin();
   do { tprints_field_name("ifr_ifindex"); print_ifindex((ifr).ifr_ifru.ifru_ivalue); } while (0);
   tprint_struct_end();
  }
  break;
 case 0x8931:
 ...
 case 0x8942:
  if ((!((tcp)->flags & 0x04))) {
   ...
   if (!((tcp)->u_error != 0) && !umoven((tcp), (arg), sizeof(*(&ifr)), (void *) (&ifr))) {
    tprints(", ");
    print_ifreq(tcp, code, arg, &ifr);
   }
   tprint_struct_end();
