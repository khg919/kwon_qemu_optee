...
#define PACKAGE_STRING "pcsc-lite 1.9.1"
...
/* pcscd filename */
#define PCSCD_BINARY "/usr/sbin/pcscd"

/* Enabled PC/SC lite features */
#define PCSCLITE_FEATURES " Linux arm-buildroot-linux-gnueabihf serial usb usbdropdir=/usr/lib/pcsc/drivers ipcdir=/run/pcscd filter configdir=/etc/reader.conf.d"
