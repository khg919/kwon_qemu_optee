...
prefix_build="/home/qemu-sgx/devel/optee/out-br/host"
...
CFLAGS=$(echo "-O2 -I/home/qemu-sgx/devel/optee/out-br/host/include" | sed "s#^$prefix_build#$prefix_real#")
VERSION="3.9"
LIBM="-lm"
LIBC=""
SYSLIBS="$LIBM $LIBC"
...
LIBPL=$(echo "$(prefix)/lib/python3.9/config-$(VERSION)$(ABIFLAGS)-x86_64-linux-gnu" | sed "s#^$prefix_build#$prefix_real#")
