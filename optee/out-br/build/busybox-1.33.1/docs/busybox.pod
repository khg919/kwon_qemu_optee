...
Currently available applets include:
	...
	base64, basename, bc, blkid, bunzip2, bzcat, cat, chattr, chgrp,
	chmod, chown, chroot, chrt, chvt, cksum, clear, cmp, cp, cpio,
	...
	swapon, switch_root, sync, sysctl, syslogd, tail, tar, tc, tee,
	telnet, test, tftp, time, top, touch, tr, traceroute, true,
...
tar c|x|t [-ahvokO] [-f TARFILE] [-C DIR] [-T FILE] [-X FILE] [OPTION]... [FILE]...
