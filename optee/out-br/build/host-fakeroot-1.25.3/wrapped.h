...
extern int (*next_getgroups)(int size, gid_t list[]);
...
extern int (*next_acl_get)(const char *path, int flags, acl_t **aclp);
extern int (*next_facl_get)(int fd, int flags, acl_t **aclp);
extern int (*next_acl_set)(const char *path, acl_t *aclp);
extern int (*next_facl_set)(int fd, acl_t *aclp);
extern int (*next_acl_trivial)(const char *path);
extern int (*next_acl)(const char *path, int cmd, int cnt, void *buf);
extern int (*next_facl)(int fd, int cmd, int cnt, void *buf);
#endif
...
#ifdef HAVE_STATX
extern int (*next_statx)(int dir_fd, const char *pathname, int flags, unsigned int mask, struct statx *buf);
#endif /* HAVE_STATX */
