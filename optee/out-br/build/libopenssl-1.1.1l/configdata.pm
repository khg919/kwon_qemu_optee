...
our %config = (
  AR => "/home/qemu-sgx/devel/optee/out-br/host/bin/arm-linux-gnueabihf-ar",
  ARFLAGS => [ "r" ],
  CC => "/home/qemu-sgx/devel/optee/out-br/host/bin/arm-linux-gnueabihf-gcc",
  CFLAGS => [ "-D_LARGEFILE_SOURCE -D_LARGEFILE64_SOURCE -D_FILE_OFFSET_BITS=64  -Os -g0 -D_FORTIFY_SOURCE=1" ],
  CPPDEFINES => [  ],
  CPPFLAGS => [ "-D_LARGEFILE_SOURCE -D_LARGEFILE64_SOURCE -D_FILE_OFFSET_BITS=64" ],
  CPPINCLUDES => [  ],
  CXX => "/home/qemu-sgx/devel/optee/out-br/host/bin/arm-linux-gnueabihf-g++",
  CXXFLAGS => [ "-D_LARGEFILE_SOURCE -D_LARGEFILE64_SOURCE -D_FILE_OFFSET_BITS=64  -Os -g0 -D_FORTIFY_SOURCE=1" ],
  HASHBANGPERL => "/usr/bin/perl",
  LDFLAGS => [  ],
  LDLIBS => [ "-latomic" ],
  PERL => "/usr/bin/perl",
  RANLIB => "/home/qemu-sgx/devel/optee/out-br/host/bin/arm-linux-gnueabihf-ranlib",
  RC => "windres",
  RCFLAGS => [  ],
  afalgeng => "",
  b32 => "1",
  ...
  libdir => "",
  major => "1",
  makedepprog => "\$(CROSS_COMPILE)/home/qemu-sgx/devel/optee/out-br/host/bin/arm-linux-gnueabihf-gcc",
  minor => "1.1",
  ...
  openssldir => "/etc/ssl",
  options => "--prefix=/usr --openssldir=/etc/ssl -latomic enable-threads enable-shared enable-camellia enable-mdc2 enable-zlib-dynamic no-asan no-buildtest-c++ no-crypto-mdebug no-crypto-mdebug-backtrace no-devcryptoeng no-ec_nistp_64_gcc_128 no-egd no-external-tests no-fuzz-afl no-fuzz-libfuzzer no-heartbeats no-md2 no-msan no-rc5 no-sctp no-ssl-trace no-ssl3 no-ssl3-method no-tests no-ubsan no-unit-test no-weak-ssl-ciphers",
  perl_archname => "x86_64-linux-gnu-thread-multi",
  perl_cmd => "/usr/bin/perl",
  perl_version => "5.30.0",
  perlargv => [ "linux-armv4", "--prefix=/usr", "--openssldir=/etc/ssl", "-latomic", "threads", "shared", "no-rc5", "enable-camellia", "enable-mdc2", "no-tests", "no-fuzz-libfuzzer", "no-fuzz-afl", "zlib-dynamic" ],
  perlenv => {
      "AR" => "/home/qemu-sgx/devel/optee/out-br/host/bin/arm-linux-gnueabihf-ar",
      "BUILDFILE" => undef,
      "CC" => "/home/qemu-sgx/devel/optee/out-br/host/bin/arm-linux-gnueabihf-gcc",
